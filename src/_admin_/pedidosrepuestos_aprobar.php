...
if ($Submit)
{
	...
	if ($err == 0)
	{		
		$oPedidoRepuesto->Aprobado = 1;
		$oPedidoRepuesto->IdUsuarioAprobado = $currentUser->IdUsuario;
		$oPedidoRepuesto->FechaAprobado = date('d-m-Y H:i:s');
		
		$oPedidosRepuestos->Update($oPedidoRepuesto);
    	...
    	<td>
			<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
      			<tr>
        			...
        			<td height="40"><span class="tituloPagina">APROBAR PEDIDO DE REPUESTOS</span></td>
      			</tr>
    		</table>
		</td>
  	</tr>
