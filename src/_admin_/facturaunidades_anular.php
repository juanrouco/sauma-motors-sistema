...
if ($Submit)
{
	...
	$oComprobanteNC = $oComprobantes->GetById($IdComprobante);
	
	if ($oComprobanteNC->Numero != $NumeroComprobante)
		$err |= 2;
	...
	if ($err == 0)
	{
		...
		$oUnidad->IdEstado = EstadoUnidad::ListoFacturar;
		...
		if ($NumeroComprobante != '')
		{
			...
			if ($oComprobanteNC = $oComprobantes->GetById($IdComprobante))
			{
				...
				$oComprobanteNC->IdCliente = $oMinuta->IdCliente;
						...
						<td class="bordeGris">
							<table  border="0" align="center" cellpadding="0" cellspacing="0">
								...
								<tr>
									<td>
										<div align="left">
											<input type="text" name="NumeroComprobante" id="NumeroComprobante" class="camporFormularioSimple" maxlength="8" autocomplete="off" value="<?=$oComprobanteNC->Numero?>" />
								...
								<tr>
									<td><?php if ($err & 1) { ?><li style="color:#FF0000;">Ingrese el nro. de nota de cr&eacute;dito</li><?php } ?>>&nbsp;</td>
									<td><?php if ($err & 2) { ?><li style="color:#FF0000;">El nro. ingresado es incorrecto</li><?php } ?>>&nbsp;</td>
								</tr>
						  	</table>						
                      	</td>
					</tr>
