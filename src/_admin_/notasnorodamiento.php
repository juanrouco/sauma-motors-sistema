...
$Paginado	= Pageable::PrintPaginator($oPage, $oNotasNoRodamiento->GetCountRows($filter), true);
$arrData 	= $oNotasNoRodamiento->GetAll($filter, $oPage);
...
{	
	window.location.href = 'notasnorodamiento.php';
}								
            ...
            <td>
                <table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
                    <tr>
                        ...
                        <td height="40"><span class="tituloPagina">Administraci&oacute;n de Notas de No Rodamiento</span></td>
                    </tr>
                </table>		
            </td>
        </tr>
                    ...
                    <tr>
                        <td width="8%" height="40">
                            <table border="0" align="left" cellpadding="0" cellspacing="0">
                                <?php if (Session::CheckPerm(PERM_NONR_CREATE)){ ?>
                                <tr>
                                    <td width="30"><div align="center"><img src="images/iconos/add.gif" alt="Agregar" border="0"></div></td>
                                    <td><a href="notasnorodamiento_add.php<?=$strParams?>">Agregar</a></td>
                                </tr>
                                <?php } ?>
                            </table>
                        </td>
    ...
    <?php if ($arrData != NULL) { ?>
        ...
        <tr>
            <td>
                ...
                <?php 
					foreach ($arrData as $oNotaNoRodamiento) 
					{
						$oMinuta = $oMinutas->GetById($oNotaNoRodamiento->IdUnidad);
						$oCliente = $oClientes->GetById($oNotaNoRodamiento->IdCliente);
						$oUnidad = $oUnidades->GetById($oNotaNoRodamiento->IdUnidad);
						$oModelo = $oModelos->GetById($oUnidad->IdModelo);
				?>
          
                    <tr onMouseOver="bgColor='#f3f3f3'" onMouseOut="bgColor=''">
                        <td width="99" height="25"><div id="margen" align="center"><?=$oUnidad->IdUnidad?></div></td>
                        <td width="80" height="25"><div id="margen" align="center"><?=$oUnidad->NumeroVin?></div></td>
                        <td width="261" height="25"><div id="margen"><?=$oModelo->DenominacionComercial?></div></td>
                        <td width="255" height="25"><div id="margen"><?=$oCliente->RazonSocial?></div></td>
                        <td width="125" height="25"><div id="margen"><?=CambiarFecha($oNotaNoRodamiento->Fecha)?></div></td>
                        <td width="106" height="25" valign="middle">
                            <div align="center">
                                <a href="notasnorodamiento_pdf.php<?=$strParams?>&IdNota=<?=$oNotaNoRodamiento->IdNota?>" target="_blank">
                                    <img src="images/iconos/pdf.png" alt="Generar Comprobante" border="0" /></a> - 
                                <a href="notasnorodamiento_details.php<?=$strParams?>&IdNota=<?=$oNotaNoRodamiento->IdNota?>">
                                    <img src="images/iconos/preview.gif" alt="Ver Detalles" border="0" /></a> - 
                            <?php if (Session::CheckPerm(PERM_NONR_CREATE)){ ?>
                                <a href="notasnorodamiento_mod.php<?=$strParams?>&IdNota=<?=$oNotaNoRodamiento->IdNota?>">
                                    <img src="images/iconos/mod.gif" alt="Anular" border="0" /></a> - 
                            <?php } ?>
							<?php if (Session::CheckPerm(PERM_NONR_DELETE)){ ?>
                                <a href="notasnorodamiento_del.php<?=$strParams?>&IdNota=<?=$oNotaNoRodamiento->IdNota?>">
