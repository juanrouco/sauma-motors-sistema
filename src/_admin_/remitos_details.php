    	...
    	<td>
			<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
      			<tr>
        			...
        			<td height="40"><span class="tituloPagina">Administraci&oacute;n de Remitos - Detalle</span></td>
      			</tr>
    		</table>
		</td>
  	</tr>
				...
				<form name="frmData" id="frmData" method="post" action="<?=$strParams?>">
                                    ...
                                    <tr>
                                        <td>
                                            <table width="100%" border="0" align="center" cellpadding="3" cellspacing="3">
                                                <tr>
                                                    <td width="21%"><div align="right">Nro. Carpeta:</div></td>
                                                    <td width="79%">
                                                        <div align="left">
                                                        	<span><?=$oRemito->IdMinuta?></span>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div align="left">
                                                        	<span><?=$oRemito->NumeroComprobante?></span>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div align="left">
                                                        	<span><?=CambiarFecha($oRemito->Fecha)?></span>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td><div align="right">Trasnporte:</div></td>
                                                    <td>
                                                        <div align="left">
                                                        	<span><?=$oRemito->Transporte?></span>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td><div align="right">Trasnporte CUIT/CUIL:</div></td>
                                                    <td>
                                                        <div align="left">
                                                        	<span><?=ClaveFiscalTipos::GetById($oRemito->TransporteClaveFiscalTipo) . ': ' . $oRemito->TransporteClaveFiscalNumero?></span>
                                                        </div>
                                                    </td>
                                                </tr>
                                            </table>
                                    	...
                                    	<td>
                                        	<div align="center">
                                                <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
                                                    <tr>
                                                        <td height="40" align="center"><span class="tituloPagina">Datos del Remito</span></td>
                                                    </tr>
                                                </table>
                                           	</div>
                                        </td>
					...
					<table width="90%"  border="0" align="center" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
						<tr>
							<td height="30">
								<div align="center">
									<input type="button" name="btnCancelar" class="botonBasico" id="btnCancelar" onclick="javascript: window.location.href = 'remitos.php<?=$strParams?>';" value="Volver" />
								</div>
							</td>
						</tr>
					</table>
