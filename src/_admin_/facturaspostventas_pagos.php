...
if (!Session::CheckPerm(PERM_FACTPV_UPDATE))
	Session::NoPerm();
...
if ((!isset($filterPago)) || (IsEmptyArray($filterPago)) || ($Submit))
{
	...
	$filterPago['IdFacturaPostVenta'] 	= trim($_REQUEST['IdFacturaPostVenta']);
}
...
$strParams = '?';
$strParams.= '&IdFacturaPostVenta=' 			. $IdFacturaPostVenta;
$strParams.= '&Page='				. $Page;
...
<form name="frmData" id="frmData" method="post" action="" onSubmit="Filtrar();">
    ...
    <table width="90%"  border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <td>
                <table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
                    <tr>
                        ...
                        <td height="40"><span class="tituloPagina">Administraci&oacute;n de Facturas PosVenta - Pagos</span></td>
                    </tr>
                </table>		
            </td>
        </tr>
                        ...
                        <td height="40">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td>
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
											<?php if (Session::CheckPerm(PERM_FACTPV_UPDATE)){ ?>
                                            <tr>
                                                <td width="30"><div align="center"><img src="images/iconos/add.gif" alt="Agregar" border="0"></div></td>
                                                <td><a href="facturaspostventas_pagos_add.php<?= $strParams ?>">Agregar</a></td>
                                            </tr>
											<?php } ?>
                                        </table>
                                    </td>
                                    <td><div align="right"><a href="facturaspostventas.php<?= $strParams ?>" class="linkMenu"><strong>[Volver al listado de cuentas corriente]</strong></a></div></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
       ...
       <?php /* <tr>
        ...
        <tr>
            <td><b>Pagos de la Factura <?=$oFacturaPostVenta->NumeroFactura?>:</b></td>
        </tr>
        <tr>
            <td>&nbsp;</td>
        </tr>
                ...
                <?php foreach ($arrData as $oPago) { ?>
                    ...
                    <tr onMouseOver="bgColor='#f3f3f3'" onMouseOut="bgColor=''">
                        ...
                        <td width="80" height="25"> 
                            <div align="left">
								<?php if (Session::CheckPerm(PERM_FACTPV_UPDATE)){ ?>
                                <a href="facturaspostventas_pagos_mod.php<?=$strParams?>&IdPago=<?=$oPago->IdPago?>"><img src="images/iconos/mod.gif" alt="Modificar" border="0" /></a> - 
                                <?php } ?>
								<?php if (Session::CheckPerm(PERM_FACTPV_UPDATE)){ ?>
								<a href="facturaspostventas_pagos_del.php<?=$strParams?>&IdPago=<?=$oPago->IdPago?>"><img src="images/iconos/del.gif" alt="Eliminar" border="0" /></a>
								<?php } ?>
							</div>
                        </td>
                    </tr>
