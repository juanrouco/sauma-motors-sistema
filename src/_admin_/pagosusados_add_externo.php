...
$j(document).ready(function() {
	...
	$j('#IdTipoPago').change(function() {
		...
		else if ($j('#IdTipoPago').val() == '<?= TipoPago::Credito ?>') {
			$j('#trBancoCliente').show();
			$j('#trBancoCliente2').show();
			$j('#trBancoDesde').hide();
			$j('#trBancoDesde2').hide();
		...
		else if ($j('#IdTipoPago').val() == '<?= TipoPago::Debito ?>') {
			$j('#trBancoCliente').show();
			$j('#trBancoCliente2').show();
			$j('#trBancoDesde').hide();
			$j('#trBancoDesde2').hide();
		...
		else if ($j('#IdTipoPago').val() == '<?= TipoPago::CreditoPersonal ?>') {
			$j('#trBancoCliente').show();
			$j('#trBancoCliente2').show();
			$j('#trBancoDesde').hide();
			$j('#trBancoDesde2').hide();
							...
							<td class="bordeGris">
								<table border="0" align="center" cellpadding="0" cellspacing="0">
									...
									<tr>
										...
										<td>
                                        	<div align="left">
                                                <input type="text" id="IdMinuta" name="IdMinuta" value="<?= $IdMinuta ?>" class="camporFormulariosSimple" />
                                	...
                                	<tr>
										<td height="20">&nbsp;</td>
										<td height="20" align="left"><?php if ($err & 8) { ?><li style="color:#FF0000;">Ingrese el n&uacute;mero de interno.</li><?php } ?></td>
									</tr>
									<tr>
                                	...
                                	<tr>
										<td height="20">&nbsp;</td>
										<td height="20" align="left"><?php if ($err & 32) { ?><li style="color:#FF0000;">El nro de recibo ya fue ingresado.</li><?php } ?><?php if ($err & 16) { ?><li style="color:#FF0000;">Ingrese un nro de recibo.</li><?php } ?></td>
									</tr>
									<tr>
						...
						<tr>
							<td height="30">
								<div align="center">
									...
									<input type="button" name="btnCancelar" class="botonBasico" id="btnCancelar" onclick="javascript: window.location.href = 'cuentascorrienteusados.php<?=$strParams?>';" value="Cancelar" />
								</div>
							</td>
						</tr>
					</table>
