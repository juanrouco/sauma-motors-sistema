...
if ((!isset($filter)) || (IsEmptyArray($filter)) || ($Submit))
{
	...
	$filter['IdEstado'][0] = EstadoUnidad::Facturado;
	$filter['IdEstado'][1] = EstadoUnidad::Entregado;
	$filter['IdEstado'][2] = EstadoUnidad::Reservado;
	$filter['IdEstado'][3] = 9;
}
...
<table width="794" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
    	<td align="center"><div align="center"><span class="Estilo4">REPORTE DE FACTURACION DEL <?= $filter['FechaFacturaDesde'] ?> AL <?=$filter['FechaFacturaHasta']?></span></div></td>
    </tr>
    <tr>
    	<td>&nbsp;</td>
    </tr>
...
<table width="794" border="1" cellspacing="0" cellpadding="0">
    <tr>
        <td>No se encuentran unidades facturadas en el rango de fechas especificadas</td>
    </tr>
</table>
<?php } ?>     
</body>
...
$oMpdf->Output('reporte_facturacion.pdf', 'D'); 
