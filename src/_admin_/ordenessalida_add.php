...
if ($Submit)
{
	...
	else
	{
		...
		$oMinuta = $oMinutas->GetById($IdUnidad);
	...
	if ($err == 0)
	{
		...
		$oOrdenSalida->IdUnidad 						= $IdUnidad;
    	...
    	<td>
			<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
      			<tr>
        			...
        			<td height="40"><span class="tituloPagina">Administraci&oacute;n de &Oacute;rdenes de Salida - Agregar</span></td>
      			</tr>
    		</table>
		</td>
  	</tr>
						...
						<tr>
							<td height="30">
								<div align="center">
									...
									<input type="button" name="btnCancelar" class="botonBasico" id="btnCancelar" onclick="javascript: window.location.href = 'ordenessalida.php<?=$strParams?>';" value="Cancelar" />
								</div>
							</td>
						</tr>
					</table>
