...
{	
	window.location.href = 'cuentasgestoriausados.php?MainAction=<?=$MainAction?>';
}								
...
$j(document).ready(function() {
	$j(".comentarios-guardar").on('input',function() {
		...
		timer = setTimeout(function() {
			SaveComentariosCuentaGestoriaUsados(IdCuentaGestoria, Comentarios);
		}, 1000);
            ...
            <td>
                <table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
                    <tr>
                        ...
                        <td height="40"><span class="tituloPagina">Administraci&oacute;n de Cuentas Corriente de Gestor&iacute;a de Usados</span></td>
                    </tr>
                </table>		
            </td>
        </tr>
                        ...
                        <td width="8%" height="40">
                            <table border="0" align="left" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    ...
                                    <td><a href="cuentasgestoriausados_seleccionar_minuta.php<?=$strParams?>">Agregar</a></td>
                        ...
                        <td width="16%" height="40">
                            <table border="0" align="left" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    ...
                                    <td><a href="cuentasgestoriausados_exportar.php<?=$strParams?>">Exportar Rentabilidad</a></td>									                                     
                                </tr>
                                <?php } ?>
                            </table>
                        </td>
            ...
            <td>
				...
				?>
                    ...
                    <tr class="bordeGrisFondo">
						...
						<td align="center">
							<a href="cuentasgestoriausados_pdf.php?Fecha=<?= CambiarFecha($oHeader['Fecha']) ?>">
								<img src="images/iconos/pdf.png" alt="Eliminar" border="0" /></a> - 
							<?php if (Session::CheckPerm(PERM_GESCUE_UPDATE)){ ?>
							<a href="cuentasgestoriausados_lote_mod.php?Fecha=<?= CambiarFecha($oHeader['Fecha']) ?>">
				...
				?>
                    ...
                    <tr onMouseOver="bgColor='#f3f3f3'" onMouseOut="bgColor=''">
						...
						<td colspan="6">
							<table width="100%" cellpadding="0" cellspacing="0" border="0" class="bordeGris">
								<tr>
									...
									<td width="178" height="25"><div id="margen"><?=$oUsado->Modelo?></div></td>
                        ...
                        <td width="91" height="25" valign="middle">
                            <div align="center">
                                <?php if (Session::CheckPerm(PERM_GESCUE_UPDATE)){ ?>
								<a href="cuentasgestoriausados_mod.php?IdCuentaGestoria=<?=$oCuentaGestoria->IdCuentaGestoria?>">
									<img src="images/iconos/mod.gif" alt="Eliminar" border="0" /></a> - 
								<?php } ?>
								<?php if (Session::CheckPerm(PERM_GESCUE_RENDICION)){ ?>
								<a href="cuentasgestoriausados_rendicion.php?IdCuentaGestoria=<?=$oCuentaGestoria->IdCuentaGestoria?>">
									<img src="images/iconos/facturacion.png" alt="Eliminar" border="0" /></a> - 
								<?php } ?>
								<?php if (Session::CheckPerm(PERM_GESCUE_DELETE)){ ?>
								<a href="cuentasgestoriausados_del.php?IdCuentaGestoria=<?=$oCuentaGestoria->IdCuentaGestoria?>">
