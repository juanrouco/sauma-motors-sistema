            ...
            <td height="30" valign="top">
                <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <td height="40"><a href="contabilidad_notascredito_reporte_xls.php<?=$strParams?>">Exportar</a></td>
                        <td width="10">&nbsp;</td>
                    </tr>
                </table>		
            </td>
            ...
            <td>
				...
				?>
                    ...
                    <tr onMouseOver="bgColor='#f3f3f3'" onMouseOut="bgColor=''">
						...
						<td width="100" height="25"><div id="margen"><?=$oFactura->Prefijo . ' - ' . $oFactura->Numero?></div></td>
