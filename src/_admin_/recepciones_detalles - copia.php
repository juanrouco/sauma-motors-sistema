            ...
            <td>
                <table width="90%" align="center" cellpadding="0" cellspacing="0" class="bordeGris">
                    <tr class="bordeGrisFondo">
                        ...
                        <td height="25" class="bordeGrisTitulo"><div id="margen"><strong>Neto</strong></div></td>
                ...
                <?php foreach ($arrData as $oMinutaPagoItem) { ?>
                    ...
                    <tr onMouseOver="bgColor='#f3f3f3'" onMouseOut="bgColor=''">
                        ...
                        <td width="241" height="25"><div id="margen"><?=number_format($oMinutaPagoItem->Neto, 2)?></div></td>
