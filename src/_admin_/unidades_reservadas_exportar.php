...
<form name="frmData" id="frmData" method="post" target="_blank" action="unidades_reservadas_exportar_pdf.php">
            ...
            <td>
                <table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
                    <tr>
                        ...
                        <td height="40"><span class="tituloPagina">Exportar Unidades Reservadas</span></td>
                    </tr>
                </table>		
            </td>
        </tr>
                            ...
                            <td class="tituloMenu">
                                <table border="0" cellspacing="0" cellpadding="0">
                                    <tr>                              
                                        ...
                                        <td>
                                        	<input name="FilterFechaDesde" id="FilterFechaDesde" type="text" class="camporFormularioSimple" value="<?=$filter['FechaDesde']?>" maxlength="12">
											<script language="javascript">
                                        ...
                                        <td>
                                        	<input name="FilterFechaHasta" id="FilterFechaHasta" type="text" class="camporFormularioSimple" value="<?=$filter['FechaHasta']?>" maxlength="12">
											<script language="javascript">
