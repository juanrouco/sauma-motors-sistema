...
if ($Submit)
{
	...
	if ($err == 0)
	{
		...
		if ($oUpload->UploadFile())
		{
			...
			$res = $oTareasTrabajo->Import($oUpload->GetNombre());
			
			$Mensaje = $res->Mensaje;

			/* eliminamos el archivo almacenado en el servidor */
			Up::DeleteFile(Unidad::PathFile, $oUpload->GetNombre());
		}
	}
}
    	...
    	<td>
			<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
      			<tr>
        			...
        			<td height="40"><span class="tituloPagina">Actualizar Tareas</span></td>
   			  </tr>
    		</table>
		</td>
  	</tr>
