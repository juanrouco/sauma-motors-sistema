...
$ClienteCondominio		= '';
$oAcreedor 				= $oAcreedores->GetById($oMinutaUsado->IdAcreedor);
if ($oMinutaUsado->Condominio)
{
    	...
    	<td>
			<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
      			<tr>
        			...
        			<td height="40"><span class="tituloPagina">Administraci&oacute;n de Minutas de Usados - Detalle</span></td>
      			</tr>
    		</table>
		</td>
  	</tr>
			...
			<div align="center">
														...
														<table border="0" align="center" cellpadding="0" cellspacing="0">
																...
																<td>
																	<table border="0" align="left" cellpadding="0" cellspacing="0">
																		...
																		<tr>
																			...
																			<td>
																				<div align="left">
																					<input type="text" name="IdUsado" id="IdUsado" class="camporFormularioChico" maxlength="5" value="<?=$IdUsado?>" onkeyup="javascript: StrToUpper(this.id);" readonly="readonly" />
																				</div>
																			</td>
																		</tr>
																	</table>
																...
																<td>
																	<table border="0" align="left" cellpadding="0" cellspacing="0">
																		...
																		<tr>
																			<td>
																				<div align="left">
																					<input name="FechaVencimiento" type="text" class="camporFormularioMediano" id="FechaVencimiento" value="<?=$FechaVencimiento?>" size="12" maxlength="12" readonly="readonly" />
																				</div>
																			</td>
																		</tr>
																	</table>
															...
															<tr>
																<td>
																	<table border="0" align="left" cellpadding="0" cellspacing="0">
																		<tr>
																			<td><div id="margen" align="left">Fecha Estimada de Retiro:</div></td>
																		</tr>
																		<tr>
																			<td>
																				<div align="left">
																					<input name="FechaRetiro" type="text" class="camporFormularioMediano" id="FechaRetiro" value="<?=$FechaRetiro?>" size="12" maxlength="12" readonly="readonly" />
																				</div>
																			</td>
																		</tr>
																	</table>
																...
																<td>
																	<table border="0" align="left" cellpadding="0" cellspacing="0">
																		...
																		<tr>
																			<td>
																				<div align="left">
																					<input type="text" name="Anticipo" id="Anticipo" class="camporFormularioSimple" maxlength="10" onKeyPress="javascript: if (event.keyCode &lt; 45 || event.keyCode &gt; 57) event.returnValue = false;" value="<?=$Anticipo?>" readonly="readonly" />
																				</div>
																			</td>
																		</tr>
																	</table>
																...
																<td>
																	<table border="0" align="left" cellpadding="0" cellspacing="0">
																		...
																		<tr>
																			<td>
																				<div align="left">
																					<input type="text" name="Gastos" id="Gastos" class="camporFormularioSimple" maxlength="10" onKeyPress="javascript: if (event.keyCode &lt; 45 || event.keyCode &gt; 57) event.returnValue = false;" value="<?=$Gastos?>" readonly="readonly" />
																				</div>
																			</td>
																		</tr>
																	</table>
                                        	...
                                        	<div align="center">
												<table id="contenedor-items" width="90%" border="0" align="center" cellpadding="0" cellspacing="0" class="bordeGris">
													...
													<tr id="row_<?= $i ?>" class="bordeGris">
														<td height="30"><div id="margen"><input type="text" id="Detalle[]" name="Detalle[]" class="camporFormularioSimple" value="<?= $arrDetalles[$i] ?>" readonly="readonly" /></div></td>
														<td width="10">&nbsp;</td>
														<td width="200">&nbsp;</td>
													</tr>
													<?php
				...
				<table width="90%"  border="0" align="center" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
					<tr>
						<td height="30">
							<div align="center">
								<input type="button" name="btnCancelar" class="botonBasico" id="btnCancelar" onclick="javascript: window.location.href = 'minutasusados.php<?=$strParams?>';" value="Volver" />
								<input type="button" name="btnImprimir" class="botonBasico" id="btnImprimir" onclick="javascript: window.location.href = 'minutasusados_pdf.php?IdMinuta=<?=$IdMinuta?>';" value="Imprimir" />
								<input type="button" name="btnPagos" class="botonBasico" id="btnPagos" onclick="javascript: window.location.href = 'pagosusados.php?IdMinuta=<?=$IdMinuta?>';" value="Pagos" />
							</div>
						</td>
					</tr>
				</table>
