...
if ($Submit)
{
	...
	if ($RazonSocial == '')
		$err |= 2;
	if ($IdTipoIva == TipoIva::RI && $ClaveFiscalTipo != ClaveFiscalTipos::Cuit)
		$err |= 4;
	if ($IdTipoIva == TipoIva::RI && $ClaveFiscalNumero == '')
		$err |= 8;
	if ($Email == '')
		$err |= 16;
	/*if ($IdTipoIva == '')
...
$j(document).ready(function() {
	...
	{
	?>
	FilterEstadoCivil('<?= $IdEstadoCivil ?>', '');
	<?php
	}	
	if ($ConyugeDocumentoTipo)
	{
	?>
	FilterTipoDocumento('<?= $DocumentoTipo ?>', '');
	<?php
	}	
	if ($ConyugeDocumentoTipo)
	{
	?>
	FilterTipoDocumentoConyuge('<?= $ConyugeDocumentoTipo ?>', '');
	<?php
	}	
	if ($DomicilioIdLocalidad)
	{
	?>
		FilterDomicilioLocalidad('<?= $DomicilioIdLocalidad ?>', '');
	<?php
	}
	if ($DomicilioIdLocalidadPostal)
	{
	?>
		FilterDomicilioLocalidadPostal('<?= $DomicilioIdLocalidadPostal ?>', '');
	<?php
	}
	if ($IdTipoIva)
	{
	...
	{ 
		...
		{
	?>
		window.opener.FilterClienteCondominio('<?=$oCliente->IdCliente?>', '');
	<?php
		}
		elseif ($Reventa)
		{
	?>
		window.opener.FilterClienteReventa('<?=$oCliente->IdCliente?>', '');
	<?php
		}
		else
		{
...
<form name="frmData" id="frmData" method="post" action="<?=$strParams?>">
	...
	{
	?>
		<input type="hidden" name="Condominio" id="Condominio" value="1" />
	<?php
	}
	?>
	<?php
	...
	{
	?>
		<input type="hidden" name="Reventa" id="Reventa" value="1" />
	<?php
	}
	?>
                                                                ...
                                                                <tr>
                                                                    <td valign="top">
                                                                        <table border="0" align="center" cellpadding="0" cellspacing="0">
                                                                                ...
                                                                                <td>
                                                                                    <table border="0" align="left" cellpadding="0" cellspacing="0">
                                                                                        ...
                                                                                        <tr>
                                                                                            <td>
                                                                                                <div align="left">
                                                                                                    <input type="text" name="DocumentoTipoNombre" id="DocumentoTipoNombre" class="camporFormularioSuggest" maxlength="128" value="<?=$DocumentoTipoNombre?>" onkeyup="javascript: StrToUpper(this.id);" autocomplete="off" />
                                                                                                    <script language="javascript">
                                                                            ...
                                                                            <tr id="trFechaNacimiento" style="display:none;">
                                                                                <td>
                                                                                    <table border="0" align="left" cellpadding="0" cellspacing="0">
                                                                                        <tr>
                                                                    ...
                                                                    <td valign="top">
                                                                        <table border="0" align="center" cellpadding="0" cellspacing="0">
                                                                                ...
                                                                                <td>
                                                                                    <table border="0" align="left" cellpadding="0" cellspacing="0">
                                                                                        ...
                                                                                        <tr>
                                                                                            <td>
                                                                                                <div align="left">
                                                                                                    <input type="text" name="Empresa" id="Empresa" class="camporFormularioSimple" maxlength="128" value="<?=$Empresa?>" onkeyup="javascript: StrToUpper(this.id);" />
                                                                                                </div>
                                                                                            </td>
                                                                                            <td>&nbsp;</td>
                                                                                        </tr>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td height="20">
																					<?php if ($err & 4) { ?><li style="color:#FF0000;">El tipo de clave fiscal debe ser CUIT para un responsable inscripto.</li><?php } ?>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td height="20"><?php if ($err & 16) { ?><li style="color:#FF0000;">Debe ingresar el email.</li><?php } ?>
                                                                                        ...
                                                                                        <tr>
                                                                                            <td>
                                                                                                <div align="left">
																									...
																									SUGGESTRequest('Usuarios', 'GetAllSuggest', 'Usuario', 'FilterUsuario', 'IdUsuario', 'Nombre', 'FilterNombre', arrParams);
                                                                                                    </script>
                                                                                                </div>
                                                                                            </td>
                                                                                            <td>
                                                                            ...
                                                                            <tr>
                                                                                <td height="20"><?php if ($err & 16 && false) { ?>
                                                                                ...
                                                                                <td>
                                                                                    <table border="0" align="left" cellpadding="0" cellspacing="0">
                                                                                        ...
                                                                                        <tr>
                                                                                            <td>
                                                                                                <div align="left">
                                                                                                    <input type="text" name="Profesion" id="Profesion" class="camporFormularioSuggest" maxlength="128" value="<?=$Profesion?>" onkeyup="javascript: StrToUpper(this.id);"  autocomplete="off" required />
                                                                                                    <script language="javascript">
                                                                                ...
                                                                                <td>
                                                                                    <table border="0" align="left" cellpadding="0" cellspacing="0">
                                                                                        ...
                                                                                        <tr>
                                                                                            <td>
                                                                                                <div align="left">
                                                                                                    <input type="text" name="EstadoCivil" id="EstadoCivil" class="camporFormularioSuggest" maxlength="128" value="<?=$EstadoCivil?>" onkeyup="javascript: StrToUpper(this.id);" onblur="javascript: VerificarEstadoCivil(this.value);" autocomplete="off" />
                                                                                                    <script language="javascript">
                                                                                ...
                                                                                <td>
                                                                                    <table border="0" align="left" cellpadding="0" cellspacing="0">
                                                                                        ...
                                                                                        <tr>
                                                                                            <td>
                                                                                                <div align="left">
                                                                                                    <input type="text" name="Nupcia" id="Nupcia" class="camporFormularioChico" maxlength="3" value="<?=$Nupcia?>" />
                                                                                                </div>
                                                                                            </td>
                                                                                            <td><span style="color:#FF0000;">&nbsp;</span></td>
                                                                                        </tr>
                                                                    ...
                                                                    <td>
                                                                        <table border="0" align="left" cellpadding="0" cellspacing="0">
                                                                            ...
                                                                            <tr>
                                                                                <td>
                                                                                    <div align="left">
                                                                                        <input type="text" name="ConyugeNombre" id="ConyugeNombre" class="camporFormularioSimple" maxlength="128" value="<?=$ConyugeNombre?>" onkeyup="javascript: StrToUpper(this.id);" />
                            														</div>
                                                                                </td>
                                                                                <td><span style="color:#FF0000;">&nbsp;</span></td>
                                                                            </tr>
                                                                                ...
                                                                                <td>
                                                                                    <table border="0" align="left" cellpadding="0" cellspacing="0">
                                                                                        ...
                                                                                        <tr>
                                                                                            <td>
                                                                                                <div align="left">
                                                                                                    <input type="text" name="ConyugeDocumentoTipoNombre" id="ConyugeDocumentoTipoNombre" class="camporFormularioSuggest" maxlength="128" value="<?=$ConyugeDocumentoTipoNombre?>" onkeyup="javascript: StrToUpper(this.id);"  autocomplete="off" />
                                                                                                    <script language="javascript">
                                                                                                    SUGGESTRequest('TiposDocumento', 'GetAll', 'ConyugeDocumentoTipoNombre', 'FilterTipoDocumentoConyuge', 'IdTipoDocumento', 'Nombre', 'FilterNombre', null);
                                                                                                    </script>
                                                                                                </div>
                                                                                            </td>
                                                                                            <td>
                                                                                            ...
                                                                                            <td>&nbsp;</td>
                                                                                            <td><input type="button" id="btnAddTipoDocumento" class="botonBasico" onClick="javascript:AddTipoDocumento('DocumentoConyuge');" value=" + " /></td>
                                                                                        </tr>
                                                                                    </table>
                                                                                </td>
                                                                            </tr>
                                                                                ...
                                                                                <td>
                                                                                    <table border="0" align="left" cellpadding="0" cellspacing="0">
                                                                                        ...
                                                                                        <tr>
                                                                                            <td>
                                                                                                <div align="left">
                                                                                                    <input type="text" name="ConyugeDocumentoNumero" id="ConyugeDocumentoNumero" class="camporFormularioSimple" maxlength="128" value="<?=$ConyugeDocumentoNumero?>" />
                                                                                                </div>
                                                                                            </td>
                                                                                        </tr>
                                                                                    </table>
                                                                    ...
                                                                    <td valign="top">
                                                                        <table border="0" align="left" cellpadding="0" cellspacing="0" valign="top">
                                                                            ...
                                                                            <tr>
                                                                                <td>
                                                                                    <div align="left">
                                                                                        <input type="text" name="RepresentanteRazonSocial" id="RepresentanteRazonSocial" class="camporFormularioSimple" maxlength="128" value="<?=$RepresentanteRazonSocial?>" onkeyup="javascript: StrToUpper(this.id);" />
                            														</div>
                                                                                </td>
                                                                                <td><span style="color:#FF0000;">&nbsp;</span></td>
                                                                            </tr>
                                                                                ...
                                                                                <td>
                                                                                    <table border="0" align="left" cellpadding="0" cellspacing="0">
                                                                                        ...
                                                                                        <tr>
                                                                                            <td>
                                                                                                <div align="left">
                                                                                                    <input type="text" name="RepresentanteDocumentoTipoNombre" id="RepresentanteDocumentoTipoNombre" class="camporFormularioSuggest" maxlength="128" value="<?=$RepresentanteDocumentoTipoNombre?>" onkeyup="javascript: StrToUpper(this.id);"  autocomplete="off" />
                                                                                                    <script language="javascript">
                                                                                                    SUGGESTRequest('TiposDocumento', 'GetAll', 'RepresentanteDocumentoTipoNombre', 'FilterTipoDocumentoRepresentante', 'IdTipoDocumento', 'Nombre', 'FilterNombre', null);
                                                                                                    </script>
                                                                                                </div>
                                                                                            </td>
                                                                                            <td>
                                                                                                <div align="left">
                                                                                                    <input type="text" name="RepresentanteDocumentoTipoCodigo" id="RepresentanteDocumentoTipoCodigo" class="camporFormularioChicoSuggest" maxlength="3" value="<?=$RepresentanteDocumentoTipoCodigo?>" readonly="readonly" />
                                                                                ...
                                                                                <td>
                                                                                    <table border="0" align="left" cellpadding="0" cellspacing="0">
                                                                                        ...
                                                                                        <tr>
                                                                                            <td>
                                                                                                <div align="left">
                                                                                                    <input type="text" name="RepresentanteDocumentoNumero" id="RepresentanteDocumentoNumero" class="camporFormularioSimple" maxlength="128" value="<?=$RepresentanteDocumentoNumero?>" />
                                                                                                </div>
                                                                                            </td>
                                                                                        </tr>
                                                                                    </table>
                                                                    ...
                                                                    <td valign="top">
                                                                        <table border="0" align="left" cellpadding="0" cellspacing="0">
                                                                            ...
                                                                            <tr>
                                                                                <td>
                                                                                    <div align="left">
                                                                                        <input type="text" name="DomicilioCalle" id="DomicilioCalle" class="camporFormularioSimple" maxlength="128" value="<?=$DomicilioCalle?>" onkeyup="javascript: StrToUpper(this.id);" required />
                                                                                    </div>
                                                                                </td>
                                                                                <td><span style="color:#FF0000;">&nbsp;</span></td>
                                                                            </tr>
                                                                                ...
                                                                                <td>
                                                                                    <table border="0" align="left" cellpadding="0" cellspacing="0">
                                                                                        ...
                                                                                        <tr>
                                                                                            <td>
                                                                                                <div align="left">
                                                                                                    <input type="text" name="DomicilioNumero" id="DomicilioNumero" class="camporFormularioChico" maxlength="12" value="<?=$DomicilioNumero?>" required onkeyup="javascript: StrToUpper(this.id);" />
                                                                                                </div>
                                                                                            </td>
                                                                                            <td>&nbsp;</td>
                                                                                            <td>
                                                                                ...
                                                                                <td>
                                                                                    <table border="0" align="left" cellpadding="0" cellspacing="0">
                                                                                        ...
                                                                                        <tr>
                                                                                            <td>
                                                                                                <div align="left">
                                                                                                    <input type="text" name="DomicilioLocalidad" id="DomicilioLocalidad" class="camporFormularioSuggest" maxlength="128" value="<?=$DomicilioLocalidad?>" required onkeyup="javascript: StrToUpper(this.id);" autocomplete="off" />
                                                                                                    <script language="javascript">
                                                                                            ...
                                                                                            <td>
                                                                                                <div align="left">
                                                                                                    <input type="text" name="DomicilioCodigoPostal" id="DomicilioCodigoPostal" class="camporFormularioChico" maxlength="10" value="<?=$DomicilioCodigoPostal?>" required />
                                                                                ...
                                                                                <td>
                                                                                    <table border="0" align="left" cellpadding="0" cellspacing="0">
                                                                                        ...
                                                                                        <tr>
                                                                                            <td>
                                                                                                <div align="left">
                                                                                                    <input type="text" name="NacimientoLocalidad" id="NacimientoLocalidad" class="camporFormularioSuggest" maxlength="128" value="<?=$NacimientoLocalidad?>" onkeyup="javascript: StrToUpper(this.id);" autocomplete="off" />
                                                                                                    <script language="javascript">
                                                                                                    SUGGESTRequest('Localidades', 'GetAllSuggest', 'NacimientoLocalidad', 'FilterNacimientoLocalidad', 'IdLocalidad', 'Nombre', 'FilterNombre', null);
                                                                                                    </script>
                                                                                                </div>
                                                                                            </td>
                                                                                            <td>
                                                                                                <div align="left">
                                                                                                    <input type="text" name="NacimientoCodigoPostal" id="NacimientoCodigoPostal" class="camporFormularioChico" maxlength="10" value="<?=$NacimientoCodigoPostal?>" />
                                                                                                    
                                                                                                </div>
                                                                                            </td>
                                                                                            <td>&nbsp;</td>
                                                                                            <td><input type="button" id="btnAddLocalidad" class="botonBasico"  onClick="javascript:AddLocalidad('DomicilioNacimiento');" value=" + " /></td>
                                                                                        </tr>
                                                                                    </table>
                                                                                </td>
                                                                            </tr>
                                                                    ...
                                                                    <td valign="top">
                                                                        <table border="0" align="left" cellpadding="0" cellspacing="0">
                                                                            ...
                                                                            <tr>
                                                                                <td>
                                                                                    <div align="left">
                                                                                        <input type="text" name="DomicilioCallePostal" id="DomicilioCallePostal" class="camporFormularioSimple" maxlength="128" value="<?=$DomicilioCallePostal?>" onkeyup="javascript: StrToUpper(this.id);" />
                                                                                    </div>
                                                                                </td>
                                                                                <td><span style="color:#FF0000;">&nbsp;</span></td>
                                                                            </tr>
                                                                                ...
                                                                                <td>
                                                                                    <table border="0" align="left" cellpadding="0" cellspacing="0">
                                                                                        ...
                                                                                        <tr>
                                                                                            <td>
                                                                                                <div align="left">
                                                                                                    <input type="text" name="DomicilioNumeroPostal" id="DomicilioNumeroPostal" class="camporFormularioChico" maxlength="12" value="<?=$DomicilioNumeroPostal?>" onkeyup="javascript: StrToUpper(this.id);" />
                                                                                                </div>
                                                                                            </td>
                                                                                            <td>&nbsp;</td>
                                                                                            <td>
                                                                                                <div align="left">
                                                                                                    <input type="text" name="DomicilioPisoPostal" id="DomicilioPisoPostal" class="camporFormularioChico" maxlength="4" value="<?=$DomicilioPisoPostal?>" />
                                                                                                </div>
                                                                                            </td>
                                                                                            <td>&nbsp;</td>
                                                                                            <td>
                                                                                                <div align="left">
                                                                                                    <input type="text" name="DomicilioDptoPostal" id="DomicilioDptoPostal" class="camporFormularioChico" maxlength="4" value="<?=$DomicilioDptoPostal?>" />
                                                                                                </div>
                                                                                            </td>
                                                                                        </tr>
                                                                                    </table>
                                                                                ...
                                                                                <td>
                                                                                    <table border="0" align="left" cellpadding="0" cellspacing="0">
                                                                                        ...
                                                                                        <tr>
                                                                                            <td>
                                                                                                <div align="left">
                                                                                                    <input type="text" name="DomicilioLocalidadPostal" id="DomicilioLocalidadPostal" class="camporFormularioSuggest" maxlength="128" value="<?=$DomicilioLocalidadPostal?>" onkeyup="javascript: StrToUpper(this.id);" autocomplete="off" />
                                                                                                    <script language="javascript">
                                                                                                    SUGGESTRequest('Localidades', 'GetAllSuggest', 'DomicilioLocalidadPostal', 'FilterDomicilioLocalidadPostal', 'IdLocalidad', 'Nombre', 'FilterNombre', null);
                                                                                                    </script>
                                                                                                </div>
                                                                                            </td>
                                                                                            <td>
                                                                                                <div align="left">
                                                                                                    <input type="text" name="DomicilioCodigoPostalPostal" id="DomicilioCodigoPostalPostal" class="camporFormularioChico" maxlength="10" value="<?=$DomicilioCodigoPostalPostal?>" />
                                                                                                    
                                                                                                </div>
                                                                                            </td>
                                                                                            <td>&nbsp;</td>
                                                                                            <td><input type="button" id="btnAddLocalidadPostal" class="botonBasico"  onClick="javascript:AddLocalidad('DomicilioPostal');" value=" + " /></td>
                                                                                        </tr>
                                                                                    </table>
                                                                                </td>
                                                                            </tr>
