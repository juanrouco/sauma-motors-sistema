...
if (!Session::CheckPerm(PERM_UBIC_CREATE))
	Session::NoPerm();
...
if ($Submit)
{
	...
	if ($Nombre == '')
		$err |= 2;
	elseif ($oUbicaciones->GetByNombre($Nombre))
		$err |= 4;
	...
	if ($err == 0)
	{
		...
		$oUbicacion = $oUbicaciones->Create($oUbicacion);
    	...
    	<td>
			<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
      			<tr>
        			...
        			<td height="40"><span class="tituloPagina">Administraci&oacute;n de Ubicaciones - Agregar</span></td>
      			</tr>
    		</table>
		</td>
  	</tr>
