            ...
            <td>
                <table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
                    <tr>
                        ...
                        <td height="40"><span class="tituloPagina">Administraci&oacute;n de Cuentas Corriente de Gestor&iacute;a de Usados - Rendici&oacute;n</span></td>
                    </tr>
                </table>
            </td>
        </tr>
            ...
            <td>
				<table width="90%" align="center" cellpadding="0" cellspacing="0" class="borderGris">
					...
					<tr>
						...
						<td align="left">&nbsp;<?= $oUsado->IdUsadi ?></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td align="left">&nbsp;<?=$oUsado->Modelo?></td>
					</tr>
					<tr>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
