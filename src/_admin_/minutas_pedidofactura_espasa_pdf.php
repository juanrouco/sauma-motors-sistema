                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                    ...
                    <tr>
                        <td height="30" align="left">
                            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                <tr align="left">
                                    <td align="left"><div align="left"><?= utf8_encode('SOLICITO FACTURACI&Oacute;N DE UNIDAD:') ?></div></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td height="30" align="left">
                            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                <tr align="left">
                                    <td align="left"><div align="left">PV: <strong><?=utf8_encode($oUnidad->NumeroPedido)?></strong></div></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td height="30" align="left">
                            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                <tr align="left">
                                    <td align="left"><div align="left">POSICI&Oacute;N ANTE AFIP: <?= $oCliente->IdTipoIva == TipoIva::RI ? 'RESP. INSC.' : 'CONS. FINAL' ?></div></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td height="30" align="left">
                            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                <tr align="left">
                                    <td align="left"><div align="left"><?= utf8_encode('ADJUNTO FOTOCOPIA DE D.N.I. COMPLETO, DECLARACI&Oacute;N JURADA DE ESTADO CIVIL Y CUIT') ?></div></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td>
                            <table style="border: 1px solid #000000;" width="100%" border="0" cellpadding="10" cellspacing="0">
                                <tr>
                                  <td align="left"><div align="left"><strong><?= utf8_encode('SOLICITAMOS POR LA PRESENTE QUE NOS ENVIEN URGENTE LA DOCUMENTACI&Oacute;N POR CORREO LAN CARGO A VELEZ SARFIELD 168 HACIENDONOS RESPONSABLES POR LOS ROBOS, HURTOS O EXTRAVIOS NO TENIENDO NADA QUE RECLAMAR A ESPASA S.A.')?></strong></div></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
