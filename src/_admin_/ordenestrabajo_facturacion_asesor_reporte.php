...
$arrAsesores = $oOrdenesTrabajo->GetReporteAsesores($filter['FechaDesde'], $filter['FechaHasta']);
...
{
	window.location.href='ordenestrabajo_facturacion_asesor_reporte.php<?= $strParams ?>';
}								
    	...
    	<td>
			<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
      			<tr>
        			...
        			<td height="40"><span class="tituloPagina">Reporte de Facturaci&oacute;n de Ordenes de Trabajo - Asesores</span></td>
   			  </tr>
    		</table>
		</td>
  	</tr>
					...
					<td>
						<table width="100%"  border="0" cellpadding="0" cellspacing="0">
							<tr class="bordeGrisFondo">
								<td width="30%" height="25" class="bordeGrisTitulo"><div id="margen"><strong>Asesor</strong></div></td>
							...
							foreach ($arrAsesores as $oAsesor)
							{
								$TotalFacturadas = 0;
								$oUsuario = $oUsuarios->GetById($oAsesor->IdUsuario);
								
								$oReporteFacturadoOrdenReparacion = $oOrdenesTrabajo->GetReporteOTFacturadas(TipoVenta::OrdenReparacion, $filter['FechaDesde'], $filter['FechaHasta'], Categorias::Taller, null, $oUsuario->IdUsuario);
