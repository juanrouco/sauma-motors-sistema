...
if (!Session::CheckPerm(PERM_PROV_LIST))
	Session::NoPerm();
...
$Paginado	= Pageable::PrintPaginator($oPage, $oProvincias->GetCountRows($filter), true);
$arrData 	= $oProvincias->GetAll($filter, $oPage);
            ...
            <td>
                <table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
                    <tr>
                        ...
                        <td height="40"><span class="tituloPagina">Administraci&oacute;n de Provincias</span></td>
                    </tr>
                </table>
            </td>
        </tr>
            ...
            <td height="30" valign="top">
                ...
                <?php if (Session::CheckPerm(PERM_PROV_CREATE)){ ?>
                    <tr>
                        ...
                        <td height="40"><a href="provincias_add.php<?=$strParams?>">Agregar</a></td>
                    </tr>
                <?php } ?>
                </table>
            </td>
                          	...
                          	<td class="tituloMenu">
                            	<table border="0" cellspacing="0" cellpadding="0">
                            		<tr>
                              			...
                              			<td><select name="FilterPais" id="FilterPais"  class="camporFormularioSimple">
    ...
    <?php if ($arrData != NULL) { ?>
        ...
        <tr>
            <td>
                ...
                <?php foreach ($arrData as $oProvincia) { ?>
                    <?php $oPais = $oPaises->GetById($oProvincia->IdPais); ?>
                
                    <tr onMouseOver="bgColor='#f3f3f3'" onMouseOut="bgColor=''">
                        <td width="5" class="bordeGrisTitulo">&nbsp;</td>
                        <td width="200" height="25"><div id="margen"><?=($PaisAnterior != $oPais->Nombre) ? $oPais->Nombre : "";?></div></td>
                      	<td height="25"><?=$oProvincia->Nombre?></td>
                        <td width="100" height="25">
                            <div align="center">
                            <?php if (Session::CheckPerm(PERM_PROV_UPDATE)){ ?>
                                <a href="provincias_mod.php<?=$strParams?>&IdProvincia=<?=$oProvincia->IdProvincia?>">
                                    <img src="images/iconos/mod.gif" alt="Modificar" border="0" /></a> - 
                            <?php } ?>
                            <?php if (Session::CheckPerm(PERM_PROV_DELETE)){ ?>
                                <a href="provincias_del.php<?=$strParams?>&IdProvincia=<?=$oProvincia->IdProvincia?>">
