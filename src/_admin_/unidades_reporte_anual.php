            ...
            <td>
                <table width="100%" align="center" cellpadding="0" cellspacing="0" class="bordeGris">
                    <tr class="bordeGrisFondo">
						...
						<td height="25" class="bordeGrisTitulo"><div id="margen" align="center"><strong>Cantidad Vendidas 2015</strong></div></td>
						<td height="25" class="bordeGrisTitulo"><div id="margen" align="center"><strong>Cantidad Vendidas 2016</strong></div></td>		
                    </tr>
          
                <?php foreach ($arrModelos as $oModelo) 
				{
					$filterVendido = array();
					$filterVendido['FechaDesde'] 		= '2015-01-01';	
					$filterVendido['FechaHasta'] 		= '2015-12-31';
					$filterVendido['IdModelo'] 			= $oModelo->IdModelo;
					$TotalVendido 	= $oUnidades->GetTotalReporteVendidos($filterVendido);	
					$filterVendido['FechaDesde'] 		= '2016-01-01';	
					$filterVendido['FechaHasta'] 		= '2016-12-31';
					$filterVendido['IdModelo'] 			= $oModelo->IdModelo;
					$TotalVendido2 	= $oUnidades->GetTotalReporteVendidos($filterVendido);	
                ?>
                    <tr onMouseOver="bgColor='#f3f3f3'" onMouseOut="bgColor=''">
						<td width="50%" height="25"><div id="margen" align="left"><?= $oModelo->DenominacionComercial ?></div></td>  
						<td width="25%" height="25"><div id="margen" align="center"><?= $TotalVendido->CantidadTotal ?></div></td>  
						<td width="25%" height="25"><div id="margen" align="center"><?= $TotalVendido2->CantidadTotal ?></div></td>   
                    </tr>
                    <tr>
                        <td colspan="24">
                            <div align="center">
