...
if ($Page > $StockMovimientos->GetPagesCountReporteAjuste($oPage, $filter))
	$Page = $StockMovimientos->GetPagesCountReporteAjuste($oPage, $filter);

$oPage 		= new Page($Page);
$oPage->Size = 20;
$arr 			= $StockMovimientos->GetAllAjusteReporte($filter, $oPage);
$CountRows		= $StockMovimientos->GetCountRowsReporteAjuste($filter);
$Paginado		= Pageable::PrintPaginator($oPage, $StockMovimientos->GetPagesCountReporteAjuste($oPage, $filter), $CountRows);
    	...
    	<td>
			<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
      			<tr>
        			...
        			<td height="40"><span class="tituloPagina">Reporte de Ajustes de stock</span></td>
   			  </tr>
    		</table>
		</td>
  	</tr>
  		...
  		<td height="30" valign="top">
			<table border="0" align="right" cellpadding="0" cellspacing="0">
				<tr>
					...
					<td><a href="stockmovimientos_ajuste_exportar.php<?=$strParams?>">Exportar XLS</a></td>
				</tr>
			</table>
		</td>
  	</tr>
    	...
    	<td>
			...
			<table width="100%" align="center" cellpadding="0" cellspacing="0" class="bordeGris">
      			<tr class="bordeGrisFondo">
					...
					<td width="103" height="25" class="bordeGrisTitulo"><div align="center"><strong>Observaciones</strong></div></td>
				</tr>
				<?php
			...
			?>
				<tr onMouseOver="bgColor='#f3f3f3'" onMouseOut="bgColor=''">
                	...
                	<td height="25"><div id="margen"><?=$oUbicacion->Nombre?></div></td>
   	                <td height="25"><div align="center"><?= $oStockMovimiento->Cantidad ?></div></td>
					<td height="25"><div align="center"><?=$oStockMovimiento->Observaciones?></div></td>
				</tr>
	  			<tr>
