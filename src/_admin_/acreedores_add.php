...
if (!Session::CheckPerm(PERM_ACRE_CREATE))
	Session::NoPerm();
...
if ($Submit)
{
	...
	if ($err == 0)
	{
		...
		$oAcreedor->DomicilioCodigoPostal	 		= $DomicilioCodigoPostal;
		...
		/* crea el usuario */
		$oAcreedor = $oAcreedores->Create($oAcreedor);
...
else
{
	...
	$EnteJuridicoFechaInscripcion 	= date('d-m-Y');
}
                        ...
                        <tr>
                            <td height="30">
                                <div align="center">
                                    ...
                                    <input type="button" name="btnCancelar" id="btnCancelar" class="botonBasico" onclick="javascript: window.location.href = 'acreedores.php<?=$strParams?>';" value="Cancelar" />
                                </div>
                            </td>
                        </tr>
                    </table>
