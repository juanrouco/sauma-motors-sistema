	...
	switch ($Action)
	{
		case 'AddNueva':
			try
			{
				...
				$oUsadoArreglo->IdUsado = $IdUsado;
				$oUsadoArreglo->Importe	= floatval($_REQUEST['Importe']);;
				$oUsadoArreglo->Detalle = $_REQUEST['Detalle'];
				
				$oUsadoArreglo = $oUsadosArreglos->Create($oUsadoArreglo);
		...
		case 'Delete':
			try
			{
				$oUsadoArreglo = $oUsadosArreglos->GetById($Id);
				
				$oUsadosArreglos->Delete($oUsadoArreglo->IdUsadoArreglo);
			}
			catch (Exception $ex)
			{
			}
				...
				<td>
					<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
						<tr>
							...
							<td height="40"><span class="tituloPagina">Usado N&deg; <?= $IdUsado ?>: Arreglos</span></td>
						</tr>
					</table>			
				</td>
			</tr>
...
<tr>
			...
			<tr height="20">
				<td><span class="tituloCategoriaMenu">Arreglos cargados al usado N&deg; <?= $IdUsado ?>:</span></td>
			</tr>
			<tr>
				<td>&nbsp;</td>
			</tr>
			<tr>
				<td>
					<table width="100%" align="center" cellpadding="0" cellspacing="0" class="bordeGris">
						...
						<?php 
						$Total = 0;
						foreach ($arrUsadosArreglos as $oRelacion) 
						{ 
						...
						<tr onMouseOver="bgColor='#f3f3f3'" onMouseOut="bgColor=''">
							...
							<td>
								<div align="center">
									<a href="#bottom" onClick="javascript: Delete(<?=$oRelacion->IdUsadoArreglo?>)">
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
						<tr>
							<td height="30">
								<div align="right">
									<label>
										<input name="button" type="button" class="botonBasico" id="button" onclick="javascript: window.location.href = 'usados.php<?=$strParams?>';" value="Finalizar" />
									</label>
								</div>
							</td>
