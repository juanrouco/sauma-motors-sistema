...
{	
	window.location.href = 'ordenessalida.php';
}								
            ...
            <td>
                <table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
                    <tr>
                        ...
                        <td height="40"><span class="tituloPagina">Administraci&oacute;n de &Oacute;rdenes de Salida</span></td>
                    </tr>
                </table>		
            </td>
        </tr>
                        ...
                        <td width="8%" height="40">
                            <table border="0" align="left" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    ...
                                    <td><a href="ordenessalida_add.php<?=$strParams?>">Agregar</a></td>
                                </tr>
                                <?php } ?>
                            </table>
                        </td>
            ...
            <td>
                ...
                <?php 
					foreach ($arrData as $oOrdenSalida) 
					{
						...
						$oUnidad = $oUnidades->GetById($oOrdenSalida->IdUnidad);
						$oModelo = $oModelos->GetById($oUnidad->IdModelo);
				?>
          
                    <tr onMouseOver="bgColor='#f3f3f3'" onMouseOut="bgColor=''">
                        <td width="81" height="25"><div id="margen" align="center"><?=$oOrdenSalida->IdUnidad?></div></td>
                        <td width="64" height="25"><div id="margen" align="center"><?=$oUnidad->NumeroVin?></div></td>
                        <td width="263" height="25"><div id="margen"><?=$oModelo->DenominacionComercial?></div></td>
                        ...
                        <td width="93" height="25" valign="middle">
                            <div align="center">
                                <a href="ordenessalida_pdf.php<?=$strParams?>&IdOrden=<?=$oOrdenSalida->IdOrden?>" target="_blank"><img src="images/iconos/pdf.png" alt="Generar Comprobante" border="0" /></a> - 
                                <a href="ordenessalida_details.php<?=$strParams?>&IdOrden=<?=$oOrdenSalida->IdOrden?>"><img src="images/iconos/preview.gif" alt="Ver Detalles" border="0" /></a> - 
                            <?php if (Session::CheckPerm(PERM_ORDS_DELETE) && false){ ?>
                                <a href="ordenessalida_del.php<?=$strParams?>&IdOrden=<?=$oOrdenSalida->IdOrden?>"><img src="images/iconos/del.gif" alt="Anular" border="0" /></a>
                            <?php } ?>
                            </div>
                        </td>
                    </tr>
