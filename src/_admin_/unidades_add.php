...
if ($Submit)
{
	...
	if ($NumeroVin == '' && $IdUbicacion != Ubicacion::Transito)
		$err |= 4;
	elseif ($oUnidades->GetByNumeroVin($NumeroVin))
		$err |= 8;
	if (($NumeroVinPrefijo != '') && ($NumeroVin != '') && ($oUnidades->GetByNumeroChasis($NumeroVinPrefijo . $NumeroVin)) && $IdUbicacion != Ubicacion::Transito)
		$err |= 16;
	/*if ($NumeroMotor == '' && $IdEstado != EstadoUnidad::PreVenta)
		$err |= 32;
	else*/
	if ($NumeroMotor != '' && $oUnidades->GetByNumeroMotor($NumeroMotor))
		$err |= 64;
	if ($IdUbicacion == '')
		$err |= 128;
	if ($IdEstado == '')
	...
	if ($err == 0)
	{
		...
		$oUnidad->DNRPA					= $DNRPA;
		$oUnidad->LugarPatentamiento	= $LugarPatentamiento;
		...
		$oUnidad->Cosignacion			= $Cosignacion;
		...
		$oUnidad = $oUnidades->Create($oUnidad);
		
		$urlToGo = "Location: unidades.php" . $strParams;
...
else
{
	...
	$oEstadoUnidad = $oEstadosUnidad->GetById(EstadoUnidad::Stock);

	$IdEstado		= $oEstadoUnidad->IdEstado;
	$Estado			= $oEstadoUnidad->Nombre;
	$EstadoCodigo	= $oEstadoUnidad->Codigo;

	/* obtenemos la ubicacion por defecto */
	$oUbicacion = $oUbicaciones->GetById(Ubicacion::Transito);
...
{
	var Url = 'modelos.php?MainAction=Select';
    	...
    	<td>
			<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
      			<tr>
        			...
        			<td height="40"><span class="tituloPagina">Administraci&oacute;n de de unidades - Agregar</span></td>
      			</tr>
    		</table>
		</td>
  	</tr>
							...
							<td class="bordeGris">
								<table width="80%" border="0" align="center" cellpadding="0" cellspacing="0">
                                                                        ...
                                                                        <tr>
                                                                            <td>
                                                                                <div align="left">
																					...
																					&nbsp;<input type="button" id="btnSelectMinuta" class="botonBasico"  onClick="javascript:SelectModelo();" value=" ? " />
																					<script language="">
									...
									<tr>
                                    	<td>
                                        	<div align="center">
                                                <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
                                                    <tr>
