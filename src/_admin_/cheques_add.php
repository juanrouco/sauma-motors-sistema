...
if (!Session::CheckPerm(PERM_CHEQUE_CREATE))
	Session::NoPerm();
...
if ($Submit)
{
	...
	if ($err == 0)
	{
		...
		$oCheque = $oCheques->Create($oCheque);
    	...
    	<td>
			<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
      			<tr>
        			...
        			<td height="40"><span class="tituloPagina">Administraci&oacute;n de Cheques - Agregar</span></td>
      			</tr>
    		</table>
		</td>
  	</tr>
                                                            ...
                                                            <div align="left">
																<select name="Banco" id="Banco" class="camporFormularioSimple">
																	...
																	<?php foreach ($arrCajasDeposito as $oCajaDetalle) { ?> 
																		<option value="<?=$oCajaDetalle->IdCajaDetalle?>" <?= $Banco == $oCajaDetalle->IdCajaDetalle ? 'selected="selected"' : '' ?>><?=$oCajaDetalle->Nombre?></option>
																	<?php } ?>
