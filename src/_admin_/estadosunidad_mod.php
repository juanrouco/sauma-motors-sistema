...
if (!Session::CheckPerm(PERM_ESTU_UPDATE))
	Session::NoPerm();
...
if (!$oEstadoUnidad = $oEstadosUnidad->GetById($IdEstado))
{	
	header("Location: estadosunidad.php" . $strParams);
	exit();
}
...
if ($Submit)
{
	...
	if ($Nombre == '')
		$err |= 2;
	elseif (($oEstadoUnidad->Nombre != $Nombre) && ($oEstadosUnidad->GetByNombre($Nombre)))
		$err |= 4;
	...
	if ($err == 0)
	{
		...
		$oEstadoUnidad = $oEstadosUnidad->Update($oEstadoUnidad);
...
{
	$Codigo = $oEstadoUnidad->Codigo;
	$Nombre = $oEstadoUnidad->Nombre;
	$Color 	= $oEstadoUnidad->Color;
}
...
<table width="90%"  border="0" align="center" cellpadding="0" cellspacing="0" class="bordeGris">
    	...
    	<td>
			<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
      			<tr>
        			...
        			<td height="40"><span class="tituloPagina">Administraci&oacute;n de Estados de Unidad - Modificar</span></td>
      			</tr>
    		</table>
		</td>
  	</tr>
  	...
  	<tr>
    	<td>
			<div align="center">
      		<form name="frmData" id="frmData" method="post" action="estadosunidad_mod.php<?=$strParams?>">
					...
					<tr>
						<td class="bordeGris">
							<table  border="0" align="center" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td width="203"><div align="right">Color:</div></td>
                                    <td>
					...
					<tr>
						<td height="30">
							<div align="center">
								...
								<input type="button" name="btnCancelar" class="botonBasico" id="btnCancelar" onclick="javascript: window.location.href = 'estadosunidad.php<?=$strParams?>';" value="Cancelar" />
							</div>
						</td>
					</tr>
				</table>
