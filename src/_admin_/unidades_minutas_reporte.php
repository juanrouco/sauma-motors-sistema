...
$Paginado	= Pageable::PrintPaginator($oPage, $oUnidades->GetCountRowsReporteMinutas($filter), true);
$arrData 	= $oUnidades->GetAllReporteMinutas($filter, $oPage);

$oReporteTotal = $oUnidades->GetTotalReporteMinutas($filter);
            ...
            <td>
				...
				?>          
                    <tr onMouseOver="bgColor='#f3f3f3'" onMouseOut="bgColor=''">
                        ...
                        <td width="81" height="25"><div id="margen"><?=$oUnidad->NumeroVin?></div></td>
