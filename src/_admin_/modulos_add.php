...
if (!Session::CheckPerm(PERM_MODU_CREATE))
	Session::NoPerm();
...
if ($Submit)
{
	...
	if ($Nombre == '')
		$err |= 1;
	elseif ($oModulosAux = $oModulos->GetByNombre($Nombre))
		$err |= 2;
	...
	if ($err == 0)
	{
		...
		$oModulo = $oModulos->Create($oModulo);
		
		if ($oModulo)
		{
			header("Location: modulos_permisos.php" . $strParams . "&IdModulo=" . $oModulo->IdModulo);
			exit();
		}
	}
}
    	...
    	<td>
			<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
      			<tr>
        			...
        			<td height="40"><span class="tituloPagina">Administraci&oacute;n de Módulos - Agregar</span></td>
      			</tr>
    		</table>
		</td>
  	</tr>
