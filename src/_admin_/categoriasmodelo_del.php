...
if (!Session::CheckPerm(PERM_CATM_DELETE))
	Session::NoPerm();
...
if ($Submit)
{
	$oCategoriaModelo = $oCategoriasModelo->Delete($oCategoriaModelo->IdCategoriaModelo);
...
<table width="90%"  border="0" align="center" cellpadding="0" cellspacing="0" class="bordeGris">
	...
	<tr>
		<td>
			...
			<?php if ($oCategoriaModelo->CanDelete()) { ?>
					...
					<tr>
						<td class="bordeGris">
							<table  border="0" align="center" cellpadding="0" cellspacing="0">
								...
								<tr>
									<td><div align="center" class="campoEliminar"><?=$oCategoriaModelo->Nombre?></div></td>
								</tr>
								<tr>
									<td>&nbsp;</td>
								</tr>
						...
						<tr>
						  	<td height="30">
								<div align="center">
									...
									<input type="button" name="btnCancelar" class="botonBasico" id="btnCancelar" value="Cancelar" onClick="javascript: window.location.href = 'categoriasmodelo.php<?=$strParams?>';">
								</div>
							</td>
						</tr>
					</form>
				...
				<table width="60%"  border="0" align="center" cellpadding="0" cellspacing="0">
  				...
  				<table width="60%"  border="0" align="center" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
                    <tr>
                        <td height="30">
                            <div align="center">
                              <input type="button" class="botonBasico" value="Volver" onclick="javascript: window.location.href = 'categoriasmodelo.php<?=$strParams?>'" />
                            </div>
                        </td>
                    </tr>
				</table>
