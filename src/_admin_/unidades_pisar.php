...
if (!Session::CheckPerm(PERM_UNID_PISAR))
	Session::NoPerm();
    	...
    	<td>
			<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
      			<tr>
        			...
        			<td height="40"><span class="tituloPagina">Administraci&oacute;n de Unidades - Pisar Unidad</span></td>
      			</tr>
    		</table>
		</td>
  	</tr>
                        ...
                        <td class="bordeGris">
                            <table width="80%" border="0" align="center" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
									<td>&nbsp;</td>
                                    <td>&nbsp;</td>
                                    <td><?php if ($err & 1) { ?><li style="color: red">Debe ingresar uun comentario para pisar la unidad.<?php } ?>&nbsp;</li></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
