...
if (!Session::CheckPerm(PERM_PERF_UPDATE))
	Session::NoPerm();
...
if ($Submit)
{
	...
	if ($Nombre == '')
		$err |= 1;
	elseif (($oPerfil->Nombre != $Nombre) && ($oPerfiles->GetByNombre($Nombre)))
		$err |= 2;
	...
	if ($err == 0)
	{
		...
		$oPerfil = $oPerfiles->Update($oPerfil);
    	...
    	<td>
			<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
      			<tr>
        			...
        			<td height="40"><span class="tituloPagina">Administraci&oacute;n de Perfiles - Modificar</span></td>
      			</tr>
    		</table>
		</td>
  	</tr>
