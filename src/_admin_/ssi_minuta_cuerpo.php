				...
				<form name="frmData" id="frmData" method="post" action="<?=$strParams?>" onsubmit="document.getElementById('btnAceptar').disabled = 'disabled'; return true;">
                                                    ...
                                                    <tr>
                                                            ...
                                                            <table border="0" align="center" cellpadding="0" cellspacing="0">
																...
																<tr>
																	<td> <table border="0" align="left" cellpadding="0" cellspacing="0">
                                                                            <tr>
                                                                                <td><div id="margen" align="left">Horario Estimado de  Retiro:</div></td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td>
                                                                                    <div align="left">
                                                        ...
                                                        <td valign="top">
                                                            <table border="0" align="center" cellpadding="0" cellspacing="0">
                                                                    ...
                                                                    <td>
                                                                        <table border="0" align="left" cellpadding="0" cellspacing="0">
                                                                            ...
                                                                            <tr>
                                                                                <td>
                                                                                    <div align="left">
                                                                                        <input type="text" name="PrecioVentaTotal" id="PrecioVentaTotal" class="camporFormularioSimple" maxlength="10" onKeyPress="javascript: if (event.keyCode &lt; 45 || event.keyCode &gt; 57) event.returnValue = false;" value="<?=$PrecioVentaTotal?>" />
                                                                                    </div>
                                                                                </td>
                                                                                <td><span style="color:#FF0000;">&nbsp;(*)</span></td>
                                                                            </tr>
                                                                ...
                                                                <tr>
                                                                    <td height="20">
																		<?php if ($err & 16) { ?><li style="color:#FF0000;">Ingrese precio de venta</li><?php } ?>
																		<?php if ($err & (65536 * 2)) { ?><li style="color:#FF0000;">El precio de venta debe ser mayor al precio contado (o cr&eacute;dito) + Formularios</li><?php } ?>
																	</td>
                                                                </tr>
																<?php
																$oUsuario = Session::GetCurrentUser();
																if ($oUsuario->IdPerfil != 2)
																{
																?>
                                                                ...
                                                                <tr>
                                                                    <td height="20"><?php if ($err & 16) { ?><li style="color:#FF0000;">Ingrese precio de facturaci&oacute;n</li><?php } ?></td>
                                                                </tr>
                                                                <tr>
                                                                    <td>
                                                                        <table border="0" align="left" cellpadding="0" cellspacing="0">
																...
																{
																?>
																<input type="hidden" name="PrecioVenta" id="PrecioVenta" class="camporFormularioSimple" value="<?=$PrecioVenta?>" />
																<input type="hidden" name="GastosOtorgamiento" id="GastosOtorgamiento" value="<?=$GastosOtorgamiento?>" />
																<?php
																}
																?>
                                                                <tr>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <table border="0" align="left" cellpadding="0" cellspacing="0">
                                                                            <tr>
                                                                                <td><div id="margen" align="left">Inter&eacutes;:</div></td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td>
                                                                                    <div align="left">
                                                                                        <input type="text" name="Interes" id="Interes" class="camporFormularioSimple" maxlength="10" onKeyPress="javascript: if (event.keyCode &lt; 45 || event.keyCode &gt; 57) event.returnValue = false;" value="<?=$Interes?>" />
                                                                                    </div>
                                                                                </td>
                                                                                <td><span style="color:#FF0000;">&nbsp;</span></td>
                                                                            </tr>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <table border="0" align="left" cellpadding="0" cellspacing="0">
                                                                            <tr>
                                                                                <td><div id="margen" align="left">Nro. Garantia:</div></td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td>
                                                                                    <div align="left">
                                                                                        <input type="text" name="NumeroGarantia" class="camporFormularioSimple" id="NumeroGarantia" value="<?= $NumeroGarantia ?>">
						...
						<tr>
							<td height="30">
								<div align="center">
									...
									<input type="button" name="btnCancelar" class="botonBasico" id="btnCancelar" onclick="javascript: if (confirm('Est&aacute; seguro que desea salir?\nNo se guardar&aacute;n sus modificaciones')) window.location.href = 'minutas.php<?=$strParams?>';" value="Cancelar" />
								</div>
							</td>
						</tr>
					</table>
