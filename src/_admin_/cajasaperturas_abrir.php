...
if ($oCajasAperturas->GetUltimoTipoApertura() == 1)
{
	header('Location: cajasaperturas_cerrar.php');
	exit;
}
...
if ($Submit)
{
	...
	if ($err == 0)
	{
		...
		$oCajaMovimiento->IdTipoMovimiento		= TiposMovimientosCaja::Apertura;
            ...
            <td>
                <table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
                    <tr>
                        ...
                        <td height="40"><span class="tituloPagina">Apertura de Caja <?= $oCajaDetalle->Nombre ?></span></td>
                  </tr>
                </table>
            </td>
        </tr>
                            ...
                            <td class="bordeGris">
                                <table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div align="left">
                                                <input type="text" name="Importe" id="Importe" class="camporFormularioChico" maxlength="16" readonly="true" value="<?=$Importe;?>" />
