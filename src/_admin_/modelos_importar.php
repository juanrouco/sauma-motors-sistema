...
if ($Submit)
{
	...
	if ($err == 0)
	{
		...
		if ($oUpload->UploadFile())
		{
			...
			$Mensaje = $oModelos->Import($oUpload->GetNombre());
            ...
            <td>
                <table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
                    <tr>
                        ...
                        <td height="40"><span class="tituloPagina">Administraci&oacute;n de Modelos - Importar</span></td>
                  	</tr>
                </table>
            </td>
        </tr>
                    ...
                    <table width="60%"  border="0" align="center" cellpadding="0" cellspacing="0">
      				...
      				<table width="60%"  border="0" align="center" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
      					<tr>
                            <td height="30">
                                <div align="center">
                        	        <input type="button" name="btnAceptar" class="botonBasico" id="btnAceptar" onclick="javascript: window.location.href = 'modelos.php';" value="Aceptar" />                			
                                </div>
                            </td>
                        </tr>
                    </table>
