...
$arrData 	= $oPresupuestos->GetAll($filter, $oPage);
            ...
            <td>
                <table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
                    <tr>
                        ...
                        <td height="40"><span class="tituloPagina">Administraci&oacute;n de Facturas Proforma</span></td>
                    </tr>
                </table>		
            </td>
        </tr>
                    ...
                    <tr onMouseOver="bgColor='#f3f3f3'" onMouseOut="bgColor=''">
                        ...
                        <td width="103" height="25" valign="middle">
                            <div align="center">
								...
								<a href="presupuestos_pdf.php<?=$strParams?>&IdPresupuesto=<?=$oPresupuesto->IdPresupuesto?>">
                                    <img src="images/iconos/pdf.png" alt="Detalle" border="0" /></a> - 
								<?php
                                ...
                                <?php 
									...
									{ 
										if ($oPresupuesto->IdEstado == PresupuestoEstados::Perdido)
										{
								?>
                                <a href="presupuestos_motivo_perdida.php<?=$strParams?>&IdPresupuesto=<?=$oPresupuesto->IdPresupuesto?>">
                                    <img src="images/iconos/permisos.gif" alt="Motivo Perdida" border="0" /></a> - 
								<?php
										}
								?>
