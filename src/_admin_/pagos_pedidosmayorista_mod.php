...
if ($Submit)
{
	...
	if ($err == 0)
	{
		...
		$oPagoMayorista = $oPagosMayorista->Update($oPagoMayorista);
...
{
	$IdPedidoMayorista 	= $oPagoMayorista->IdPedidoMayorista;
	$IdTipoPago			= $oPagoMayorista->IdTipoPago;
	$Fecha	 			= CambiarFecha($oPagoMayorista->Fecha);
	$Importe			= $oPagoMayorista->Importe;
	$BancoDestino		= $oPagoMayorista->BancoDestino;
	$BancoDesde			= $oPagoMayorista->BancoDesde;
	$Cliente			= $oPagoMayorista->Cliente;
	$NumeroCheque		= $oPagoMayorista->NumeroCheque;
	$FechaEmision		= CambiarFecha($oPagoMayorista->FechaEmision);
	$FechaDeposito		= CambiarFecha($oPagoMayorista->FechaDeposito);
}
