...
if ($Submit)
{
	...
	if ($Nombre == '')
		$err |= 2;
	elseif ($oTiposVehiculo->GetByNombre($Nombre))
		$err |= 4;
	...
	if ($err == 0)
	{
		...
		$oTipoVehiculo = $oTiposVehiculo->Create($oTipoVehiculo);
    	...
    	<td>
			<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
      			<tr>
        			...
        			<td height="40"><span class="tituloPagina">Administraci&oacute;n de Tipos de Veh&iacute;culo - Agregar</span></td>
      			</tr>
    		</table>
		</td>
  	</tr>
