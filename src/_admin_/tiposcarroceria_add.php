...
if ($Submit)
{
	...
	if ($Nombre == '')
		$err |= 2;
	elseif ($oTiposCarroceria->GetByNombre($Nombre))
		$err |= 4;
	...
	if ($err == 0)
	{
		...
		$oTipoCarroceria = $oTiposCarroceria->Create($oTipoCarroceria);
...
<table width="90%"  border="0" align="center" cellpadding="0" cellspacing="0" class="bordeGris">
	<tr>
    	<td>
			<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
      			<tr>
        			...
        			<td height="40"><span class="tituloPagina">Administraci&oacute;n de Tipos de Carroceria - Agregar</span></td>
      			</tr>
    		</table>
		</td>
  	</tr>
  	...
  	<tr>
    	<td>
			<div align="center">
				<form name="frmData" id="frmData" action="<?=$strParams?>" method="post">
