...
{	
	window.location.href = 'comisionesusados.php?MainAction=<?=$Action?>';
}								
            ...
            <td>
                <table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
                    <tr>
                        ...
                        <td height="40"><span class="tituloPagina">Administraci&oacute;n de Comisiones de Usados</span></td>
                    </tr>
                </table>		
            </td>
        </tr>
                        ...
                        <td width="80%" height="40">
                            <table border="0" align="right" cellpadding="0" cellspacing="0">
                                <tr>
                                    ...
                                    <td><a href="comisionesusados_exportar_pdf.php<?=$strParams?>">Exportar PDF</a></td>
                                </tr>
                            </table>
                        </td>
                        <td width="12%" height="40">
                            <table border="0" align="right" cellpadding="0" cellspacing="0">
                                <tr>
                                    ...
                                    <td><a href="comisionesusados_exportar.php<?=$strParams?>">Exportar XLS</a></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
            ...
            <td>
				...
				?>
                    ...
                    <tr onMouseOver="bgColor='#f3f3f3'" onMouseOut="bgColor=''">
                        ...
                        <td width="80" height="25"><div id="margen" align="center">$<?= number_format($oMinuta->PrecioVenta, 2, ',', '.') ?></div></td>
                        <td width="85" height="25">
							<div id="margen" align="center">
								$<input type="text" id="Comision_<?= $oMinuta->IdMinuta ?>" name="Comision" class="camporFormularioChicoSuggest" style="text-align: center" value="<?= number_format($oMinuta->PrecioVenta  / 1.21 * Config::ComisionUsados / 100, 2, ',', '.') ?>" />
							</div>
						</td>
                    </tr>
                    <tr>
