                                                                    ...
                                                                    <td>
                                                                        <table border="0" align="left" cellpadding="0" cellspacing="0">
                                                                            ...
                                                                            <tr>
                                                                                <td>
                                                                                    <div align="left">
                                                                                        <input type="text" name="Cliente" id="Cliente" class="camporFormularioSuggestDisabled" maxlength="128" value="<?=$Cliente?>" onkeyup="javascript: StrToUpper(this.id);" readonly="readonly" />
                                                                                        <script language="javascript">
                                                                    ...
                                                                    <td>
                                                                        <table border="0" align="left" cellpadding="0" cellspacing="0">
                                                                            ...
                                                                            <tr>
                                                                                <td>
                                                                                    <div align="left">
                                                                                        <input type="text" name="Usuario" id="Usuario" class="camporFormularioSuggestDisabled" maxlength="128" value="<?=$Usuario?>" onkeyup="javascript: StrToUpper(this.id);" readonly="readonly" />
                                                                                        <script language="javascript">
