            ...
            <td>
                <table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
                    <tr>
                        ...
                        <td height="40"><span class="tituloPagina">Administraci&oacute;n de Comprobantes - <?=ComprobanteTipos::GetDescripcionById($filter['IdTipoComprobante'])?></span></td>
                    </tr>
                </table>		
            </td>
        </tr>
            ...
            <td height="30" valign="top">
                ...
                <?php if (Session::CheckPerm(PERM_CMPB_CREATE)){ ?>
                    <tr>
                        ...
                        <td height="40"><a href="comprobantes_add.php<?=$strParams?>">Agregar</a></td>
                        <td width="10">&nbsp;</td>
                    </tr>
                <?php } ?>
                </table>		
    ...
    <?php if ($arrData != NULL) { ?>
        ...
        <tr>
            <td>
                ...
                <?php foreach ($arrData as $oComprobante) { ?>
          
                    <tr onMouseOver="bgColor='#f3f3f3'" onMouseOut="bgColor=''">
                        <td width="4" class="bordeGrisTitulo">&nbsp;</td>
                        <td width="259" height="25"><div id="margen"><?=$oComprobante->Prefijo . ' - ' . $oComprobante->Numero?></div></td>
                        <td width="610" height="25"><div id="margen"><?=ComprobanteEstados::GetById($oComprobante->IdEstado)?></div></td>
                        <td width="82" height="25" valign="middle">
                            <div align="center"> 
						<?php if ($oComprobante->IdEstado != ComprobanteEstados::Anulado){ ?>
                            <?php if (Session::CheckPerm(PERM_CMPB_UPDATE)){ ?>
                                <a href="comprobantes_anular.php<?=$strParams?>&IdComprobante=<?=$oComprobante->IdComprobante?>">
