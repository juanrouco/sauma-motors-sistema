...
$IdModeloPV	= strval($_REQUEST['IdModeloPV']);
...
if ($Submit)
{
	...
	if ($err == 0)
	{
		...
		$oModeloPV = $oModelosPV->Update($oModeloPV);
    	...
    	<td>
			<div align="center">
				<form name="frmData" id="frmData" method="post" action="<?=$strParams?>">
					...
					<input type="hidden" name="IdModeloPV" id="IdModeloPV" value="<?= $IdModeloPV ?>" />
