            ...
            <td>
                <table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
                    <tr>
                        ...
                        <td height="40"><span class="tituloPagina">Administraci&oacute;n de Unidades con deuda</span></td>
                    </tr>
                </table>		
            </td>
        </tr>
            ...
            <td>
				...
				<table width="100%" align="center" cellpadding="0" cellspacing="0" class="bordeGris">
                    <tr class="bordeGrisFondo">
						...
						<td height="25" class="bordeGrisTitulo"><div id="margen" align="center"><strong>Deuda</strong></div></td>						
                    </tr>
                ...
                <?php foreach ($arrData as $oUnidad) 
				{
					...
					$TotalBruto+= $oUnidad->ImporteNotaCredito;
					$TotalDeuda+= $ImporteAAbonar;
				?>          
                    <tr onMouseOver="bgColor='<?= $oUnidad->IdEstado == EstadoUnidad::Reservado ? '#F4DA80': ($oUnidad->Pisado ? '#ADECDF' : '#f3f3f3') ?>'" onMouseOut="bgColor='<?= $oUnidad->IdEstado == EstadoUnidad::Reservado ? '#F4DA80':($oUnidad->Pisado ? '#ADECDF' : '') ?>'" bgColor='<?= $oUnidad->IdEstado == EstadoUnidad::Reservado ? '#F4DA80':($oUnidad->Pisado ? '#ADECDF' : '') ?>'>
                        ...
                        <td width="261" height="25"><div id="margen"><?=$oProveedor->Empresa?></div></td>
                ...
                <?php } ?>   
                    ...
                    <tr>
                        <td colspan="9">&nbsp;</td>
                        <td id="margen"><strong>Total:</strong>&nbsp;</td>
                        <td id="margen" align="center"><strong>$<?= $TotalBruto ?></strong></td>
                        <td id="margen" align="center"><strong>$<?= $TotalDeuda ?></strong></td>
                    </tr>
