...
if ((!isset($filter)) || (IsEmptyArray($filter)) || ($Submit))
{
	...
	$filter['ConSaldo'] 		= trim($_REQUEST['FilterConSaldo']);
}
...
{
	$Paginado	= Pageable::PrintPaginator($oPage, $oMinutas->GetCountRowsConSaldo($filter), true);
	$arrData 	= $oMinutas->GetAllConSaldo($filter, $oPage);
}
else
{
...
{	
	window.location.href = 'cuentascorriente.php?MainAction=<?=$Action?>';
}								
            ...
            <td>
                <table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
                    <tr>
                        ...
                        <td height="40"><span class="tituloPagina">Administraci&oacute;n de Cuentas Corriente</span></td>
                    </tr>
                </table>		
            </td>
        </tr>
                        ...
                        <td width="35%" height="40">
                            <table border="0" align="right" cellpadding="0" cellspacing="0">
								<tr>
                                    ...
                                    <td><a href="cuentascorriente_exportar.php<?=$strParams?>">Exportar Saldo XLS</a></td>
									<?php /*<td width="30">&nbsp;</td>
									 <td width="30"><div align="center"><img src="images/iconos/pdf.png" alt="Exportar XLS" border="0"></div></td>
                                    <td><a href="cuentascorriente_exportar_pdf.php<?=$strParams?>">Exportar Saldo PDF</a></td>*/ ?>
                                </tr>
                            </table>
                        </td>
                    </tr>
                            ...
                            <td class="tituloMenu">
                                <table border="0" cellspacing="0" cellpadding="0">
									...
									<tr>                              
                                        ...
                                        <td class="tituloMenu"><div align="right">Con Saldo:</div></td>
                                        <td>
                                        	<select name="FilterConSaldo" id="FilterConSaldo"  class="camporFormularioSimple">
												<option value="">[Indistinto]</option>
												<option value="1" <?= $filter['ConSaldo'] == 1 ? 'selected="selected"' : '' ?>>Con Saldo</option>
											</select>
                    ...
                    <tr onMouseOver="bgColor='#f3f3f3'" onMouseOut="bgColor=''">
                        ...
                        <td width="103" height="25" valign="middle">
                            <div align="center">
								...
								<a href="cuentascorriente_pdf.php<?=$strParams?>&IdMinuta=<?=$oMinuta->IdMinuta?>">
                                    <img src="images/iconos/pdf.png" alt="Imprimir" title="Imprimir" border="0" /></a> - 
                                <?php } ?>
								<?php if (Session::CheckPerm(PERM_PAGO_LIST)){ ?>
								<a href="pagos.php<?=$strParams?>&IdMinuta=<?=$oMinuta->IdMinuta?>">
