...
if ($Submit)
{
	...
	if ($err == 0)
	{
		$oClienteContacto->IdCliente 			= $IdCliente;
		...
		$oClienteContacto = $oClienteContactos->Create($oClienteContacto);
    	...
    	<td>
			<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
      			<tr>
        			...
        			<td height="40"><span class="tituloPagina">Administraci&oacute;n de Contactos - Agregar</span></td>
      			</tr>
    		</table>
		</td>
  	</tr>
