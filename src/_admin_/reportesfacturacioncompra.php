...
<form name="frmData" id="frmData" method="post" action="reportesfacturacioncompra_xls.php">
            ...
            <td>
                <table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
                    <tr>
                        ...
                        <td height="40"><span class="tituloPagina">Reportes de Facturas de Compra</span></td>
                    </tr>
                </table>		
            </td>
        </tr>
