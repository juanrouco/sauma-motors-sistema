...
$oContratoPrenda = $oContratosPrendasUsados->GetById($IdContratoPrenda);
if (!$oContratoPrenda)
	$err += 1;

if ($Submit)
{
	$oContratosPrendasUsados->Delete($oContratoPrenda->IdContratoPrenda);
	header("Location: contratosprendasusados.php" . $strParams);
}
		...
		<td>
			<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
				<tr>
					...
					<td height="40"><span class="tituloPagina">Eliminar Contrato de Prenda de Usado</span></td>
			  </tr>
			</table>
		</td>
	</tr>
						...
						<tr>
						  	<td height="30">
								<div align="center">
									...
									<input type="button" name="btnCancelar" class="botonBasico" id="btnCancelar" value="Cancelar" onClick="javascript: window.location.href = 'contratosprendasusados.php<?=$strParams?>';">
								</div>
							</td>
						</tr>
					</form>
