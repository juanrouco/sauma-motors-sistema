        	...
        	<td>
                <table width="90%"  border="0" align="center" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
                    <tr>
                        <td height="30">
                            <div align="center">
                            	<input type="button" name="btnVolver" class="botonBasico" id="btnVolver" value="volver" onClick="javascript: window.location.href='ordenestrabajo_facturacion.php<?=$strParams?>';" />
                            </div>
                        </td>
                    </tr>
                </table>
