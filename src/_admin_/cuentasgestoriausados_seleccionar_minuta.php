...
<body>
            ...
            <td>
                <table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
                    <tr>
                        ...
                        <td height="40"><span class="tituloPagina">Administraci&oacute;n de Cuentas Corriente de Gestoria de Usados - Selecci&oacute;n de Minutas</span></td>
                    </tr>
                </table>		
            </td>
        </tr>
    ...
    <?php if ($arrData != NULL) { ?>
        ...
        <tr>
            <td>
				<form name="frmData1" id="frmData1" method="post" action="cuentasgestoriausados_add.php">
				...
				?>
                    ...
                    <tr onMouseOver="bgColor='#f3f3f3'" onMouseOut="bgColor=''">
                        ...
                        <td width="200" height="25"><div id="margen"><?=$oUsado->Modelo?></div></td>
