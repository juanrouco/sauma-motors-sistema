...
if (!Session::CheckPerm(PERM_TALL_LIST))
	Session::NoPerm();
...
$Paginado	= Pageable::PrintPaginator($oPage, $oTallerUnidades->GetCountRows($filter), true);
$arrData 	= $oTallerUnidades->GetAll($filter, $oPage);
...
{	
	window.location.href = 'tallerunidades.php';
}								
            ...
            <td>
                <table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
                    <tr>
                        ...
                        <td height="40"><span class="tituloPagina">Administraci&oacute;n de Unidades de Taller</span></td>
                    </tr>
                </table>		
            </td>
        </tr>
                        ...
                        <td height="40">
                            <table border="0" align="left" cellpadding="0" cellspacing="0">
                                <tr>
									...
									<td height="40"><a href="tallerunidades_add.php" >Agregar</a></td>
                                </tr>
                            </table>
                        </td>
                                ...
                                <table border="0" cellspacing="0" cellpadding="0">
                                    <tr>                              
                                       <td class="tituloMenu"><div align="right">Dominio:</div></td>
                                        ...
                                        <option value="<?=$oMarca->IdMarca?>" <? if ($oMarca->IdMarca == $filter['IdMarca']) echo "selected='selected'"; ?> ><?=$oMarca->Nombre?></option>
                                        <?php } ?>
                                        </select></td>
										<td>&nbsp;</td>
                                    </tr>
                                    <tr>                              
                                        ...
                                        <td><input name="FilterNumeroVin" id="FilterNumeroVin" type="text" class="camporFormularioSimple" value="<?=$filter['NumeroVin']?>" maxlength="128" onkeyup="javascript: StrToUpper(this.id);"></td>
										<td>&nbsp;</td>
            ...
            <td>
                <table width="100%" align="center" cellpadding="0" cellspacing="0" class="bordeGris">
                    <tr class="bordeGrisFondo">
						...
						<td height="25" class="bordeGrisTitulo"><div id="margen" ><strong>Vin</strong></div></td>
                ...
                <?php 
					foreach ($arrData as $oUnidadTaller) 
					{
						$oMarca = $oMarcas->GetById($oUnidadTaller->IdMarca);
						$oColor = $oColores->GetById($oUnidadTaller->IdColor); 
						$oCliente = $oClientes->GetById($oUnidadTaller->IdCliente); 
				?>
          
                    <tr onMouseOver="bgColor='#f3f3f3'" onMouseOut="bgColor=''">
                        <td width="50" height="25"><div id="margen"><?=$oMarca->Nombre?></div></td>
                        <td width="160" height="25"><div id="margen"><?=$oUnidadTaller->Modelo?></div></td>
                        <td width="120" height="25"><div id="margen"><?=$oColor->Nombre?></div></td>
                        <td width="75" height="25"><div id="margen" align="center"><?= $oUnidadTaller->ModeloAnio ?></div></td>
						<td width="75" height="25"><div id="margen"><?= $oUnidadTaller->NumeroVin ?></div></td>
                        <td width="85" height="25"><div id="margen" align="center"><?= $oUnidadTaller->Dominio ?></div></td>
						...
						<td width="70" height="25">
							<div align="center">
								<a href="tallerunidades_mod.php?<?= $strParams ?>&IdTallerUnidad=<?= $oUnidadTaller->IdTallerUnidad ?>">
									<img src="images/iconos/mod.gif" alt="Modificar" /></a>
								</a>
							</div>
						</td>
                    </tr>
