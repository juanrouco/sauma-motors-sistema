...
if (!Session::CheckPerm(PERM_COMP_UPDATE))
	Session::NoPerm();
...
if ($Submit)
{
	...
	switch ($Action)
	{
		...
		case 'Finish':
			...
			{
				$ImporteCompraNeto = strval($_REQUEST['ImporteCompraNeto_' . $oUnidad->IdUnidad]);

				$oUnidad->ImporteCompraNeto = $ImporteCompraNeto;
		
				/* actualizamos el registro */		
				$oUnidads->Update($oUnidad);
			}	
...
/* obtenemos todas las unidades de la recepcion */
$arrData = $oPlanillaCompra->GetAllUnidades();
            ...
            <td>
                <table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
                    <tr>
                        ...
                        <td height="40"><span class="tituloPagina">Administraci&oacute;n de Datos de Compra - Agregar y Modificar Unidades</span></td>
                    </tr>
                </table>
            </td>
        </tr>
                    ...
                    <tr>
                    	<td>
                            ...
                            <?php if (($err != 0)) { ?>
                                <tr>
                                    <td>&nbsp;</td>
                                    <td align="left"><?php if ($err & 1) { ?><li style="color:#FF0000;">Ingrese nro. vin</li><?php } if ($err & 2) { ?><li style="color:#FF0000;">La unidad ya existe cargada</li><?php } ?></td>
                                    <td>&nbsp;</td>
                                    <td>&nbsp;</td>
            ...
            <td>
                ...
                <?php foreach ($arrData as $oUnidad) { ?>
                    ...
                    <tr onMouseOver="bgColor='#f3f3f3'" onMouseOut="bgColor=''">
                        ...
                        <td width="262" height="25"><div id="margen" align="center"><input type="text" name="ImporteCompraNeto_<?=$oUnidad->IdUnidad?>" id="ImporteCompraNeto_<?=$oUnidad->IdUnidad?>" class="camporFormularioMedianoI" maxlength="128" value="<?=$oUnidad->ImporteCompraNeto?>" onkeyup="javascript: StrToUpper(this.id);" /></div></td>
