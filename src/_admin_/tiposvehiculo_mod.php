...
if (!$oTipoVehiculo = $oTiposVehiculo->GetById($IdTipoVehiculo))
{
	header('Location: tiposvehiculo.php' . $strParams);
	exit;
}
...
if ($Submit)
{
	...
	if ($Nombre == '')
		$err |= 2;
	elseif (($oTipoVehiculo->Nombre != $Nombre) && ($oTiposVehiculo->GetByNombre($Nombre)))
		$err |= 4;
	...
	if ($err == 0)
	{
		...
		$oTipoVehiculo = $oTiposVehiculo->Update($oTipoVehiculo);
...
{
	$Codigo = $oTipoVehiculo->Codigo;
	$Nombre = $oTipoVehiculo->Nombre;
}
    	...
    	<td>
			<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
      			<tr>
        			...
        			<td height="40"><span class="tituloPagina">Administraci&oacute;n de Tipos de Veh&iacute;culo - Modificar</span></td>
      			</tr>
    		</table>
		</td>
  	</tr>
					...
					<tr>
						<td height="30">
							<div align="center">
								...
								<input type="button" name="btnCancelar" class="botonBasico" id="btnCancelar" onclick="javascript: window.location.href = 'tiposvehiculo.php<?=$strParams?>';" value="Cancelar" />
							</div>
						</td>
					</tr>
				</table>
