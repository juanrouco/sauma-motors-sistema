...
if (!Session::CheckPerm(PERM_GESTOR_CREATE))
	Session::NoPerm();
...
if ($Submit)
{
	...
	if ($err == 0)
	{
		...
		$oGestor = $oGestores->Create($oGestor);
    	...
    	<td>
			<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
      			<tr>
        			...
        			<td height="40"><span class="tituloPagina">Administraci&oacute;n de Gestores - Agregar</span></td>
      			</tr>
    		</table>
		</td>
  	</tr>
