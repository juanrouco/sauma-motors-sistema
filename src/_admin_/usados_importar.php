...
if ($Submit)
{
	...
	if ($err == 0)
	{
		...
		if ($oUpload->UploadFile())
		{
			...
			$Mensaje = $oUnidades->Import($oUpload->GetNombre());

			/* eliminamos el archivo */
			Up::DeleteFile(Unidad::PathCsvImportBack, $oUpload->GetNombre());
		}
	}
}
            ...
            <td>
                <table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
                    <tr>
                        ...
                        <td height="40"><span class="tituloPagina">Administraci&oacute;n de Unidades - Importar</span></td>
                  	</tr>
                </table>
            </td>
        </tr>
