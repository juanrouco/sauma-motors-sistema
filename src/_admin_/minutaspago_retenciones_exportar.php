...
<form name="frmData" id="frmData" method="post" action="minutaspago_retenciones_exportar_pdf.php">
            ...
            <td>
                <table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
                    <tr>
                        ...
                        <td height="40"><span class="tituloPagina">Exportar Retenciones</span></td>
                    </tr>
                </table>		
            </td>
        </tr>
