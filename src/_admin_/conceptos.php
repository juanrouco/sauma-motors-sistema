...
if ($Page > $Conceptos->GetPagesCount($oPage, $filter))
	$Page = $Conceptos->GetPagesCount($oPage, $filter);

$oPage 			= new Page($Page);
$oPage->Size 	= 20;
$arr 			= $Conceptos->GetAll($filter, $oPage);
$CountRows		= $Conceptos->GetCountRows($filter);
$Paginado		= Pageable::PrintPaginator($oPage, $Conceptos->GetPagesCount($oPage, $filter), $CountRows);
...
{	
	window.location.href = 'conceptos.php';
}								
    	...
    	<td>
			<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
      			<tr>
        			...
        			<td height="40"><span class="tituloPagina">Conceptos</span></td>
      			</tr>
    		</table>		</td>
  	</tr>
  	<tr>
    	<td height="30" valign="top">
			<table width="100%"  border="0" cellspacing="0" cellpadding="0">
        		...
        		<?php if (Session::CheckPerm(PERM_RUBR_CREATE)){ ?>
        			...
        			<td height="40"><a title="Agregar" href="conceptos_add.php<?=$strParams?>">Agregar</a></td>
                <?php } ?>
    	...
    	<td>
			...
			<table width="100%" align="center" cellpadding="0" cellspacing="0" class="bordeGris">
			  <tr class="bordeGrisFondo">
                <td height="25" class="bordeGrisTitulo"><div id="margen"><strong>Concepto</strong></div></td>
		  		<td width="100" height="25"  class="bordeGrisTitulo"><div align="center" ><strong>Acciones</strong></div></td>
   			  </tr>
      
	  		<?php foreach ($arr as $oConcepto) { ?>
      
            <tr onMouseOver="bgColor='#f3f3f3'" onMouseOut="bgColor=''">
	            <td height="25"><div id="margen"><?=$oConcepto->Nombre?></div></td>
	            <td width="100" height="25" valign="middle">
                	<div align="center">
                    <?php if (Session::CheckPerm(PERM_RUBR_UPDATE)){ ?>
                    	<a href="conceptos_mod.php<?=$strParams?>&IdConcepto=<?=$oConcepto->IdConcepto?>">
                        	<img src="images/iconos/mod.gif" alt="Modificar" title="Modificar" border="0" /></a> - 
                    <?php } ?>
                    <?php if (Session::CheckPerm(PERM_RUBR_DELETE)){ ?>
			            <a href="conceptos_del.php<?=$strParams?>&IdConcepto=<?=$oConcepto->IdConcepto?>">
