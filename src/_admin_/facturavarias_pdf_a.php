...
foreach ($arrData as $oFacturaVariaDetalle) 
{
	...
	$oPdf->Text(13.8 + 2, $y, number_format($Importe, 2));
...
/* importes */
$oPdf->Text(1.2 + 2, 19 - 1 + 7.5, number_format($oFacturaVaria->Subtotal, 2));
$oPdf->Text(9.1 + 2, 19 - 1 + 7.5, number_format($oFacturaVaria->Iva10 + $oFacturaVaria->Iva21, 2));
$oPdf->Text(13. + 28, 19 - 1 + 7.5, number_format($oFacturaVaria->Total, 2));
