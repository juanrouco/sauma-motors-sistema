...
if (!Session::CheckPerm(PERM_LOCA_UPDATE))
	Session::NoPerm();
...
if ($Submit)
{
	...
	if ($Nombre == '')
		$err |= 1;
	if (($Nombre != $oLocalidad->Nombre) && ($oLocalidades->GetByNombre($Nombre)))
		$err |= 2;
	if ($IdPais == '')
		$err |= 4;
	if ($IdProvincia == '')
	...
	if ($err == 0)
	{
		...
		$oLocalidad = $oLocalidades->Update($oLocalidad);
...
else
{
	...
	$Jurisdiccion 	= $oLocalidad->Jurisdiccion;
}
    	...
    	<td>
			<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
      			<tr>
        			...
        			<td height="40"><span class="tituloPagina">Administraci&oacute;n de Localidades - Modificar</span></td>
      			</tr>
    		</table>
		</td>
  	</tr>
