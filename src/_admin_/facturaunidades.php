...
$Paginado	= Pageable::PrintPaginator($oPage, $oFacturaUnidades->GetCountRows($filter), true);
$arrData 	= $oFacturaUnidades->GetAll($filter, $oPage);
...
{	
	window.location.href = 'facturaunidades.php?MainAction=<?=$MainAction?>';
}								
            ...
            <td>
                <table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
                    <tr>
                        ...
                        <td height="40"><span class="tituloPagina">Administraci&oacute;n de Facturas de Venta de Unidades</span></td>
                    </tr>
                </table>		
            </td>
        </tr>
                    ...
                    <tr>
                        <td width="8%" height="40">
                            <table border="0" align="left" cellpadding="0" cellspacing="0">
                                <?php if (Session::CheckPerm(PERM_FACU_CREATE)){ ?>
                                <tr>
                                    <!-- <td width="30"><div align="center"><img src="images/iconos/add.gif" alt="Agregar" border="0"></div></td>
                                    <td><a href="facturaunidades_add.php<?=$strParams?>">Agregar Factura de Talonario</a></td>
									 <td width="30"><div align="center">&nbsp;</div></td>-->
                                    <td width="30"><div align="center"><img src="images/iconos/add.gif" alt="Agregar" border="0"></div></td>
                                    <td><a href="facturaunidades_facturaelectronica_add.php<?=$strParams?>">Agregar Factura Elect&oacute;nica</a></td>
                                    <td width="30"><div align="center">&nbsp;</div></td>									                                     
                                </tr>
                                <?php } ?>
                            </table>
                        ...
                        <td width="12%" height="40">
                            <table border="0" align="right" cellpadding="0" cellspacing="0">
                                <tr>
                                    ...
                                    <td><a href="facturaunidades_exportar.php<?=$strParams?>">Exportar Reporte</a></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
    ...
    <?php if ($arrData != NULL) { ?>
        ...
        <tr>
            <td>
                ...
                <?php 
					foreach ($arrData as $oFacturaUnidad) 
					{ 
				...
				?>
                    ...
                    <tr onMouseOver="bgColor='#f3f3f3'" onMouseOut="bgColor=''">
                        ...
                        <td width="84" height="25"><div id="margen" align="center"><?=$oFacturaUnidad->NumeroComprobante?></div></td>
                        <td width="84" height="25"><div id="margen" align="center"><?=$oMinuta->IdUnidad?></div></td>
                        <td width="178" height="25"><div id="margen"><?=$cliente?></div></td>
                        <td width="178" height="25"><div id="margen"><?=$oUsuario->Nombre?> <?=$oUsuario->Apellido?></div></td>
                        <td width="110" height="25"><div id="margen"><?=CambiarFecha($oComprobante->Fecha)?></div></td>
                        <td width="123" height="25"><div id="margen" align="center">$ <?=number_format($oComprobante->Importe, 2)?></div></td>
                        ...
                        <td width="91" height="25" valign="middle">
                            <div align="center">
						<?php if ($Action == 'Select') { ?>
                                <a href="#" onClick="javascript: Select('<?=$oFacturaUnidad->IdFactura?>');">
                                    <img src="images/iconos/preview.png" alt="Seleccionar" border="0" /></a>
						<?php } else { ?>
							<?php if ($oComprobante->IdEstado != ComprobanteEstados::Anulado){ ?>
                                <?php if (!$oComprobante->Numero || $oComprobante->Numero == '00000000'){ ?>
                                <form action="facturaunidades_afip.php" style="display: inline">
									<input type="hidden" name="IdFactura" id="IdFactura" value="<?= $oFacturaUnidad->IdFactura ?>" />
								...
								{
								?>
                                <a href="facturaunidades_pdf.php<?=$strParams?>&IdFactura=<?=$oFacturaUnidad->IdFactura?>">
								...
								{
							?>
                                <form action="facturaunidades_notascredito_afip.php" style="display: inline">
									<input type="hidden" name="IdFactura" id="IdFactura" value="<?= $oFacturaUnidad->IdFactura ?>" />
									<input type="image" src="images/iconos/refresh.gif" alt="Enviar AFIP" title="Enviar AFIP" border="0" />
								</form> - 
							<?php 
							...
							?>
								<a href="facturaunidades_notacredito_pdf.php<?=$strParams?>&IdFactura=<?=$oFacturaUnidad->IdFactura?>">
									 <img src="images/iconos/pdf.png" alt="Imprimir" border="0" /></a> - 
								<?php }} ?>
                                <a href="facturaunidades_details.php<?=$strParams?>&IdFactura=<?=$oFacturaUnidad->IdFactura?>">
							...
							if ($oComprobante->IdEstado != ComprobanteEstados::Anulado)
							{
								if (Session::CheckPerm(PERM_FACU_UPDATE))
								{
									if ($oComprobante->Numero && $oComprobante->Numero != '00000000')
									{
										...
										{
							?>
                                <a href="facturaunidades_anular.php<?=$strParams?>&IdFactura=<?=$oFacturaUnidad->IdFactura?>">
							...
							<?php
										...
										{
							?>
                                <a href="facturaunidades_facturaelectronica_anular.php<?=$strParams?>&IdFactura=<?=$oFacturaUnidad->IdFactura?>">
                                    <img src="images/iconos/permisos.gif" alt="Anular" border="0" /></a>
							<?php
										}
									}
									...
									{
							?>
                                <a href="facturaunidades_del.php<?=$strParams?>&IdFactura=<?=$oFacturaUnidad->IdFactura?>">
                                    <img src="images/iconos/del.gif" alt="Anular" border="0" /></a>
								<?php
								}/*
								?>
								<a href="facturaunidades_generararchivo.php?IdFactura=<?=$oFacturaUnidad->IdFactura?>">
									<img src="images/iconos/newsletter.png" alt="Factura Electronica" border="0" />
								</a>
								<?php*/ } ?>
                            <?php } ?>
						<?php } ?>
