...
{
	header('Location: ventasrepuestos_factura_details.php?IdFacturaPostVenta=' . $oFacturaPostVenta[0]->IdFacturaPostVenta);
	exit;
}
    	...
    	<td>
			<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
      			<tr>
        			...
        			<td height="40"><span class="tituloPagina">Administraci&oacute;n de Facturas de Ventas de Repuestos</span></td>
      			</tr>
    		</table>
		</td>
  	</tr>
                                    ...
                                    <tr>
                                        <td>
                                            <table width="100%" border="0" align="left" cellpadding="3" cellspacing="3">
                                                <tr>
                                                    <td width="10%"><div align="left">Tipo Venta:</div></td>
                                                    <td>
                                                        <div align="left">
												...
												?>
												<tr>
                                                    <td width="10%"><div align="left">Tipo Cargo:</div></td>
                                                    <td>
                                                        <div align="left">
												...
												<tr>
                                                    ...
                                                    <td>
                                                        <div align="left">
                                                        	<span><?=($oFactura->IdEstado !=  ComprobanteEstados::Anulado) ? 'Facturada' : 'Anulada'?></span>
                                                        </div>
                                                    </td>
                                                </tr>
												<tr>
                                                    <td><div align="left"><?=ComprobanteTipos::GetDescripcionById($oTipoIva->FacturaTipo)?>:</div></td>
                                                    <td>
                                                        <div align="left">
                                                ...
                                                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="bordeGris">
													...
													<tr>
														<td>
															...
															if ($oCompra->PercepcionIIBB)
															{
															?>
																<tr>
																	<td><div align="left">Perc. IIBB:</div></td>
																	<td width="10">&nbsp;</td>
																	<td>
																		<div align="left">
																			<span>$ <?=$oCompra->PercepcionIIBB?></span>
																		</div>
																	</td>
																	<td>&nbsp;</td>
																</tr>
					...
					<table width="90%"  border="0" align="center" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
						<tr>
							<td height="30">
								<div align="center">
									<?php
									if (!$oCompra->IdFactura && $oCompra->TipoOperacion == TipoVenta::Mostrador && false)
									{
									?>
									<input type="button" name="btnImprimirFactura" class="botonBasico" id="btnImprimirFactura" onclick="javascript: window.open('ventarepuestos_factura_pdf.php?IdCompra=<?= $oCompra->IdCompra ?>')" value="Imprimir Factura" />
									<?php
									}
									?>
									<input type="button" name="btnCancelar" class="botonBasico" id="btnCancelar" onclick="javascript: window.location.href = 'ventarepuestos.php<?=$strParams?>';" value="Volver" />
								</div>
							</td>
						</tr>
					</table>
