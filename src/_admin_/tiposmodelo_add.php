...
if (!Session::CheckPerm(PERM_TIPM_CREATE))
	Session::NoPerm();
...
if ($Submit)
{
	...
	if ($Nombre == '')
		$err |= 2;
	elseif ($oTiposModelo->GetByNombre($Nombre))
		$err |= 4;
	...
	if ($err == 0)
	{
		...
		$oTipoModelo = $oTiposModelo->Create($oTipoModelo);
    	...
    	<td>
			<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
      			<tr>
        			...
        			<td height="40"><span class="tituloPagina">Administraci&oacute;n de Tipos de Modelos - Agregar</span></td>
      			</tr>
    		</table>
		</td>
  	</tr>
