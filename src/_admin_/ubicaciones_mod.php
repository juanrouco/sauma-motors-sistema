...
if (!Session::CheckPerm(PERM_UBIC_UPDATE))
	Session::NoPerm();
...
if (!$oUbicacion = $oUbicaciones->GetById($IdUbicacion))
{	
	header("Location: ubicaciones.php" . $strParams);
	exit();
}
...
if ($Submit)
{
	...
	if ($Nombre == '')
		$err |= 2;
	elseif (($oUbicacion->Nombre != $Nombre) && ($oUbicaciones->GetByNombreExacto($Nombre)))
		$err |= 4;
	...
	if ($err == 0)
	{
		...
		$oUbicacion = $oUbicaciones->Update($oUbicacion);
...
{
	$Codigo = $oUbicacion->Codigo;
	$Nombre = $oUbicacion->Nombre;
}
    	...
    	<td>
			<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
      			<tr>
        			...
        			<td height="40"><span class="tituloPagina">Administraci&oacute;n de Ubicaciones - Modificar</span></td>
      			</tr>
    		</table>
		</td>
  	</tr>
					...
					<tr>
						<td class="bordeGris">
							<table  border="0" align="center" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
									<td height="20">&nbsp;</td>
									<td height="20" align="left"><?php if ($err & 2) { ?><li style="color:#FF0000;">Ingrese el nombre de la ubicaci&oacute;n</li><?php } ?><?php if ($err & 4) { ?><li class="error">Ya existe registrado el nombre de la ubicaci&oacute;n</li><?php } ?></td>
                                </tr>
							</table>						
						</td>
					</tr>
					...
					<tr>
						<td height="30">
							<div align="center">
								...
								<input type="button" name="btnCancelar" class="botonBasico" id="btnCancelar" onclick="javascript: window.location.href = 'ubicaciones.php<?=$strParams?>';" value="Cancelar" />
							</div>
						</td>
					</tr>
				</table>
