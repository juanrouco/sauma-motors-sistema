...
class GeneradorNoFiscal extends GeneradorDocumentos
{
	protected function AbrirRecibo($oCliente, $Factura)
	{
		...
		$comando = "@OpenNonFiscalReceipt" . $this->Separador;
	...
	protected function ImprimirItem($Comentario, $Cantidad)
	{
		...
		$comando .= $Cantidad . $this->Separador;
	...
	{
		$comando = "@CloseNonFiscalReceipt" . $this->Separador;
