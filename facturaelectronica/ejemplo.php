...
# WSFEv1 2.5 (factura electr—nica mercado interno sin detalle -rŽgimen general-)
...
try {
	...
	$Certificado = "tolosa.crt"; // certificado de prueba
	$ClavePrivada = "tolosa.key"; // clave privada de prueba
	...
	$nro_doc = "30662071680";       # 0 para Consumidor Final (<$1000)
	$cbt_desde = $ult + 1; 
	$cbt_hasta = $ult + 1;
    ...
    # Agrego los comprobantes asociados (solo para notas de crŽdito y dŽbito):
    if (false) {
        $tipo = 19;
        $pto_vta = 2;
        $nro = 1234;
