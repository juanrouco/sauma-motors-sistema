...
if (!Session::CheckPerm(PERM_GESCUE_CREATE))
	Session::NoPerm();
...
if ($Submit)
{
	...
	switch ($Action)
	{
		case 'Select':
			...
			foreach ($arrIdMinuta as $IdMinuta)
			{
				...
				if ($err == 0)
				{
					...
					$oCuentaGestoria->PatentamientoCalculado = 0;
					$oCuentaGestoria->PrendaCalculado		 = 0;
					$oCuentaGestoria->AltaCalculado			 = 0;
					$oCuentaGestoria->SelladoCalculado		 = 0;
					$oCuentaGestoria->TotalCalculado		 = 0;
		...
		case 'Next':
			...
			$arrData = $oCuentasGestoria->GetAllByFecha(date('d-m-Y'));
            ...
            <td>
                <table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
                    <tr>
                        ...
                        <td height="40"><span class="tituloPagina">Administraci&oacute;n de Cuentas Corriente de Gestor&iacute;a de Usados - Agregar</span></td>
                    </tr>
                </table>
            </td>
        </tr>
