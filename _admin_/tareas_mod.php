...
else
{
	...
	$IdUsuarioFrom	= $oTarea->IdUsuarioFrom;
	$IdUsuarioTo	= $oTarea->IdUsuarioTo;
	
	$IdEstado		= $oTarea->IdEstado;
	$IdTipo			= $oTarea->IdTipo;
	$IdCliente		= $oTarea->IdCliente;
	if ($IdCliente)
	{
	...
	$FechaInicio 	= CambiarFecha($oTarea->FechaInicio);
	$FechaFin	 	= CambiarFecha($oTarea->FechaFin);
	$Descripcion	= $oTarea->Descripcion;
	$arrHora		= explode(':', $oTarea->Hora);
	$HoraInicio		= $arrHora[0];
	$MinutoInicio	= $arrHora[1];
}
?>
