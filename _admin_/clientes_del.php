...
if (!Session::CheckPerm(PERM_CLIE_DELETE))
	Session::NoPerm();*/
...
if ($Submit)
{
	$oCliente = $oClientes->Delete($oCliente->IdCliente);
		...
		<td>
			<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
				<tr>
					...
					<td height="40"><span class="tituloPagina">Administraci&oacute;n de Clientes - Eliminar</span></td>
				</tr>
			</table>
		</td>
	</tr>
						...
						<tr>
						  	<td height="30">
								<div align="center">
									...
									<input type="button" name="btnCancelar" class="botonBasico" id="btnCancelar" value="Cancelar" onClick="javascript: window.location.href = 'clientes.php<?=$strParams?>';">
								</div>
							</td>
						</tr>
					</form>
				...
				<table width="60%"  border="0" align="center" cellpadding="0" cellspacing="0">
  				...
  				<table width="60%"  border="0" align="center" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
                    <tr>
                        <td height="30">
                            <div align="center">
                              <input type="button" class="botonBasico" value="Volver" onclick="javascript: window.location.href = 'clientes.php<?=$strParams?>'" />
                            </div>
                        </td>
                    </tr>
				</table>
