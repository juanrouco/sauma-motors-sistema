...
$oPedidoMayorista = $oPedidosMayorista->GetById($IdPedidoMayorista);
$filter['IdCliente'] = $oPedidoMayorista->IdCliente;
...
<body>
            ...
            <td>
                <table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
                    <tr>
                        ...
                        <td height="40"><span class="tituloPagina">Administraci&oacute;n de Pedidos Mayoristas - Selecci&oacute;n de Minutas</span></td>
                    </tr>
                </table>		
            </td>
        </tr>
    ...
    <?php if ($arrData != NULL) { ?>
        ...
        <tr>
            <td>
				<form name="frmData1" id="frmData1" method="post" action="pedidosmayorista_mod_paso2.php">
                ...
                <?php 
					...
					{ 
						...
						$checked = '';
						if ($oPedidoMayoristaDetalle = $oPedidosMayoristaDetalles->GetById($IdPedidoMayorista, $oMinuta->IdMinuta))
							$checked = 'checked="checked"';
				?>
          
                    <tr onMouseOver="bgColor='#f3f3f3'" onMouseOut="bgColor=''">
                        <td width="75" height="25"><div id="margen" align="center"><?=$oMinuta->IdMinuta?></div></td>
                        <td width="80" height="25"><div id="margen" align="center"><?=CambiarFecha($oFacturaUnidad->Fecha)?></div></td>
                        ...
                        <td width="84" height="25" valign="middle">
                            <div align="center">
								<input class="check-change" type="checkbox" id="IdMinuta[]" name="IdMinuta[]" <?= $checked ?> value="<?= $oMinuta->IdMinuta ?>" />
                            </div>
                        </td>
                    </tr>
                    <tr>
