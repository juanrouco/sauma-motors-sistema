...
<form name="frmData" id="frmData" method="post" action="usados_exportar_historico_pdf.php">
            ...
            <td>
                <table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
                    <tr>
                        ...
                        <td height="40"><span class="tituloPagina">Exportar Hist&oacute;rico de Usados</span></td>
                    </tr>
                </table>		
            </td>
        </tr>
