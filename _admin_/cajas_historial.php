...
$Paginado	= Pageable::PrintPaginator($oPage, $oCajasAperturas->GetCountRows($filter), true);
$arrData 	= $oCajasAperturas->GetAll($filter, $oPage);
...
{
	window.location.href = 'cajas_historial.php';
}								
            ...
            <td>
                <table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
                    <tr>
                        ...
                        <td height="40"><span class="tituloPagina">Historial de Aperturas y Cierres de caja</span></td>
                    </tr>
                </table>
            </td>
        </tr>
            ...
            <td>
                ...
                <table width="100%" align="center" cellpadding="0" cellspacing="0" class="bordeGris">
                    <tr class="bordeGrisFondo">
                        <td width="20%" height="25" class="bordeGrisTitulo"><div id="margen"><strong>Fecha</strong></div></td>
                        <td width="20%" height="25" class="bordeGrisTitulo"><div id="margen"><strong>Tipo Movimiento</strong></div></td>
                        <td width="20%" height="25" class="bordeGrisTitulo"><div id="margen"><strong>Usuario</strong></div></td>
                        <td width="20%" height="25" class="bordeGrisTitulo"><div id="margen" align="center"><strong>Total a Rendir</strong></div></td>
                        <td width="20%" height="25" class="bordeGrisTitulo"><div id="margen" align="center"><strong>Total Ingresado</strong></div></td>
                        <td width="20%" height="25" class="bordeGrisTitulo"><div id="margen" align="center"><strong>Diferencia</strong></div></td>
                    </tr>
          
                <?php 
				foreach ($arrData as $oCajaApertura)
				{
					$Turno = $oCajaApertura->IdTurno == 1 ? 'MA&Ntilde;ANA' : 'TARDE';
					$Movimiento = $oCajaApertura->IdTipoApertura == 1 ? 'APERTURA' : 'CIERRE';
					$oUsuario = $oUsuarios->GetById($oCajaApertura->IdUsuario);
				?> 
                
                    <tr onMouseOver="bgColor='#f3f3f3'" onMouseOut="bgColor=''">
                        <td height="25"><div id="margen"><?=CambiarFechaHora($oCajaApertura->Fecha)?></div></td>
                        <td height="25"><div id="margen"><?= $Movimiento ?></div></td>
                        <td height="25"><div id="margen"><?= $oUsuario->Nombre . ' ' . $oUsuario->Apellido ?></div></td>
                        <td height="25"><div id="margen" align="center">$ <?=$oCajaApertura->TotalRendir?></div></td>
                        <td height="25"><div id="margen" align="center">$ <?=$oCajaApertura->TotalReal?></div></td>
                        <td height="25"><div id="margen" align="center">$ <?=$oCajaApertura->Diferencia?></div></td>
                    </tr>
                    <tr>
                        <td colspan="7">
                        	<div align="center">
