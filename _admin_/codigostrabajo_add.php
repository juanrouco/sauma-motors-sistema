...
if (!Session::CheckPerm(PERM_CODTRA_CREATE))
	Session::NoPerm();
...
if ($Submit)
{
	...
	if ($err == 0)
	{
		...
		$oCodigoTrabajo = $oCodigosTrabajo->Create($oCodigoTrabajo);
    	...
    	<td>
			<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
      			<tr>
        			...
        			<td height="40"><span class="tituloPagina">Administraci&oacute;n de C&oacute;digos de Trabajo - Agregar</span></td>
      			</tr>
    		</table>
		</td>
  	</tr>
