...
if (!Session::CheckPerm(PERM_UNID_STOCK))
	Session::NoPerm();
...
$j(document).ready(function() {
	...
	$j(".numerico").on('input',function() {
		...
		var Galpon = ((Neto + Flete) * 1.275 + ImpuestoInterno);
            ...
            <td>
                <table width="100%" align="center" cellpadding="0" cellspacing="0" class="bordeGris">
                    <tr class="bordeGrisFondo">
                        ...
                        <td width="84" height="25"  class="bordeGrisTitulo"><div id="margen" align="center"><strong>Facturar</strong></div></td>
                        <td width="84" height="25"  class="bordeGrisTitulo"><div id="margen" align="center"><strong>Contado</strong></div></td>
                        <td width="84" height="25"  class="bordeGrisTitulo"><div id="margen" align="center"><strong>Cr&eacute;dito</strong></div></td>
                        <td width="84" height="25"  class="bordeGrisTitulo"><div id="margen" align="center"><strong>Flete y Form.</strong></div></td>
                        <td width="84" height="25"  class="bordeGrisTitulo"><div id="margen" align="center"><strong>Arancel</strong></div></td>
                ...
                <?php foreach ($arrData as $oModelo) { ?>
                    ...
                    <tr onMouseOver="bgColor='#f3f3f3'" onMouseOut="bgColor=''">
                        ...
                        <td width="100" height="25"><div id="margen"><?=$oTipoModelo->Nombre?></div></td>
						<td width="80" height="25">
							<div id="margen" align="center">
							$<?= $oModelo->ReventaPrecio ?>
							</div>
						</td>
						<td width="80" height="25">
							<div id="margen" align="center">
						...
						<td width="80" height="25">
							<div id="margen" align="center">
							$<?= $oModelo->FleteFormularios ?>
							</div>
						</td>
						<td width="80" height="25">
							<div id="margen" align="center">
							$<?= $oModelo->Patentamiento ?>
							</div>
						</td>
						<td width="80" height="25">
							<div id="margen" align="center">
							$<?= $oModelo->IdTipoModelo == 39 || $oModelo->IdTipoModelo == 40 ? 0 : Config::GestoriaLibertador ?>
							</div>
						</td>
						<td width="80" height="25">
							<div id="margen" align="center">
							$<?= $oModelo->IdTipoModelo == 39 || $oModelo->IdTipoModelo == 40 ? 0 : Config::GestoriaOtro ?>
							</div>
						</td>
                    </tr>
                    <tr>
