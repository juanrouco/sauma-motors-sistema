...
if ($Submit)
{
	...
	if ($Nombre == '')
		$err |= 2;
	elseif (($oTipoCarroceria->Nombre != $Nombre) && ($oTiposCarroceria->GetByNombre($Nombre)))
		$err |= 4;
			
	/* si no hay ningun error... */	
	if ($err == 0)
	{
		$oTipoCarroceria->Codigo = $Codigo;
		$oTipoCarroceria->Nombre = $Nombre;
		
		$oTipoCarroceria = $oTiposCarroceria->Update($oTipoCarroceria);
...
{
	$Codigo = $oTipoCarroceria->Codigo;
	$Nombre = $oTipoCarroceria->Nombre;
}
    	...
    	<td>
			<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
      			<tr>
        			...
        			<td height="40"><span class="tituloPagina">Administraci&oacute;n de Tipos de Carroceria - Modificar</span></td>
      			</tr>
    		</table>
		</td>
  	</tr>
					...
					<tr>
						<td height="30">
							<div align="center">
								...
								<input type="button" name="btnCancelar" class="botonBasico" id="btnCancelar" onclick="javascript: window.location.href = 'tiposcarroceria.php<?=$strParams?>';" value="Cancelar" />
							</div>
						</td>
					</tr>
				</table>
