...
$filter['RepuestosAsignados'] = true;
...
{	
	window.location.href = 'ventarepuestos_ot.php?MainAction=<?=$Action?>';
}								
            ...
            <td>
                <table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
                    <tr>
                        ...
                        <td height="40"><span class="tituloPagina">Administraci&oacute;n de Repuestos asignados a OT</span></td>
                    </tr>
                </table>		
            </td>
        </tr>       
                        ...
                        <td width="20%" height="40">
                            <table border="0" align="left" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    ...
                                    <td><a href="ventarepuestos_ot_add.php<?=$strParams?>">Agregar</a></td>
									<td width="10" height="30" >&nbsp;</td>
									<td width="30"><div align="center"><img src="images/iconos/pdf.png" alt="Agregar" border="0"></div></td>
                                    <td><a href="vales_garantia_exportar.php<?=$strParams?>">Vales Garantia</a></td>
									<td width="10" height="30" >&nbsp;</td>
								</tr>
                                <?php } ?>
                            </table>
            ...
            <td>
                <table width="100%" align="center" cellpadding="0" cellspacing="0" class="bordeGris">
                    <tr class="bordeGrisFondo">
						...
						<?php /*<td height="25" class="bordeGrisTitulo"><div id="margen"><strong>Asignado</strong></div></td>*/ ?>
                        ...
                        <td width="50" height="25"  class="bordeGrisTitulo"><div id="margen" ><strong>Acciones</strong></div></td>
                    </tr>
				...
				?>          
                    <tr onMouseOver="bgColor='#f3f3f3'" onMouseOut="bgColor=''">
						...
						<td width="75" height="25"><div id="margen"><?=$oEstadoOrden->Nombre?></div></td>
						...
						<td width="50" height="25" valign="middle">
                            <div align="center">
								<a href="ventarepuestos_ot_detail.php<?=$strParams?>&IdOrdenTrabajo=<?=$oOrdenTrabajo->IdOrdenTrabajo?>" title="Detalle">
