...
if ((!isset($filter)) || (IsEmptyArray($filter)) || ($Submit))
{
	...
	$filter['Lavado'] 		= trim($_REQUEST['FilterLavado']);
	$filter['FechaRetiroDesde']	= strval($_REQUEST['FilterFechaRetiroDesde']);
	$filter['FechaRetiroHasta']	= strval($_REQUEST['FilterFechaRetiroHasta']);
}
...
{	
	window.location.href = 'planillaslavado.php';
}								
            ...
            <td>
                <table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
                    <tr>
                        ...
                        <td height="40"><span class="tituloPagina">Administraci&oacute;n de Planillas de Lavado</span></td>
                    </tr>
                </table>
            </td>
        </tr>
                        ...
                        <td width="80%" height="40">
                            <table border="0" align="right" cellpadding="0" cellspacing="0">
                                <tr>
                                    ...
                                    <td><a href="planillaslavado_pdf.php<?=$strParams?>">Generar PDF</a></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                        ...
                        <tr>
                            <td class="tituloMenu">
                                <table border="0" cellspacing="0" cellpadding="0">
									<tr>
										<td class="tituloMenu"><div align="right">Fecha de Retiro Desde:</div></td>
										<td>
											<input type="text" name="FilterFechaRetiroDesde" id="FilterFechaRetiroDesde" readonly="yes" value="<?= $filter['FechaRetiroDesde'] ?>" />
											<script language="javascript">
											new tcal({'formname': 'frmData', 'controlname': 'FilterFechaRetiroDesde'});
											</script>
										</td>
										<td>&nbsp;</td>
										<td class="tituloMenu"><div align="right">Fecha de Retiro Hasta:</div></td>
										<td>
											<input type="text" name="FilterFechaRetiroHasta" id="FilterFechaRetiroHasta" readonly="yes" value="<?= $filter['FechaRetiroHasta'] ?>" />
											<script language="javascript">
											new tcal({'formname': 'frmData', 'controlname': 'FilterFechaRetiroHasta'});
											</script>
										</td>
										<td>&nbsp;</td>
										<td>&nbsp;</td>
                                    ...
                                    <tr>                              
                                        ...
                                        <td>&nbsp;</td>
                                        <td class="tituloMenu"><div align="right">Lavado:</div></td>
                                        <td>
                                        	<select name="FilterLavado" id="FilterLavado" class="camporFormularioMediano">
                                            	<option value="" <?=($filter['Lavado'] == '') ? 'selected="selected"' : ''?>>[INDITINTO]</option>
                                                <option value="0" <?=($filter['Lavado'] == '0') ? 'selected="selected"' : ''?> >NO</option>
                                                <option value="1" <?=($filter['Lavado'] == '1') ? 'selected="selected"' : ''?>>SI</option>
                                            </select>
                                      	</td>
                                        <td>&nbsp;</td>
            ...
            <td>
                <table width="100%" align="center" cellpadding="0" cellspacing="0" class="bordeGris">
                    <tr class="bordeGrisFondo">
                        <td width="89" height="25" class="bordeGrisTitulo"><div id="margen" align="center"><strong>Nro. Interno</strong></div></td>
                        ...
                        <td height="25" class="bordeGrisTitulo"><div id="margen" align="center"><strong>Lavado</strong></div></td>
				...
				?>          
                    <tr onMouseOver="bgColor='#f3f3f3'" onMouseOut="bgColor=''">
                        <td width="89" height="25"><div id="margen" align="center"><?=$oUnidad->IdUnidad?></div></td>
                        <td width="166" height="25"><div id="margen"><?=$oModelo->DenominacionComercial?></div></td>
                        <td width="124" height="25"><div id="margen"><?=$oColor->Nombre?></div></td>
                        <td width="75" height="25"><div id="margen"><?=$CodigoLlaves?></div></td>
                        <td width="89" height="25"><div id="margen"><?=$oUnidad->NumeroVin?></div></td>
                        <td width="167" height="25"><div id="margen"><?=$oCliente->RazonSocial?></div></td>
                        <td width="65" height="25">
							<div id="margen" align="center">
								<input type="checkbox" name="Lavado_<?=$oUnidad->IdUnidad?>" id="Lavado_<?=$oUnidad->IdUnidad?>" onclick="javascript: UpdateUnidad('<?=$oUnidad->IdUnidad?>');" <?=($oUnidad->Lavado) ? 'checked="checked"' : ''?>  />
							</div>
						</td>
