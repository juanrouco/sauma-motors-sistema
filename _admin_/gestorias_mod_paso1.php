...
else
{
	...
	if (!GestoriaCreate::Load($IdGestoria))
	{
		header("Location: gestorias.php" . $strParams);
		exit();
	}
    	...
    	<td>
			<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
      			<tr>
        			...
        			<td height="40"><span class="tituloPagina">Administraci&oacute;n de Gestor&iacute;as - Modificar - Paso 1</span></td>
      			</tr>
    		</table>
		</td>
  	</tr>
                                        ...
                                        <td>
                                            <table border="0" align="center" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div align="left">
                                                            <input type="text" name="IdMinuta" id="IdMinuta" class="camporFormularioChico" maxlength="10" onblur="javascript: SetMinuta(this.value);" onKeyPress="javascript: if (event.keyCode &lt; 45 || event.keyCode &gt; 57) event.returnValue = false;" value="<?=GestoriaCreate::$IdMinuta?>" disabled="disabled" />
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                	<td>&nbsp;</td>
                                                	<td colspan="2"><?php if ($err & 1) { ?><li style="color:#FF0000;">Ingrese la fecha</li><?php } ?></td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
