...
$oMinuta = $oMinutas->GetById($oOrdenSalida->IdUsado);
...
if (!$oUsado = $oUsados->GetById($oOrdenSalida->IdUsado))
{	
	header("Location: ordenessalidausados.php" . $strParams);
	exit();
}
    	...
    	<td>
			<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
      			<tr>
        			...
        			<td height="40"><span class="tituloPagina">Administraci&oacute;n de Ordenes de Salida de Usados - Detalle</span></td>
      			</tr>
    		</table>
		</td>
  	</tr>
				...
				<form name="frmData" id="frmData" method="post" action="<?=$strParams?>">
                                                    	...
                                                    	<td valign="top">
                                                            <table width="100%" border="0" align="left" cellpadding="3" cellspacing="3">
                                                                <tr>
                                                                    ...
                                                                    <td width="80%">
                                                                        <div align="left">
                                                                        	<label id="NumeroOperacion"><?=$oUsado->IdUsado?></label>
                                                                        </div>
                                                                    </td>
                                                                </tr>
																<?php
													...
													<tr>
														<td>
															<ul>
																...
																{
																?>
																<li>Tarjeta Code entregada</li>
																<?php 
																}
																?>
																<?php 
																if ($oOrdenSalida->EntregaDocumentacion)
																{
																?>
																<li>Documentaci&oacute;n entregada</li>
																<?php 
																}
																?>
															</ul>
					...
					<table width="90%"  border="0" align="center" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
						<tr>
							<td height="30">
								<div align="center">
									<input type="button" name="btnCancelar" class="botonBasico" id="btnCancelar" onclick="javascript: window.location.href = 'ordenessalidausados.php<?=$strParams?>';" value="Volver" />
								</div>
							</td>
						</tr>
					</table>
