...
if ($Submit)
{
	...
	if ($err == 0)
	{
		...
		if ($oUpload->UploadFile())
		{
			...
			$Mensaje = $oArticulos->Ajustar($oUpload->GetNombre());
            ...
            <td>
                <table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
                    <tr>
                        ...
                        <td height="40"><span class="tituloPagina">Administraci&oacute;n de Art&iacute;culos - Ajustar</span></td>
                  	</tr>
                </table>
            </td>
        </tr>
                        ...
                        <tr>
                            <td class="bordeGris">
                                <table  border="0" align="center" cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        <td><div align="right">Archivo CSV:</div></td>
                                        <td>
                    ...
                    <table width="60%"  border="0" align="center" cellpadding="0" cellspacing="0">
      				...
      				<table width="60%"  border="0" align="center" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
      					<tr>
                            <td height="30">
                                <div align="center">
                        	        <input type="button" name="btnAceptar" class="botonBasico" id="btnAceptar" onclick="javascript: window.location.href = 'unidades.php';" value="Aceptar" />                			
                                </div>
                            </td>
                        </tr>
                    </table>
