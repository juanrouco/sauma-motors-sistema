            ...
            <td>
                <table width="90%" align="center" cellpadding="0" cellspacing="0" class="bordeGris">
                    <tr class="bordeGrisFondo">
                        ...
                        <td height="25" class="bordeGrisTitulo"><div id="margen"><strong>Bruto</strong></div></td>
        	...
        	<td>
                <table width="90%"  border="0" align="center" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
                    <tr>
                        <td height="30">
                            <div align="center">
                            	<input type="button" onclick="window.location.href = 'minutaspago_add_paso2.php?IdMinutaPago=<?= $IdMinutaPago ?>';" name="btnModificar" class="botonBasico" id="btnModificar" value="Modificar" />
                            </div>
                        </td>
						<td height="30">
                            <div align="center">
