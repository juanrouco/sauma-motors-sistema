...
if ($Submit)
{
	...
	if ($Nombre == '')
		$err |= 2;
	elseif ($oTiposModelo->GetByNombre($Nombre)->Nombre == $Nombre)
		$err |= 4;
    	...
    	<td>
			<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
      			<tr>
        			...
        			<td height="40"><span class="tituloPagina">Adminsitraci&oacute;n de Tipos de Modelos - Agregar</span></td>
      			</tr>
    		</table>
		</td>
  	</tr>
...
window.opener.FilterTipoModelo('<?=$oTipoModelo->IdTipoModelo?>', '');
window.close();
</script>
<?php } ?>
