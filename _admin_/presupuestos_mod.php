...
if ($Submit)
{
	...
	if ($err == 0)
	{
		...
		{
			$oPresupuesto->EntregaUsado			= $EntregaUsado;
			$oPresupuesto->UsadoIdMarca			= '';
			$oPresupuesto->UsadoModelo			= '';
			$oPresupuesto->UsadoAnio			= '';
			$oPresupuesto->UsadoKm				= '';
			$oPresupuesto->UsadoPrecioTomado	= '';
		}
		...
		{
			$oPresupuesto->Financia					= $Financia;
			$oPresupuesto->FinanciacionCapital		= '';
			$oPresupuesto->FinanciacionCuotas		= '';
			$oPresupuesto->FinanciacionAcreedor		= '';
			$oPresupuesto->FinanciacionValorCuota	= '';
		}
...
else
{
	...
	$ClienteTelefono		= $oCliente->Telefono;
	$ClienteEmail			= $oCliente->Email;
	...
	$GastosOtorgamiento		= $oPresupuesto->GastosOtorgamiento;
	...
	$IdOrigenCliente		= $oPresupuesto->IdOrigenCliente;
}
    	...
    	<td>
			<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
      			<tr>
        			...
        			<td height="40"><span class="tituloPagina">Administraci&oacute;n de Facturas Proforma - Modificar</span></td>
      			</tr>
    		</table>
		</td>
  	</tr>
