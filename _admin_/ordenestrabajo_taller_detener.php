		...
		<td>
			<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
				<tr>
					...
					<td height="40"><span class="tituloPagina">Administraci&oacute;n de Ordenes de Trabajo - Pausar</span></td>
				</tr>
			</table>
		</td>
	</tr>
					...
					<tr>
						<td class="bordeGris">
							<table  border="0" align="center" cellpadding="0" cellspacing="0">
								...
								<tr>
									<td><div align="center"><strong>&iquest;Esta seguro que desea pausar la orden de trabajo n&deg; <?= $oOrdenTrabajo->IdOrdenTrabajo ?> ?</strong></div></td>
								</tr>
								<tr>
									<td>&nbsp;</td>
								</tr>
