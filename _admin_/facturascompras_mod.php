...
if ($Submit)
{
	...
	{
		if ($oFacturaCompraRepetida->IdFacturaCompra != $oFacturaCompra->IdFacturaCompra)
			$err |= 64;
	}
	...
	if ($err == 0)
	{
		if (!$oFacturaCompra->IdPeriodo || $Fecha != $oFacturaCompra->Fecha)
		{
...
else
{
	...
	$IdConcepto				= $oFacturaCompra->IdConcepto;
...
function FilterConcepto(IdConcepto, Nombre)
{
	if ((IdConcepto == '') && (Nombre == ''))
	{		
		Get('Concepto').value 			= '';
		Get('IdConcepto').value 		= '';
	}

	var oConcepto = GetConcepto(IdConcepto);
	if (!(oConcepto))
		return;
	
	Get('Concepto').value 			= oConcepto.Nombre;
	Get('IdConcepto').value 		= oConcepto.IdConcepto;
}
    	...
    	<td>
			<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
      			<tr>
        			...
        			<td height="40"><span class="tituloPagina">Administraci&oacute;n de Facturas de Compra - Modificar</span></td>
      			</tr>
    		</table>
		</td>
  	</tr>
                                    ...
                                    <tr>
                                        <td>
                                            <table border="0" align="center" cellpadding="0" cellspacing="0">
												...
												<tr>
													<td colspan="2"><div id="margen" align="left">Concepto:</div></td>
												</tr>
												<tr>
													<td>
														<div align="left">
															<input type="text" name="Concepto" id="Concepto" onkeyup="javascript: StrToUpper(this.id);" class="camporFormularioSuggest" maxlength="128" value="<?=$Concepto?>" autocomplete="off">
															<span style="color:#FF0000;">&nbsp;(*)</span>
															<script language="">												
																SUGGESTRequest('Conceptos', 'GetAll', 'Concepto', 'FilterConcepto', 'IdConcepto', 'Nombre', 'Filter_Concepto', null);
															</script>
														</div>
													</td>
													<td><span style="color:#FF0000;">&nbsp;</span></td>
												...
												<tr>
													<td colspan="2" height="20">
													<?php if ($err & 32) { ?><li style="color:#FF0000;">Debe ingresar el total.</li><?php } ?>
