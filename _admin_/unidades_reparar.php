...
$Reparacion					= intval($_REQUEST['Reparacion']);
...
if ($Submit)
{
	...
	if ($err == 0)
	{
		...
		$oUnidad->Reparacion			= $Reparacion;
		$oUnidad->Comentarios		= $Comentarios;
...
else
{
	...
	$Reparacion		= $oUnidad->Reparacion;
	$Comentarios	= $oUnidad->Comentarios;
}
    	...
    	<td>
			<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
      			<tr>
        			...
        			<td height="40"><span class="tituloPagina">Administraci&oacute;n de Unidades - Reparar Unidad</span></td>
      			</tr>
    		</table>
		</td>
  	</tr>
                    ...
                    <tr>
                        <td class="bordeGris">
                            <table width="80%" border="0" align="center" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
									<td>Reparar Unidad:</td>
									<td width="10">&nbsp;</td>
									<td><input type="checkbox" name="Reparacion" id="Reparacion" value="1" <?=($Reparacion) ? 'checked="checked"' : '';?> /></td>
								</tr>
                                <tr>
                                    <td>&nbsp;</td>
                                </tr>
                                ...
                                <tr>
									<td>&nbsp;</td>
                                    <td>&nbsp;</td>
                                    <td><?php if ($err & 1) { ?><li style="color: red">Debe ingresar uun comentario para marcar la unidad debe repararse la unidad.<?php } ?>&nbsp;</li></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
