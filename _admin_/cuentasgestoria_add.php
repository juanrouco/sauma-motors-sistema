		...
		case 'Select':
			...
			foreach ($arrIdMinuta as $IdMinuta)
			{
				...
				if ($err == 0)
				{
					...
					$oCuentaGestoria->PatentamientoCalculado = $oMinuta->PrecioVenta * 0.015 + 500;
            ...
            <td>
                <table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
                    <tr>
                        ...
                        <td height="40"><span class="tituloPagina">Administraci&oacute;n de Cuentas Corriente de Gestor&iacute;a - Agregar</span></td>
                    </tr>
                </table>
            </td>
        </tr>
