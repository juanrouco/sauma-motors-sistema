...
if (!Session::CheckPerm(PERM_PAIS_LIST))
	Session::NoPerm();
...
$arrData = $oPaises->GetAll($filter, $oPage);
            ...
            <td>
                <table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
                    <tr>
                        ...
                        <td height="40"><span class="tituloPagina">Administraci&oacute;n de Paises</span></td>
                    </tr>
                </table>		
         	</td>
        </tr>
        <tr>
            <td height="30" valign="top">
                <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                	<?php if (Session::CheckPerm(PERM_PAIS_CREATE)){ ?>
                    <tr>
                        <td width="30" height="40"><div align="center"><img src="images/iconos/add.gif" alt="Agregar" border="0"></div></td>
                        <td height="40"><a href="paises_add.php<?=$strParams?>" >Agregar</a></td>
                    </tr>
                	<?php } ?>
                </table>		
         	</td>
            ...
            <td>
                <table width="100%" align="center" cellpadding="0" cellspacing="0" class="bordeGris">
                    <tr class="bordeGrisFondo">
                        ...
                        <td width="100" height="25" class="bordeGrisTitulo"><div align="center"><strong>Codigo</strong></div></td>
                        <td height="25" class="bordeGrisTitulo"><div id="margen"><strong>Pa&iacute;s</strong></div></td>
                        <td width="100" class="bordeGrisTitulo"><div align="center"><strong>Acciones</strong></div></td>
                  	</tr>
          
                <?php foreach ($arrData as $oPais) { ?>
          
                    <tr onMouseOver="bgColor='#f3f3f3'" onMouseOut="bgColor=''">
                        <td width="5" class="bordeGrisTitulo">&nbsp;</td>
                        <td width="100" height="25"><div align="center"><?=$oPais->Codigo?></div></td>
                        <td height="25"><div align="left" id="margen"><?=$oPais->Nombre?></div></td>
                        <td width="100" height="25">
                            <div align="center"> 
                            <?php if (Session::CheckPerm(PERM_PAIS_UPDATE)){ ?>
                                <a href="paises_mod.php<?=$strParams?>&IdPais=<?=$oPais->IdPais?>">
                                    <img src="images/iconos/mod.gif" alt="Modificar" border="0" /></a> - 
                            <?php } ?>
                            <?php if (Session::CheckPerm(PERM_PAIS_DELETE)){ ?>
                                <a href="paises_del.php<?=$strParams?>&IdPais=<?=$oPais->IdPais?>">
