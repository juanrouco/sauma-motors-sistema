...
{
	header('Location: pagos_pedidosmayorista.php' . $IdPagoMayorista);
	exit;
}

if ($Submit)
{
	$oPagoMayorista = $oPagosMayorista->Delete($oPagoMayorista->IdPagoMayorista);
		...
		<td>
			<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
				<tr>
					...
					<td height="40"><span class="tituloPagina">Administraci&oacute;n de Pagos - Eliminar</span></td>
				</tr>
			</table>
		</td>
	</tr>
					...
					<tr>
						<td class="bordeGris">
							<table  border="0" align="center" cellpadding="0" cellspacing="0">
								...
								<tr>
									<td><div align="center" class="campoEliminar">Pago de $<?=number_format($oPagoMayorista->Importe, 2, ',', '.')?> al pedido Nro. <?= $oPagoMayorista->IdPedidoMayorista ?></div></td>
								</tr>
								<tr>
									<td>&nbsp;</td>
								</tr>
