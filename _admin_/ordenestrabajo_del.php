...
if ($Submit)
{
	$oOrdenTrabajo = $oOrdenesTrabajo->Delete($oOrdenTrabajo->IdOrdenTrabajo);
		...
		<td>
			<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
				<tr>
					...
					<td height="40"><span class="tituloPagina">Administraci&oacute;n de Ordenes de Trabajo - Eliminar</span></td>
				</tr>
			</table>
		</td>
	</tr>
					...
					<tr>
						<td class="bordeGris">
							<table  border="0" align="center" cellpadding="0" cellspacing="0">
								...
								<tr>
									<td><div align="center" class="campoEliminar"><?=CambiarFecha($oOrdenTrabajo->Fecha)?></div></td>
								</tr>
								<tr>
									<td>&nbsp;</td>
								</tr>
						...
						<tr>
						  	<td height="30">
								<div align="center">
									...
									<input type="button" name="btnCancelar" class="botonBasico" id="btnCancelar" value="Cancelar" onClick="javascript: window.location.href = 'ordenestrabajo.php<?=$strParams?>';">
								</div>
							</td>
						</tr>
					</form>
