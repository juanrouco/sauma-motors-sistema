...
else
{
	...
	$oPdf->Text(11.5, 6.15 + $yAlt, $oTipoDocumento->Codigo . ': ' . $oCliente->DocumentoNumero);
}
...
if ($oModelo->Iva == '10.5')
{
	$oPdf->Text(3, 13.5 + $yAlt, 'ALICUOTA:');
...
$yAlt = -1.5;
/* importes */
	$oPdf->Text(13.8, 9.3 + $yAlt, number_format($oNotaCredito->Importe, 2));
$oPdf->Text(13.8, 19 + $yAlt, number_format($oNotaCredito->Importe, 2));
