					  	...
					  	<tr>
							<td class="bordeGris">
								<table border="0" align="center" cellpadding="0" cellspacing="0">
                                	...
                                	<tr>
										<td height="20">&nbsp;</td>
										<td height="20" align="left"><?php if ($err & 8) { ?><li style="color:#FF0000;">El nro de recibo ya fue ingresado.</li><?php } ?><?php if ($err & 16) { ?><li style="color:#FF0000;">Ingrese un nro de recibo.</li><?php } ?></td>
									</tr>
									<tr>
                                                        ...
                                                        <td>
                                                            <div align="left">
                                                              <select name="BancoDestino" id="BancoDestino" class="camporFormularioSimple">
																...
																<option value="Banco Santander Rio" <?= $BancoDestino == 'Banco Santander Rio' ? 'selected="selected"' : '' ?>>Banco Santander Rio</option>
