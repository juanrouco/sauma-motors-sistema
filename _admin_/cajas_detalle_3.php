...
{
	$filter = array();
	$filter['FechaDesde'] 		 = $Fecha;
	$filter['FechaHasta']		 = $Fecha;
...
function ClearFilter()
{
	...
	frmData.FilterIdTipoMovimiento.value 	= '';
...
<form name="frmData" id="frmData" method="post" action="<?=$_SEVER['PHP_SELF']?>" onSubmit="Filtrar();">
    ...
    <table width="90%"  border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <td>
                <table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
                    <tr>
                        ...
                        <td height="40"><span class="tituloPagina">Caja <?= $oCajaDetalle->Nombre ?> - Detalle Diario</span></td>
                    </tr>
                </table>
            </td>
        </tr>     
        ...
        <tr>
            <td align="right"><a href="cajas_detalle_2.php?IdCajaDetalle=1" class="linkMenu">[Volver al detalle de la caja]</a></td>
            <td></td>
        </tr>     
        <tr>
            <td></td>
            ...
            <td>
                ...
                <table width="100%" align="center" cellpadding="0" cellspacing="0" class="bordeGris">
                    <tr class="bordeGrisFondo">
                        <td width="15%" height="25" class="bordeGrisTitulo"><div id="margen"><strong>Fecha</strong></div></td>
                        <td width="20%" height="25" class="bordeGrisTitulo"><div id="margen"><strong>Tipo Movimiento</strong></div></td>
                        <td width="25%" height="25" class="bordeGrisTitulo"><div id="margen"><strong>Cliente/Proveedor</strong></div></td>
                        <td width="25%" height="25" class="bordeGrisTitulo"><div id="margen"><strong>Observaciones</strong></div></td>
                        <td width="15%" height="25" class="bordeGrisTitulo"><div id="margen" align="center"><strong>Total</strong></div></td>
                    </tr>
                ...
                ?>      
                    ...
                    <tr onMouseOver="bgColor='#f3f3f3'" onMouseOut="bgColor=''">
                        ...
                        <td height="25"><div id="margen"><?= $Nombre ?></div></td>
