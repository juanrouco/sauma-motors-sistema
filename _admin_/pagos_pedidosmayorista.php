...
$strParams = '?';
$strParams.= '&IdPedidoMayorista=' 	. $IdPedidoMayorista;
$strParams.= '&Page='				. $Page;
...
$arrPagosMayorista = $oPagosMayorista->GetByIdPedidoMayorista($oPedidoMayorista->IdPedidoMayorista);
...
<form name="frmData" id="frmData" method="post" action="" onSubmit="Filtrar();">
    ...
    <table width="90%"  border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <td>
                <table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
                    <tr>
                        ...
                        <td height="40"><span class="tituloPagina">Administraci&oacute;n de Pedidos Mayorista - Pagos</span></td>
                    </tr>
                </table>		
            </td>
        </tr>
                                    ...
                                    <td>
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="pagos_pedidosmayorista_add.php<?= $strParams ?>">Agregar</a></td>
                                            </tr>
											<?php } ?>
                                        </table>
                                    </td>
                                    <td><div align="right"><a href="pedidosmayorista.php<?= $strParams ?>" class="linkMenu"><strong>[Volver al listado de cuentas corriente]</strong></a></div></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
       ...
       <?php /* <tr>
        ...
        <tr>
            <td><b>Pagos al Pedido Nro. <?= $IdPedidoMayorista ?>:</b></td>
        </tr>
        <tr>
            <td>&nbsp;</td>
        </tr>
		<?php if ($arrPagosMayorista != NULL) { ?>
        <tr>
            <td>&nbsp;</td>
        </tr>
        <tr>
            <td>
                ...
                <?php foreach ($arrPagosMayorista as $oPago) { ?>
                    ...
                    <tr onMouseOver="bgColor='#f3f3f3'" onMouseOut="bgColor=''">
                        ...
                        <td width="80" height="25"> 
                            <div align="left">
                                ...
                                <a href="pagos_pedidosmayorista_mod.php<?=$strParams?>&IdPagoMayorista=<?=$oPago->IdPagoMayorista?>"><img src="images/iconos/mod.gif" alt="Modificar" border="0" /></a> - 
                                <?php } ?>
								<?php if (Session::CheckPerm(PERM_PAGO_UPDATE)){ ?>
                                <a href="pagos_pedidosmayorista_distribuir.php<?=$strParams?>&IdPagoMayorista=<?=$oPago->IdPagoMayorista?>"><img src="images/iconos/relacion.png" alt="Distribuir Pago" border="0" /></a> - 
                                <?php } ?>
								<?php if (Session::CheckPerm(PERM_PAGO_DELETE)){ ?>
								<a href="pagos_pedidosmayorista_del.php<?=$strParams?>&IdPagoMayorista=<?=$oPago->IdPagoMayorista?>"><img src="images/iconos/del.gif" alt="Eliminar" border="0" /></a>
								<?php } ?>
							</div>
                        </td>
                    </tr>
    ...
    <?php } ?>
        ...
        foreach ($arrPedidosMayoristaDetalles as $oPedidoMayoristaDetalle)
        {
        	...
        	$filterPago['IdMinuta'] 	= trim($oPedidoMayoristaDetalle->IdMinuta);
        ...
        <tr>
            <td><b>Pagos del Interno <?=$oMinuta->IdUnidad?>:</b></td>
        </tr>
        <tr>
            <td>&nbsp;</td>
        </tr>
