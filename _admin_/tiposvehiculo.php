...
$Paginado	= Pageable::PrintPaginator($oPage, $oTiposVehiculo->GetCountRows($filter), true);
$arrData 	= $oTiposVehiculo->GetAll($filter, $oPage);
            ...
            <td>
                <table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
                    <tr>
                        ...
                        <td height="40"><span class="tituloPagina">Tipos de Veh&iacute;culo</span></td>
                    </tr>
                </table>
            </td>
        </tr>
            ...
            <td height="30" valign="top">
                <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                    ...
                    <?php if (Session::CheckPerm(PERM_MARC_CREATE)){ ?>
                        ...
                        <td height="40"><a href="tiposvehiculo_add.php<?=$strParams?>">Agregar</a></td>
                    <?php } ?>
                        <td width="10">&nbsp;</td>
                    </tr>
                </table>
            ...
            <td>
                <table width="100%" align="center" cellpadding="0" cellspacing="0" class="bordeGris">
                	<tr class="bordeGrisFondo">
                  		...
                  		<td width="195" height="25" class="bordeGrisTitulo"><div><div align="left"><strong>Tipo de Veh&iacute;culo</strong></div></div></td>
                  		<td width="92" height="25" class="bordeGrisTitulo"><div align="center"><strong>Acciones</strong></div></td>
                	</tr>
          
                <?php foreach ($arrData as $oTipoVehiculo) { ?>      
                
                    <tr onMouseOver="bgColor='#f3f3f3'" onMouseOut="bgColor=''">
                      	<td width="307" valign="middle"><div id="margen"><?=$oTipoVehiculo->Codigo?></a></div></td>				  
                    	<td width="195" valign="middle"><div align="left"><?=$oTipoVehiculo->Nombre?></div>
                      	<td width="92" valign="middle">
                        	<div align="center">
							<?php if (Session::CheckPerm(PERM_MARC_UPDATE)){ ?>
                                <a href="tiposvehiculo_mod.php<?=$strParams?>&IdTipoVehiculo=<?=$oTipoVehiculo->IdTipoVehiculo?>">
                                    <img src="images/iconos/mod.gif" alt="Modificar" border="0" /></a> - 
                            <?php } ?>
                            <?php if (Session::CheckPerm(PERM_MARC_DELETE)){ ?>
                                <a href="tiposvehiculo_del.php<?=$strParams?>&IdTipoVehiculo=<?=$oTipoVehiculo->IdTipoVehiculo?>">
