...
if ($Submit)
{
	...
	{		
		...
		$oOrdenTrabajo->IdUsuarioCreacion	= Session::GetCurrentUser()->IdUsuario;
    	...
    	<td>
			<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
      			<tr>
        			...
        			<td height="40"><span class="tituloPagina">Agregar Orden de Trabajo</span></td>
      			</tr>
    		</table>
		</td>
  	</tr>
																		...
																		<tr>
																			<td>
																				<table width="100%" cellpadding="0" cellspacing="0" border="0">
																					...
																					<tr>
																						<td valign="middle"><div align="right">Fecha Salida:</div></td>
																						<td valign="top">
																							<div align="left">
																					...
																					<tr>
																						<td valign="middle"><div align="right">Horario Salida:</div></td>
																						<td>
																							<div align="left">
