...
if ($Submit)
{
	...
	if ($err == 0)
	{
		...
		$oFacturaPostVenta = $oOrdenTrabajoFactura->GenerarFacturaFromFranquicia($oOrdenTrabajoFranquicia, $oCliente, $oComprobante);
...
function ActualizarFacturacion()
{
	...
	var itemBruto = parseFloat($j('#Importe').val());
