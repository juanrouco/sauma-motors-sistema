...
<form name="frmData" id="frmData" method="post" action="contratosprendasusados_reporte_pdf.php">
            ...
            <td>
                <table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
                    <tr>
                        ...
                        <td height="40"><span class="tituloPagina">Exportar Reporte Prendas</span></td>
                    </tr>
                </table>		
            </td>
        </tr>
                            ...
                            <td class="tituloMenu">
                                <table border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>                              
										...
										<td>&nbsp;</td>
                                        <td class="tituloMenu"><div align="right">Pre Prenda:</div></td>
                                        <td>
											<select name="FilterPrePrenda" id="FilterPrePrenda" class="camporFormularioMediano">
												<option value="">INDISTINTO</option>
                                    ...
                                    <tr>                              
                                        ...
                                        <td>&nbsp;</td>
                                        <td>&nbsp;</td>
                                        <td align="right"><input type="submit" name="button" id="button" class="botonBasico" value="Exportar"></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
