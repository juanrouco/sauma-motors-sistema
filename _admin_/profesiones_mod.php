...
if (!Session::CheckPerm(PERM_PROF_UPDATE))
	Session::NoPerm();
...
if ($Submit)
{
	...
	if ($Nombre == '')
		$err |= 2;
	elseif (($oProfesion->Nombre != $Nombre) && ($oProfesiones->GetByNombre($Nombre)))
		$err |= 4;
	...
	if ($err == 0)
	{
		...
		$oProfesion = $oProfesiones->Update($oProfesion);
...
{
	$Codigo = $oProfesion->Codigo;
	$Nombre = $oProfesion->Nombre;
}
    	...
    	<td>
			<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
      			<tr>
        			...
        			<td height="40"><span class="tituloPagina">Administraci&oacute;n de Profesiones - Modificar</span></td>
      			</tr>
    		</table>
		</td>
  	</tr>
                        ...
                        <tr>
                            <td height="30">
                                <div align="center">
                                    ...
                                    <input type="button" name="btnCancelar" class="botonBasico" id="btnCancelar" onclick="javascript: window.location.href = 'profesiones.php<?=$strParams?>';" value="Cancelar" />
                                </div>
                            </td>
                        </tr>
                    </table>
