    	...
    	<td>
			<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
      			<tr>
        			...
        			<td height="40"><span class="tituloPagina">Administraci&oacute;n de Ordenes de Salida - Detalle</span></td>
      			</tr>
    		</table>
		</td>
  	</tr>
				...
				<form name="frmData" id="frmData" method="post" action="<?=$strParams?>">
					...
					<table width="90%"  border="0" align="center" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
						<tr>
							<td height="30">
								<div align="center">
									<input type="button" name="btnCancelar" class="botonBasico" id="btnCancelar" onclick="javascript: window.location.href = 'ordenessalida.php<?=$strParams?>';" value="Volver" />
								</div>
							</td>
						</tr>
					</table>
