...
$Obsoleto					= intval($_REQUEST['Obsoleto']);
...
$oTiposCarroceria 	= new TiposCarroceria();
$oTiposUso			= new TiposUso();
$oTiposVehiculo		= new TiposVehiculo();
...
if ($Submit)
{
	...
	if ($DenominacionComercial == '')
		$err |= 32;
	if ($NumeroVin != '' && strlen($NumeroVin) != 10 && strlen($NumeroVin) != 8)
		$err |= 128;
	...
	if ($err == 0)
	{
		...
		$oModelo->GTIN						= $GTIN;
		$oModelo->Cufe						= $Cufe;
		$oModelo->Obsoleto					= $Obsoleto;
		
		$oModelo = $oModelos->Update($oModelo);
...
else
{
	...
	$oTipoVehiculo		= $oTiposVehiculo->GetById($oModelo->IdTipoVehiculo);
	$oTipoCarroceria	= $oTiposCarroceria->GetById($oModelo->IdTipoCarroceria);
	$oTipoUso			= $oTiposUso->GetById($oModelo->IdTipoUso);
	$oDestinoVehiculo	= $oDestinosVehiculo->GetById($oModelo->IdDestinoVehiculo);
	
	$IdTipoCombustible			= $oModelo->IdTipoCombustible;
	$IdTipoModelo				= $oTipoModelo->IdTipoModelo;
	$TipoModelo					= $oTipoModelo->Nombre;
	$TipoModeloCodigo			= $oTipoModelo->Codigo;
	
	$IdTipoVehiculo 			= $oModelo->IdTipoVehiculo;
	if ($oTipoVehiculo)
	{
		$TipoVehiculo				= $oTipoVehiculo->Nombre;
		$TipoVehiculoCodigo			= $oTipoVehiculo->Codigo;	
	}
	$IdTipoCarroceria 			= $oModelo->IdTipoCarroceria;
	if ($oTipoCarroceria)
	{
		$TipoCarroceria				= $oTipoCarroceria->Nombre;
		$TipoCarroceriaCodigo		= $oTipoCarroceria->Codigo;
	}
	$IdTipoUso		 			= $oModelo->IdTipoUso;
	if ($oTipoUso)
	{
		$TipoUso					= $oTipoUso->Nombre;
		$TipoUsoCodigo				= $oTipoUso->Codigo;
	}
	$IdDestinoVehiculo 			= $oModelo->IdDestinoVehiculo;
	if ($oDestinoVehiculo)
	{
		$DestinoVehiculo			= $oDestinoVehiculo->Nombre;
		$DestinoVehiculoCodigo		= $oDestinoVehiculo->Codigo;
	}
		
	$IdCategoriaModelo			= $oCategoriaModelo->IdCategoriaModelo;
	$CategoriaModelo			= $oCategoriaModelo->Nombre;
	$CategoriaModeloCodigo		= $oCategoriaModelo->Codigo;
	$IdMarcaMotor				= $oMarcaMotor->IdMarca;
	$MarcaMotor					= $oMarcaMotor->Nombre;
	$MarcaMotorCodigo			= $oMarcaMotor->Codigo;
	$IdMarcaChasis				= $oMarcaChasis->IdMarca;
	$MarcaChasis				= $oMarcaChasis->Nombre;
	$MarcaChasisCodigo			= $oMarcaChasis->Codigo;
	$IdMarcaVehiculo			= $oMarcaVehiculo->IdMarca;
	$MarcaVehiculo				= $oMarcaVehiculo->Nombre;
	$MarcaVehiculoCodigo		= $oMarcaVehiculo->Codigo;
	$NumeroVin					= $oModelo->NumeroVinPrefijo;
	$CodigoComercial			= $oModelo->CodigoComercial;
	$DenominacionComercial		= $oModelo->DenominacionComercial;
	$DenominacionModelo			= $oModelo->DenominacionModelo;
	$Anio						= $oModelo->Anio;
	$Peso						= $oModelo->Peso;
	$PrecioPublicoNeto			= $oModelo->PrecioPublicoNeto;
	$PrecioPublicoTotalIva		= $oModelo->PrecioPublicoTotalIva;
	$Precio1					= $oModelo->Precio1;
	$Precio2					= $oModelo->Precio2;
	$MesPrecioTotal				= $oModelo->MesPrecioTotal;
	$Patentamiento				= $oModelo->Patentamiento;
	$MesPrecioTotalGeneral		= $oModelo->MesPrecioTotalGeneral;
	$Flete						= $oModelo->Flete;	
	$PrecioCompra				= $oModelo->PrecioCompra;
	$ReventaPrecio				= $oModelo->ReventaPrecio;
	$Iva						= $oModelo->Iva;
	$Prenda						= $oModelo->Prenda;
	$Otorgamiento				= $oModelo->Otorgamiento;
	$ImpuestoInterno			= $oModelo->ImpuestoInterno;
	$BonificacionCompra			= $oModelo->BonificacionCompra;
	$BonificacionVenta			= $oModelo->BonificacionVenta;
	$BonificacionExtra			= $oModelo->BonificacionExtra;	
	$DescuentoReventa			= $oModelo->DescuentoReventa;
	$RecuperoBonificacion		= $oModelo->RecuperoBonificacion;
	$Cilindrada					= $oModelo->Cilindrada;
	$Electrolito				= $oModelo->Electrolito;
	$GTIN						= $oModelo->GTIN;
	$Cufe						= $oModelo->Cufe;
	$Obsoleto						= $oModelo->Obsoleto;
}
            ...
            <td>
                <table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
                    <tr>
                        ...
                        <td height="40"><span class="tituloPagina">Administraci&oacute;n de Modelos - Modificar</span></td>
                    </tr>
                </table>
            </td>
        </tr>
                                                ...
                                                <tr>
                                                                ...
                                                                <td>
                                                                    <table border="0" align="left" cellpadding="0" cellspacing="0">
                                                                        ...
                                                                        <tr>
                                                                            <td>
                                                                                <div align="left">
                                                                                    <input type="text" name="MarcaVehiculo" id="MarcaVehiculo" class="camporFormularioSuggest" maxlength="128" value="<?=$MarcaVehiculo?>" onkeyup="javascript: StrToUpper(this.id);" />
                                                                                    <script language="">
                                                                ...
                                                                <td>
                                                                    <table border="0" align="left" cellpadding="0" cellspacing="0">
                                                                        ...
                                                                        <tr>
                                                                            <td>
                                                                                <div align="left">
                                                                                    <input type="text" name="MarcaMotor" id="MarcaMotor" class="camporFormularioSuggest" maxlength="128" value="<?=$MarcaMotor?>" onkeyup="javascript: StrToUpper(this.id);" />
                                                                                    <script language="">
                                                                ...
                                                                <td>
                                                                    <table border="0" align="left" cellpadding="0" cellspacing="0">
                                                                        ...
                                                                        <tr>
                                                                            <td>
                                                                                <div align="left">
                                                                                    <input type="text" name="MarcaChasis" id="MarcaChasis" class="camporFormularioSuggest" maxlength="128" value="<?=$MarcaChasis?>" onkeyup="javascript: StrToUpper(this.id);" />
                                                                                    <script language="">
                                                    ...
                                                    <td valign="top">
                                                        <table border="0" align="center" cellpadding="0" cellspacing="0">
                                                                ...
                                                                <td>
                                                                    <table border="0" align="left" cellpadding="0" cellspacing="0">
                                                                        ...
                                                                        <tr>
                                                                            <td>
                                                                                <div align="left">
                                                                                    <input type="text" name="CategoriaModelo" id="CategoriaModelo" class="camporFormularioSuggest" maxlength="128" value="<?=$CategoriaModelo?>" onkeyup="javascript: StrToUpper(this.id);" />
                                                                                    <script language="">
                                                            ...
                                                            <tr>
                                                                <td><div id="margen" align="left">Discontinuado:
                                                                        <input type="checkbox" name="Obsoleto" id="Obsoleto" value="1" <?= $Obsoleto ? 'checked="checked"' : '' ?> />
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                            <tr>
