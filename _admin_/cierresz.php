...
$Paginado	= Pageable::PrintPaginator($oPage, $oCierresZ->GetCountRows($filter), true);
$arrData = $oCierresZ->GetAll($filter, $oPage);
...
{	
	window.location.href = 'cierresz.php';
}								
            ...
            <td>
                <table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
                    <tr>
                        ...
                        <td height="40"><span class="tituloPagina">Administraci&oacute;n de Cierres Z</span></td>
                    </tr>
                </table>		
            </td>
        </tr>
            ...
            <td height="30" valign="top">
                ...
                <?php if (Session::CheckPerm(PERM_CMPB_CREATE)){ ?>
                    <tr>
                        ...
                        <td height="40"><a href="cierre_z.php<?=$strParams?>">Generar</a></td>
                        <td width="10">&nbsp;</td>
                    </tr>
                <?php } ?>
                </table>		
            ...
            <td>
                <table width="100%" align="center" cellpadding="0" cellspacing="0" class="bordeGris">
                    <tr class="bordeGrisFondo">
                        ...
                        <td height="25" class="bordeGrisTitulo"><div id="margen"><strong>Usuario</strong></div></td>
                    </tr>
          
                <?php foreach ($arrData as $oCierreZ) { 
					$oUsuario = $oUsuarios->GetById($oCierreZ->IdUsuario);
				?>
          
                    <tr onMouseOver="bgColor='#f3f3f3'" onMouseOut="bgColor=''">
                        <td width="4" class="bordeGrisTitulo">&nbsp;</td>
                        <td width="259" height="25"><div id="margen"><?= CambiarFechaHora($oCierreZ->Fecha) ?></div></td>
                        <td width="610" height="25"><div id="margen"><?=$oUsuario->Nombre?> <?=$oUsuario->Apellido?></div></td>                        
                    </tr>
                    <tr>
                        <td colspan="3">
                            <div align="center">
