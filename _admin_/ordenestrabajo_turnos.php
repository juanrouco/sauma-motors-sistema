		...
		$('#calendar').fullCalendar({
			...
			dayClick: function(date, allDay, jsEvent, view) {
				...
				if (view.name != 'month' && !allDay) {
					...
					window.location.href= "turnos_add.php?FechaInicio=" + fechaInicio + "&HoraInicio=" + horaInicio + "&MinutoInicio=" + minutoInicio;
				}
			},
			...
			eventMouseover: function(calEvent, jsEvent) {
				...
				$.ajax('json-turnos.php?IdTurno=' + calEvent.id, {
					dataTyoe: 'json',
					success: function (data, textStatus, jqXHR) {
						...
						html+= '<div class="row"><label>Reconfirmado:&nbsp;</label>' + json.Reconfirmado + '</div>';
						html+= '<div class="row"><label>Remis:&nbsp;</label>' + json.Remis + '</div>';
