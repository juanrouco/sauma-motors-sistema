...
{	
	window.location.href = 'ventarepuestos_ot_garantia.php?MainAction=<?=$Action?>';
}								
            ...
            <td>
                <table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
                    <tr>
                        ...
                        <td height="40"><span class="tituloPagina">Administraci&oacute;n de Repuestos asignados en garant&iacute;a</span></td>
                    </tr>
                </table>		
            </td>
        </tr>       
                        ...
                        <td width="20%" height="40">
                            <table border="0" align="left" cellpadding="0" cellspacing="0">
                                <tr>
                                    ...
                                    <td><a href="ventasrepuestos_ot_garantia_exportar.php<?=$strParams?>">Exportar</a></td>
