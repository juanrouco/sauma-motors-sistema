...
if ($Submit)
{
	...
	if ($err == 0)
	{
		$oFacturaPostVenta->IdCliente			= $IdCliente;
		$oFacturaPostVenta->Fecha				= $Fecha;
		$oFacturaPostVenta->IdFormaPago			= FormaPago::CtaCte;
		$oFacturaPostVenta->IdPlanCuota			= 59;

		if ($oFacturaPostVenta = $oFacturasPostVentas->Create($oFacturaPostVenta))
		{
			header("Location: facturaspostventas_add_paso2.php" . $strParams . '&IdFacturaPostVenta=' . $oFacturaPostVenta->IdFacturaPostVenta);
			exit();
		}
	}
}
    	...
    	<td>
			<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
      			<tr>
        			...
        			<td height="40"><span class="tituloPagina">Administraci&oacute;n de Facturas de Post Venta - Agregar</span></td>
      			</tr>
    		</table>
		</td>
  	</tr>
						...
						<tr>
							<td height="30">
								<div align="center">
									...
									<input type="button" name="btnCancelar" class="botonBasico" id="btnCancelar" onclick="javascript: window.location.href = 'facturaspostventas.php<?=$strParams?>';" value="Cancelar" />
								</div>
							</td>
						</tr>
					</table>
