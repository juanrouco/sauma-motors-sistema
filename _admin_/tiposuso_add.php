...
if ($Submit)
{
	...
	if ($Nombre == '')
		$err |= 2;
	elseif ($oTiposUso->GetByNombre($Nombre))
		$err |= 4;
	...
	if ($err == 0)
	{
		...
		$oTipoUso = $oTiposUso->Create($oTipoUso);
    	...
    	<td>
			<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
      			<tr>
        			...
        			<td height="40"><span class="tituloPagina">Administraci&oacute;n de Tipos de Uso - Agregar</span></td>
      			</tr>
    		</table>
		</td>
  	</tr>
