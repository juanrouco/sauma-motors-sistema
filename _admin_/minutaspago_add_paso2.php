	...
	switch ($Action)
	{
		case 'Select':
			...
			foreach ($arrIdUnidad as $IdUnidad)
			{
				...
				if ($err == 0)
				{
					...
					$oMinutaPagoItem->IdProveedor		= $oUnidad->IdProveedor;
		...
		case 'Next':
			if (abs($TotalAPagar_v - $oMinutaPago->MontoDisponible) > 0.001)
				...
				{
					header('Location: minutaspago_add_paso3.php?IdMinutaPago=' . $IdMinutaPago);
					exit;
				}
            ...
            <td>
                <table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
                    <tr>
                        ...
                        <td height="40"><span class="tituloPagina">Administraci&oacute;n de Minutas de Pago - Agregar Unidades</span></td>
                    </tr>
                </table>
            </td>
        </tr>
