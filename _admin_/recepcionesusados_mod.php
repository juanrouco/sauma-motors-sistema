...
if (!Session::CheckPerm(PERM_RECEPUS_UPDATE))
	Session::NoPerm();
...
if ($Submit)
{
	...
	if ($err == 0)
	{
		...
		if ($oRecepcionUsado = $oRecepcionesUsados->Update($oRecepcionUsado))
		{
    	...
    	<td>
			<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
      			<tr>
        			...
        			<td height="40"><span class="tituloPagina">Administraci&oacute;n de Recepci&oacute;n de Usados - Modificar</span></td>
      			</tr>
    		</table>
		</td>
  	</tr>
