...
<script type="text/javascript">
	...
	function validar(tab, busqueda)
	{
		switch(tab) {
			case 0: 
				if ($j('#IdTipoOperacion:checked').length == 0) {
					$j('.error_1').show();
					return false;
				} else {
					$j('.error_1').hide();
	...
	$j(document).ready(function() {
		...
		$j('input[name=IdTipoOperacion]').change(function() {
			var sel = $j('#IdTipoOperacion:checked').val();
			if (sel == '0' || sel == 0) {
				$j('#Dominio').attr('disabled', 'disabled');
				$j('#Dominio').val('');
				$j('#IdOrdenTrabajo').val('');
				$j('#lblTallerUnidad').html('');
				$j('#Cliente').removeAttr("disabled");
				$j('#tareasTrabajo').children().remove();
				
			} else {
				$j('#Cliente').attr('disabled', 'disabled');
				$j('#Cliente').val('');
				$j('#IdCliente').val('');
				$j('#Dominio').removeAttr("disabled");
				
			}
			
			<?php
			foreach (TipoVenta::GetAllVenta() as $oTipoVenta)
			{
			?>
			if (sel == '<?= $oTipoVenta['IdTipoVenta'] ?>')
			{
				$j('#TipoVenta').html('<?= $oTipoVenta['Nombre'] ?>');
			}
			<?php
			}
			?>
    	...
    	<td>
			<div id="tabs" align="center">
				<form name="frmData" id="frmData" method="post" enctype="multipart/form-data">
					...
					<ul>
						<li><a href="#tipo-venta">Tipo de Devoluci&oacute;n</a></li>
						<li><a href="#cliente-unidad">Cliente / Unidad</a></li>
						<li><a href="#repuestos">Repuestos</a></li>
						<li><a href="#facturas">Confirmar Devoluci&oacute;n</a></li>
					</ul>
					
					<div id="cliente-unidad">
						<div class="titulo-seccion" style="text-align: left">Ingrese el cliente o la unidad:</div>
								...
								<td class="bordeGris">
									<table  border="0" cellpadding="0" cellspacing="0">										
										...
										<tr class="error_2" style="display:none">											
											<td colspan="3"><li style="color:#FF0000;">Debe ingresar un cliente o seleccionar una OT y Tarea.</li></td>
										</tr>															
										<tr>
											<td colspan="3">&nbsp;</td>
										</tr>
					...
					<div id="tipo-venta">
						<div class="titulo-seccion" style="text-align: left">Seleccione el tipo de devoluci&oacute;n:</div>
						<div style="clear:both; height: 0px">&nbsp;</div>
						<table width="100%"  border="0" cellpadding="5" cellspacing="0">
							<tr>
								<td class="bordeGris">
									<table  border="0" cellpadding="0" cellspacing="0">
										...
										<tr>											
											<td>
												<input type="radio" name="IdTipoOperacion" id="IdTipoOperacion" value="<?= $oTipoVenta['IdTipoVenta'] ?>" />
												<span><?= $oTipoVenta['Nombre'] ?></span>											
											</td>
										</tr>
										<?php
										}
										?>																		
										<tr class="error_1" style="display:none">											
											<td colspan="2"><li style="color:#FF0000;">Debe seleccionar un tipo de devoluci&oacute;n</li></td>
										</tr>															
										<tr>
											<td>&nbsp;</td>
										</tr>
					...
					<div id="repuestos">
						<div class="titulo-seccion" style="text-align: left">Seleccione los repuestos:</div>
						<div style="clear:both; height: 0px">&nbsp;</div>
						<table width="100%" border="0" cellpadding="5" cellspacing="0">
							<tr>
								<td class="bordeGris">
						...
						<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
							<tr>
								<td height="30">
									<div align="right">
									<input type="button" class="botonBasico anterior" alt="3" id="btnAnterior_3" value="Anterior" />
									<input type="button" class="botonBasico siguiente" alt="3" id="btnSiguiente_3" value="Siguiente" />									
					...
					<div id="facturas">
						<div class="titulo-seccion" style="text-align: left">Tipo de Devoluci&oacute;n:</div>
						<div style="clear:both; height: 0px">&nbsp;</div>
						<table width="100%" border="0" cellpadding="5" cellspacing="0">
							<tr>
								<td class="bordeGris">
						...
						<div class="titulo-seccion" style="text-align: left">Repuestos:</div>
						<div style="clear:both; height: 0px">&nbsp;</div>
						<table width="100%" border="0" cellpadding="5" cellspacing="0">
							<tr>
								<td class="bordeGris">
