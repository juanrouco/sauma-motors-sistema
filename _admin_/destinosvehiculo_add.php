...
if ($Submit)
{
	...
	if ($Nombre == '')
		$err |= 2;
	elseif ($oDestinosVehiculo->GetByNombre($Nombre))
		$err |= 4;
	...
	if ($err == 0)
	{
		...
		$oDestinoVehiculo = $oDestinosVehiculo->Create($oDestinoVehiculo);
    	...
    	<td>
			<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
      			<tr>
        			...
        			<td height="40"><span class="tituloPagina">Administraci&oacute;n de Destinos Veh&iacute;culo - Agregar</span></td>
      			</tr>
    		</table>
		</td>
  	</tr>
