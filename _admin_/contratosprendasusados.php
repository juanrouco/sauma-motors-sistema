...
if (!Session::CheckPerm(PERM_CPREUS_LIST))
	Session::NoPerm();
...
$Paginado	= Pageable::PrintPaginator($oPage, $oContratosPrendasUsados->GetCountRows($filter), true);
$arrData 	= $oContratosPrendasUsados->GetAll($filter, $oPage);
...
{	
	window.location.href = 'contratosprendasusados.php?MainAction=<?=$MainAction?>';
}								
            ...
            <td>
                <table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
                    <tr>
                        ...
                        <td height="40"><span class="tituloPagina">Administraci&oacute;n de Contratos de Prenda de Usados</span></td>
                    </tr>
                </table>		
            </td>
        </tr>
                    ...
                    <tr>
                        <td width="8%" height="40">
                            <table border="0" align="left" cellpadding="0" cellspacing="0">
                                <?php if (Session::CheckPerm(PERM_CPREUS_CREATE)){ ?>
                                <tr>
                                    <td width="30"><div align="center"><img src="images/iconos/add.gif" alt="Agregar" border="0"></div></td>
                                    <td><a href="contratosprendasusados_add.php<?=$strParams?>">Agregar</a></td>
                        ...
                        <td width="12%" height="40">
                            <table border="0" align="right" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    ...
                                    <td><a href="contratosprendasusados_reporte.php<?=$strParams?>">Exportar Reporte</a></td>
									<td>&nbsp;</td>
									<?php if (Session::CheckPerm(PERM_CPREUS_REPORT)){ ?>
									<td width="30"><div align="center"><img src="images/iconos/pdf.png" alt="Exportar XLS" border="0"></div></td>
                                    <td><a href="contratosprendasusados_exportar_pdf.php<?=$strParams?>">Exportar PDF</a></td>
									<td>&nbsp;</td>
									<td width="30"><div align="center"><img src="images/iconos/icono_csv.gif" alt="Exportar XLS" border="0"></div></td>
                                    <td><a href="contratosprendasusados_export.php<?=$strParams?>">Exportar Reporte</a></td>
									<?php } ?>
								</tr>
            ...
            <td>
				...
				?>
                    ...
                    <tr onMouseOver="bgColor='#f3f3f3'" onMouseOut="bgColor=''">
                        <td width="85" height="25"><div id="margen" align="center">U-<?=$oContratoPrenda->IdMinuta?></div></td>
                        ...
                        <td width="91" height="25" valign="middle">
                            <div align="center">
                                <?php if (Session::CheckPerm(PERM_CPREUS_UPDATE)){ ?>
								<a href="contratosprendasusados_mod.php?IdContratoPrenda=<?=$oContratoPrenda->IdContratoPrenda?>">
									<img src="images/iconos/mod.gif" alt="Eliminar" border="0" />
								</a> - <a href="contratosprendasusados_del.php?IdContratoPrenda=<?=$oContratoPrenda->IdContratoPrenda?>">
