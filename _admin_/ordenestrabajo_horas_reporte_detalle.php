			...
			<td height="30" valign="top">
				<table border="0" align="right" cellpadding="0" cellspacing="0">
					<tr>
						...
						<td width="30"><div align="center"><a href="ordenestrabajo_horas_reporte_detalle_exportar.php<?=$strParams?>">Exportar</a></div></td>
						<td width="20">&nbsp;</td>
					</tr>
				</table>
			</td>
  	...
  	<tr>
    	...
    	<td>
			<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
      			<tr>
        			<td width="20" height="40" class="TituloRubro">&nbsp;</td>
        			<td height="40"><span class="tituloPagina">Cantidad de OT: <?= count($arrOrdenesTrabajoHitos) ?></span></td>
   			  </tr>
    		</table>
		</td>
  	</tr>	
