...
for ($i=0; $i<1 /*$oTipoFormulario->CantidadCopias*/; $i++)
{
	...
	if ($oCliente->IdTipoPersona == PersonaTipos::PersonaFisica)
	{
		...
		if ($oNacionalidad->Current)
		{
			if ($oCliente->DocumentoTipo == TipoDocumento::DNI)
				$oPdf->Text($OffsetX + 4.8, $OffsetY + 16.5 + 0.1, 'X');
			if ($oCliente->DocumentoTipo == TipoDocumento::LE)
				$oPdf->Text($OffsetX + 5.9, $OffsetY + 16.5 + 0.1, 'X');
			if ($oCliente->DocumentoTipo == TipoDocumento::LC)
				$oPdf->Text($OffsetX + 7, $OffsetY + 16.5 + 0.1, 'X');
		}
		else
		{
			if ($oCliente->DocumentoTipo == TipoDocumento::DNI)
				$oPdf->Text($OffsetX + 8.5, $OffsetY + 16.5 + 0.1, 'X');
			if ($oCliente->DocumentoTipo == TipoDocumento::CI)
				$oPdf->Text($OffsetX + 9.6, $OffsetY + 16.5 + 0.1, 'X');
			if ($oCliente->DocumentoTipo == TipoDocumento::PA)
				$oPdf->Text($OffsetX + 10.7, $OffsetY + 16.5 + 0.1, 'X');
		}
		$oPdf->Text($OffsetX + 5, $OffsetY + 17.2 + 0.1, $oCliente->DocumentoNumero);
		$oPdf->Text($OffsetX + 8.5, $OffsetY + 17.2 + 0.1, $oCliente->DocumentoExpedido);
		$oPdf->Text($OffsetX + 6.5, $OffsetY + 17.9 + 0.1, ClaveFiscalTipos::GetById($oCliente->ClaveFiscalTipo) . ': ' . $oCliente->ClaveFiscalNumero);
		$oPdf->Text($OffsetX + 7, $OffsetY + 18.6, $LocalidadNacimiento);
		
		if ($oCliente->IdTipoPersona == PersonaTipos::PersonaFisica)
		{
			$oPdf->Text($OffsetX + 4.5, $OffsetY + 19.7 + 0.2, date("d", strtotime($oCliente->FechaNacimiento)));
			$oPdf->Text($OffsetX + 5.2, $OffsetY + 19.7 + 0.2, date("m", strtotime($oCliente->FechaNacimiento)));
			$oPdf->Text($OffsetX + 6, $OffsetY + 19.7 + 0.2, substr(date("Y", strtotime($oCliente->FechaNacimiento)), 2, 2));
			if ($oCliente->IdEstadoCivil == EstadoCivil::Soltero)
				$oPdf->Text($OffsetX + 7.3, $OffsetY + 19.7 + 0.2, 'X');
			elseif ($oCliente->IdEstadoCivil == EstadoCivil::Casado)
				$oPdf->Text($OffsetX + 8.3, $OffsetY + 19.7 + 0.2, 'X');
			elseif ($oCliente->IdEstadoCivil == EstadoCivil::Viudo)
				$oPdf->Text($OffsetX + 9.3, $OffsetY + 19.7 + 0.2, 'X');
			elseif ($oCliente->IdEstadoCivil == EstadoCivil::Divorciado)
				$oPdf->Text($OffsetX + 10.3, $OffsetY + 19.7 + 0.2, 'X');
			$oPdf->Text($OffsetX + 11.3, $OffsetY + 19.7 + 0.2, $oCliente->Nupcia);
			$oPdf->Text($OffsetX + 4.5, $OffsetY + 20.9 + 0.2, $oCliente->ConyugeApellido . ' ' . $oCliente->ConyugeNombre);
		}
	}
	...
	if (($oGestoria->PorcentajeTitularidad) < 100 && ($oGestoria->IdClienteCondominio != ''))
	{
		$OffsetY -= 1;
		$OffsetY += 0.3;
		$oPdf->Text($OffsetX + 12.7, $OffsetY + 7.7, number_format((100 - $oGestoria->PorcentajeTitularidad), 2));
		$oPdf->Text($OffsetX + 12.7, $OffsetY + 8.3, $oClienteCondominio->RazonSocial);
		$oPdf->Text($OffsetX + 12.7, $OffsetY + 8.9, $NacionalidadCondominio);
		$oPdf->Text($OffsetX + 14.2, $OffsetY + 9.5, $EmailCondominio);
		$oPdf->Text($OffsetX + 14.2, $OffsetY + 10.0, $oClienteCondominio->TelefonoCodigoArea . '-' . $oClienteCondominio->Telefono);
		$oPdf->Text($OffsetX + 12.7, $OffsetY + 10.6, $oClienteCondominio->DomicilioCalle);
		$oPdf->Text($OffsetX + 12.7, $OffsetY + 11.4, $oClienteCondominio->DomicilioNumero);
		$oPdf->Text($OffsetX + 15.2, $OffsetY + 11.4, $oClienteCondominio->DomicilioPiso);
		$oPdf->Text($OffsetX + 16.7, $OffsetY + 11.4, $oClienteCondominio->DomicilioDpto);
		if ($oClienteCondominio->DomicilioCodigoPostal)
			$oPdf->Text($OffsetX + 18.4, $OffsetY + 11.4, $oClienteCondominio->DomicilioCodigoPostal);
		else
			$oPdf->Text($OffsetX + 18.4, $OffsetY + 11.4, $oLocalidadCondominio->CodigoPostal);
			
		$OffsetY -= 0.3;
		$oPdf->Text($OffsetX + 12.7, $OffsetY + 12.1, $oLocalidadCondominio->Nombre);
		$oPdf->Text($OffsetX + 12.7, $OffsetY + 12.8, $oPartidoCondominio->Nombre);
		$oPdf->Text($OffsetX + 17.2, $OffsetY + 12.8, $oProvinciaCondominio->Nombre);
		$oPdf->Text($OffsetX + 12.7, $OffsetY + 13.6, $oClienteCondominio->DomicilioCallePostal ? $oClienteCondominio->DomicilioCallePostal : $oClienteCondominio->DomicilioCalle);
		$oPdf->Text($OffsetX + 12.7, $OffsetY + 14.4, $oClienteCondominio->DomicilioNumeroPostal ? $oClienteCondominio->DomicilioNumeroPostal : $oClienteCondominio->DomicilioNumero);
		$oPdf->Text($OffsetX + 15.2, $OffsetY + 14.4, $oClienteCondominio->DomicilioPisoPostal ? $oClienteCondominio->DomicilioPisoPostal : $oClienteCondominio->DomicilioPiso);
		$oPdf->Text($OffsetX + 16.7, $OffsetY + 14.4, $oClienteCondominio->DomicilioDptoPostal ? $oClienteCondominio->DomicilioDptoPostal : $oClienteCondominio->DomicilioDpto);
		if ($oClienteCondominio->DomicilioCodigoPostalPostal)
			$oPdf->Text($OffsetX + 18.4, $OffsetY + 14.4, $oClienteCondominio->DomicilioCodigoPostalPostal);
		else
			$oPdf->Text($OffsetX + 18.4, $OffsetY + 14.4, $oLocalidadPostalCondominio->CodigoPostal);
		$oPdf->Text($OffsetX + 12.7, $OffsetY + 15.1, $oLocalidadPostalCondominio->Nombre);
		$oPdf->Text($OffsetX + 12.7, $OffsetY + 15.8, $oPartidoPostalCondominio->Nombre);
		$oPdf->Text($OffsetX + 17.2, $OffsetY + 15.8, $oProvinciaPostalCondominio->Nombre);
		...
		if ($oClienteCondominio->IdTipoPersona == PersonaTipos::PersonaFisica)
		{
			...
			if ($oNacionalidadCondominio->Current)
			{
				if ($oClienteCondominio->DocumentoTipo == TipoDocumento::DNI)
					$oPdf->Text($OffsetX + 13, $OffsetY + $lineaDNI, 'X');
				if ($oClienteCondominio->DocumentoTipo == TipoDocumento::LE)
					$oPdf->Text($OffsetX + 14.1, $OffsetY + $lineaDNI, 'X');
				if ($oClienteCondominio->DocumentoTipo == TipoDocumento::LC)
					$oPdf->Text($OffsetX + 15.2, $OffsetY + $lineaDNI, 'X');
			}
			else
			{
				if ($oClienteCondominio->DocumentoTipo == TipoDocumento::DNI)
					$oPdf->Text($OffsetX + 16.8, $OffsetY + $lineaDNI, 'X');
				if ($oClienteCondominio->DocumentoTipo == TipoDocumento::CI)
					$oPdf->Text($OffsetX + 17.9, $OffsetY + $lineaDNI, 'X');
				if ($oClienteCondominio->DocumentoTipo == TipoDocumento::PA)
					$oPdf->Text($OffsetX + 19, $OffsetY + $lineaDNI, 'X');
			}
			$lineaNDNI = 17.2 + 0.1;
			$oPdf->Text($OffsetX + 12.7, $OffsetY + $lineaNDNI, $oClienteCondominio->DocumentoNumero);
			$oPdf->Text($OffsetX + 15.7, $OffsetY + $lineaNDNI, $oClienteCondominio->DocumentoExpedido);
			$lineaCUIT = 17.9 + 0.1;
			$oPdf->Text($OffsetX + 15.2, $OffsetY + $lineaCUIT, ClaveFiscalTipos::GetById($oClienteCondominio->ClaveFiscalTipo) . ': ' . $oClienteCondominio->ClaveFiscalNumero);
			$oPdf->Text($OffsetX + 15.2, $OffsetY + 18.6, $LocalidadNacimientoCondominio);
			$lineaFN = 19.7 + 0.2;
			$oPdf->Text($OffsetX + 12.6, $OffsetY + $lineaFN, date("d", strtotime($oClienteCondominio->FechaNacimiento)));
			$oPdf->Text($OffsetX + 13.5, $OffsetY + $lineaFN, date("m", strtotime($oClienteCondominio->FechaNacimiento)));
			$oPdf->Text($OffsetX + 14.3, $OffsetY + $lineaFN, substr(date("Y", strtotime($oClienteCondominio->FechaNacimiento)), 2, 2));
			
			$lineaEC = 19.7 + 0.2;
			if ($oClienteCondominio->IdEstadoCivil == EstadoCivil::Soltero)
				$oPdf->Text($OffsetX + 15.3, $OffsetY + $lineaEC, 'X');
			elseif ($oClienteCondominio->IdEstadoCivil == EstadoCivil::Casado)
				$oPdf->Text($OffsetX + 16.3, $OffsetY + $lineaEC, 'X');
			elseif ($oClienteCondominio->IdEstadoCivil == EstadoCivil::Viudo)
				$oPdf->Text($OffsetX + 17.3, $OffsetY + $lineaEC, 'X');
			elseif ($oClienteCondominio->IdEstadoCivil == EstadoCivil::Divorciado)
				$oPdf->Text($OffsetX + 18.3, $OffsetY + $lineaEC, 'X');
			$oPdf->Text($OffsetX + 19.4, $OffsetY + $lineaEC, $oClienteCondominio->Nupcia);
			$oPdf->Text($OffsetX + 12.7, $OffsetY + 20.9 + 0.2, $oClienteCondominio->ConyugeApellido . ' ' . $oClienteCondominio->ConyugeNombre);
		}
	...
	$oPdf->Text($OffsetX + 7, $OffsetY + 26 + 0.1, $oGestoria->NumeroCertificado);
	$oPdf->Text($OffsetX + 6, $OffsetY + 26.5 + 0.1, $oMarcaVehiculo->Nombre);
	$oPdf->Text($OffsetX + 6, $OffsetY + 27 + 0.1, $oTipoModelo->Nombre);
	$oPdf->Text($OffsetX + 6, $OffsetY + 27.7 + 0.1, $oModelo->DenominacionModelo);
	$oPdf->Text($OffsetX + 14.5, $OffsetY + 25.3 + 0.1, $oMarcaMotor->Nombre);
	$oPdf->Text($OffsetX + 14.5, $OffsetY + 25.9 + 0.1, $oUnidad->NumeroMotor);
	$oPdf->Text($OffsetX + 14.5, $OffsetY + 26.5 + 0.1, $oMarcaChasis->Nombre);
	$oPdf->Text($OffsetX + 15, $OffsetY + 26.9 + 0.2, $oUnidad->NumeroChasis);
	$oPdf->Text($OffsetX + 14, $OffsetY + 27.6 + 0.1, UsoTipos::GetById($oGestoria->IdTipoUso));
	$oPdf->Text($OffsetX + 5.5, $OffsetY + 28.5 + 0.2, number_format($oFacturaUnidad->Total));
	$oPdf->Text($OffsetX + 9.9, $OffsetY + 28.5 + 0.2, date("d", strtotime($oFacturaUnidad->Fecha)));
	$oPdf->Text($OffsetX + 10.8, $OffsetY + 28.5 + 0.2, date("m", strtotime($oFacturaUnidad->Fecha)));
	$oPdf->Text($OffsetX + 11.6, $OffsetY + 28.5 + 0.2, substr(date("Y", strtotime($oFacturaUnidad->Fecha)), 2, 2));
	$oPdf->Text($OffsetX + 13, $OffsetY + 28.5 + 0.1, $Comprobante . ' ' . $oDatosEmpresa->RazonSocial);
}
$oPdf->AutoPrint(true);
