...
if ($Submit)
{
	...
	if ($err == 0)
	{
		...
		$oArticulo = $Articulos->Update($oArticulo);
...
{		
	...
	$PrecioCompra 	= $oArticulo->PrecioCompra;
	$PrecioLista	= $oArticulo->PrecioLista;
	$PrecioOferta 	= $oArticulo->PrecioOferta;		
	$PrecioTerceros	= $oArticulo->PrecioTerceros;
	$IdProveedor 	= $oArticulo->IdProveedor;
	$UnidadVenta 	= $oArticulo->UnidadVenta;
	$DescCod 		= $oArticulo->DescCod;
	$CodDes 		= $oArticulo->CodDes;
	$StockMaximo 	= $oArticulo->StockMaximo;
	$StockMinimo	= $oArticulo->StockMinimo;
	$IdIva			= $oArticulo->IdIva;
	$Utilidad 		= $oArticulo->Utilidad;
	$ClasePieza 	= $oArticulo->ClasePieza;
}
    	...
    	<td>
			<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
      			<tr>
        			...
        			<td height="40"><span class="tituloPagina">Modificar Repuesto </span></td>
   			  </tr>
    		</table>
		</td>
  	</tr>
            			...
            			<td class="bordeGris">
							<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0">
								...
								<tr>
									...
									<td>
										<div align="left">
											<input type="text" name="Codigo" id="Codigo" class="camporFormularioMediano" value="<?=$Codigo?>" readonly="true" />
                           ...
                           <?php } ?>
                                ...
                                <tr>
									<td><div align="right">Precio Sugerido (c/IVA):</div></td>
									<td>
										<div align="left">
                                ...
                                <tr>
                                	<td>&nbsp;</td>
                                    <td><li style="color:#FF0000;">Ingrese el precio sugerido del art&iacute;culo.</li></td>
                                </tr>
								<?php } ?><?php /*
								<tr>
