...
$Paginado	= Pageable::PrintPaginator($oPage, $oTiposCarroceria->GetCountRows($filter), true);
$arrData 	= $oTiposCarroceria->GetAll($filter, $oPage);
            ...
            <td>
                <table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
                    <tr>
                        ...
                        <td height="40"><span class="tituloPagina">Tipos de Carroceria</span></td>
                    </tr>
                </table>
            </td>
        </tr>
            ...
            <td height="30" valign="top">
                <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                    ...
                    <?php if (Session::CheckPerm(PERM_MARC_CREATE)){ ?>
                        ...
                        <td height="40"><a href="tiposcarroceria_add.php<?=$strParams?>">Agregar</a></td>
                    <?php } ?>
                        <td width="10">&nbsp;</td>
                    </tr>
                </table>
            ...
            <td>
                <table width="100%" align="center" cellpadding="0" cellspacing="0" class="bordeGris">
                	<tr class="bordeGrisFondo">
                  		...
                  		<td width="195" height="25" class="bordeGrisTitulo"><div><div align="left"><strong>Tipos de Carroceria</strong></div></div></td>
                  		<td width="92" height="25" class="bordeGrisTitulo"><div align="center"><strong>Acciones</strong></div></td>
                	</tr>
          
                <?php foreach ($arrData as $oTipoCarroceria) { ?>      
                
                    <tr onMouseOver="bgColor='#f3f3f3'" onMouseOut="bgColor=''">
                      	<td width="307" valign="middle"><div id="margen"><?=$oTipoCarroceria->Codigo?></a></div></td>				  
                    	<td width="195" valign="middle"><div align="left"><?=$oTipoCarroceria->Nombre?></div>
                      	<td width="92" valign="middle">
                        	<div align="center">
							<?php if (Session::CheckPerm(PERM_MARC_UPDATE)){ ?>
                                <a href="tiposcarroceria_mod.php<?=$strParams?>&IdTipoCarroceria=<?=$oTipoCarroceria->IdTipoCarroceria?>">
                                    <img src="images/iconos/mod.gif" alt="Modificar" border="0" /></a> - 
                            <?php } ?>
                            <?php if (Session::CheckPerm(PERM_MARC_DELETE)){ ?>
                                <a href="tiposcarroceria_del.php<?=$strParams?>&IdTipoCarroceria=<?=$oTipoCarroceria->IdTipoCarroceria?>">
