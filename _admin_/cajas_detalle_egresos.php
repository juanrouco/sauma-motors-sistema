            ...
            <td>
                <table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
                    <tr>
                        ...
                        <td height="40"><span class="tituloPagina">Caja <?= $oCajaDetalle->Nombre ?> - Detalle Egresos</span></td>
                    </tr>
                </table>
            </td>
        </tr>
            ...
            <td>
                ...
                <table width="100%" align="center" cellpadding="0" cellspacing="0" class="bordeGris">
                    <tr class="bordeGrisFondo">
                        ...
                        <td width="20%" height="25" class="bordeGrisTitulo"><div id="margen"><strong>Comentarios</strong></div></td>
                        <td width="20%" height="25" class="bordeGrisTitulo"><div id="margen" align="center"><strong>Total</strong></div></td>
                        <td width="20%" class="bordeGrisTitulo"><div align="center"><strong>Acciones</strong></div></td>
                    </tr>
