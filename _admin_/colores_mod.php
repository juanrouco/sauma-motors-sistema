...
if (!Session::CheckPerm(PERM_COLO_UPDATE))
	Session::NoPerm();
...
{
	$Codigo = $oColor->Codigo;
	$Nombre = $oColor->Nombre;
}
    	...
    	<td>
			<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
      			<tr>
        			...
        			<td height="40"><span class="tituloPagina">Administraci&oacute;n de Colores - Modificar</span></td>
      			</tr>
    		</table>
		</td>
  	</tr>
			  		...
			  		<tr>
						<td class="bordeGris">
							<table  border="0" align="center" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td height="20">&nbsp;</td>
                                    <td height="20" align="left"><?php if ($err & 1) { ?><li style="color:#FF0000;">Ingrese el c&oacute;digo del color</li><?php } ?></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td height="20">&nbsp;</td>
                                    <td height="20" align="left"><?php if ($err & 2) { ?><li style="color:#FF0000;">Ingrese el nombre del color</li><?php } ?><?php if ($err & 4) { ?><li style="color:#FF0000;">Ya existe registrado el nombre del color</li><?php } ?></td>
                                </tr>
							</table>						
          				</td>
					</tr>
