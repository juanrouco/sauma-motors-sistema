					...
					<tr>
						<td class="bordeGris">
							<table  border="0" align="center" cellpadding="0" cellspacing="0">
								...
								<tr>
									<td><div align="center" class="campoEliminar">Pago de $<?=number_format($oPago->Importe, 2, ',', '.')?> al usado <?= $oPago->IdMinutaUsado ?></div></td>
								</tr>
								<tr>
									<td>&nbsp;</td>
								</tr>
						...
						<tr>
						  	<td height="30">
								<div align="center">
									...
									<input type="button" name="btnCancelar" class="botonBasico" id="btnCancelar" value="Cancelar" onClick="javascript: window.location.href = 'pagosusados.php<?=$strParams?>';">
								</div>
							</td>
						</tr>
					</form>
