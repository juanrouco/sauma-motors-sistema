...
if (!Session::CheckPerm(PERM_CATM_CREATE))
	Session::NoPerm();
...
if ($Submit)
{
	...
	if ($Nombre == '')
		$err |= 2;
	elseif ($oCategoriasModelo->GetByNombre($Nombre)->Nombre == $Nombre)
		$err |= 4;
	...
	if ($err == 0)
	{
		...
		$oCategoriaModelo = $oCategoriasModelo->Create($oCategoriaModelo);
    	...
    	<td>
			<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
      			<tr>
        			...
        			<td height="40"><span class="tituloPagina">Adminsitraci&oacute;n de Categor&iacute;as de Modelos - Agregar</span></td>
      			</tr>
    		</table>
		</td>
  	</tr>
...
window.opener.FilterCategoriaModelo('<?=$oCategoriaModelo->IdCategoriaModelo?>', '');
window.close();
</script>
<?php } ?>
