...
if (!Session::CheckPerm(PERM_PEDREP_UPDATE))
	Session::NoPerm();
    	...
    	<td>
			<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
      			<tr>
        			...
        			<td height="40"><span class="tituloPagina">MODIFICAR PEDIDO DE REPUESTOS</span></td>
      			</tr>
    		</table>
		</td>
  	</tr>
										...
										<td colspan="6">
											<table id="articulos" class="bordeGris" border="0" align="center" cellpadding="0" cellspacing="0" width="95%">
												...
												<tr id="row_<?= $oPedidoRepuestoDetalle->IdArticulo ?>" onMouseOver="bgColor='#f3f3f3'" onMouseOut="bgColor=''">
													...
													<td height="25">
														<input type="text" id="cantidad_<?= $oPedidoRepuestoDetalle->IdArticulo ?>" name="cantidad_<?= $oPedidoRepuestoDetalle->IdArticulo ?>" value="<?= $oPedidoRepuestoDetalle->Cantidad ?>" style="width:75px" />
													...
													<td height="25">
														$<input type="text" id="precio_<?= $oPedidoRepuestoDetalle->IdArticulo ?>" name="precio_<?= $oPedidoRepuestoDetalle->IdArticulo ?>" value="<?= $oPedidoRepuestoDetalle->Precio ?>" style="width:75px" />
													</td>
													<td height="25"><?= $oArticuloStock->StockActual > 0 ? 'SI' : 'NO' ?></td>
													<td height="25">
														<select id="cargo_<?= $oPedidoRepuestoDetalle->IdArticulo ?>" name="cargo_<?= $oPedidoRepuestoDetalle->IdArticulo ?>" style="width:75px" >
														<?php
														foreach (TipoVenta::GetAllPedidosRepuestos() as $oTipoVenta)
														{
															$selected = '' ;
													...
													<td height="25">&nbsp;</td>
													<td height="25">
														<a href="javascript:QuitarArticulo(<?= $oPedidoRepuestoDetalle->IdArticulo ?>)">
															<img src="images/iconos/del.gif" alt="Quitar" /></a>
													</td>
												</tr>
												<?php
												}
