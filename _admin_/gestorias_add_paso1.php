...
if ($Submit)
{
	GestoriaCreate::$IdMinuta 		= $_REQUEST['IdMinuta'];
	GestoriaCreate::$FechaGestion 	= CambiarFecha($_REQUEST['FechaGestion']);
	...
	switch ($Action)
	{
		case 'Next':
			...
			if ((GestoriaCreate::$IdMinuta == '') || (!$oMinutas->GetById(GestoriaCreate::$IdMinuta)))
				$err |= 1;
			if (GestoriaCreate::$FechaGestion == '')
				$err |= 2;

			/* si no hay errores. */			
			if ($err == 0)
			{
				/* obtenemos los datos de la minuta */
				$oMinuta = $oMinutas->GetById(GestoriaCreate::$IdMinuta);
				...
				/* seteamos algunos valores por defecto */
				if (GestoriaCreate::$DomicilioFiscalCalle == '')
					GestoriaCreate::$DomicilioFiscalCalle = $oCliente->DomicilioCalle;
				if (GestoriaCreate::$DomicilioFiscalNumero == '')
					GestoriaCreate::$DomicilioFiscalNumero = $oCliente->DomicilioNumero;
				if (GestoriaCreate::$DomicilioFiscalPiso == '')
					GestoriaCreate::$DomicilioFiscalPiso = $oCliente->DomicilioPiso;
				if (GestoriaCreate::$DomicilioFiscalDpto == '')
					GestoriaCreate::$DomicilioFiscalDpto = $oCliente->DomicilioDpto;
				if (GestoriaCreate::$DomicilioFiscalIdLocalidad == '')
					GestoriaCreate::$DomicilioFiscalIdLocalidad = $oCliente->DomicilioIdLocalidad;
				if (GestoriaCreate::$DomicilioFiscalLocalidad == '')
					GestoriaCreate::$DomicilioFiscalLocalidad = $oLocalidad->Nombre;
				if (GestoriaCreate::$DomicilioFiscalCodigoPostal == '')
					GestoriaCreate::$DomicilioFiscalCodigoPostal = $oLocalidad->CodigoPostal;
				
				header("Location: gestorias_add_paso2.php" . $strParams);
				exit;
			}
...
{
	var Url = 'minutas.php?MainAction=Select&Target=Formulario';
    	...
    	<td>
			<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
      			<tr>
        			...
        			<td height="40"><span class="tituloPagina">Administraci&oacute;n de Gestor&iacute;as - Agregar - Paso 1</span></td>
      			</tr>
    		</table>
		</td>
  	</tr>
				...
				<form name="frmData" id="frmData" method="post" action="<?=$strParams?>">
                                        ...
                                        <td>
                                            <table border="0" align="center" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div align="left">
                                                            <input type="text" name="IdMinuta" id="IdMinuta" class="camporFormularioChico" maxlength="10" onblur="javascript: SetMinuta(this.value);" onKeyPress="javascript: if (event.keyCode &lt; 45 || event.keyCode &gt; 57) event.returnValue = false;" value="<?=GestoriaCreate::$IdMinuta?>" />
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div align="left">
                                                            <input name="FechaGestion" type="text" class="camporFormularioChico" id="FechaGestion" value="<?=GestoriaCreate::$FechaGestion?>" size="12" maxlength="12" />
                                                            <script language="javascript">
                                                            new tcal({'formname': 'frmData', 'controlname': 'FechaGestion'});
                                                            </script>
                                                        </div>
                                                    </td>
                                                    <td></td>
                                                ...
                                                <tr>
                                                	<td>&nbsp;</td>
                                                	<td colspan="2"><?php if ($err & 2) { ?><li style="color:#FF0000;">Ingrese la fecha</li><?php } ?></td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
                                                    ...
                                                    <tr>
                                                    	<td valign="top">
                                                            <table width="100%" border="0" align="left" cellpadding="3" cellspacing="3">
                                                                ...
                                                                <tr>
                                                                    <td height="30" valign="middle" colspan="3"><div id="margen" align="left"><a href="#" class="linkMenu" onclick="javascript:ModCliente('IdCliente');">Modificar datos del Cliente</a></div></td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                                    </tr>                                                     
					...
					<table width="90%"  border="0" align="center" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
						<tr>
							<td height="30">
								<div align="center">
									<input type="button" name="btnCancelar" class="botonBasico" id="btnCancelar" value="Cancelar" onclick="javascript: Cancel();" />
...
<?php if ($IdMinuta != '') { ?>
SetMinuta('<?=$IdMinuta?>');
<?php } elseif (GestoriaCreate::$IdMinuta != '') { ?>
SetMinuta('<?=GestoriaCreate::$IdMinuta?>');
<?php } ?>
</script>
