...
if (!Session::CheckPerm(PERM_CPRE_CREATE))
	Session::NoPerm();
...
if ($Submit)
{
	...
	if ($err == 0)
	{
		...
		$create = false;
		if (!$oContratoPrenda = $oContratosPrendas->GetByIdMinuta($IdMinuta))
		{
			$create = true;
		...
		if ($create)
			$oContratosPrendas->Create($oContratoPrenda);
		else
    	...
    	<td>
			<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
      			<tr>
        			...
        			<td height="40"><span class="tituloPagina">Administraci&oacute;n de Contratos de Prenda - Agregar Lote de Contratos</span></td>
      			</tr>
    		</table>
		</td>
  	</tr>
