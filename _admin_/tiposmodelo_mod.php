...
if (!Session::CheckPerm(PERM_TIPM_UPDATE))
	Session::NoPerm();
...
if ($Submit)
{
	...
	if ($Nombre == '')
		$err |= 2;
	elseif (($oTipoModelo->Nombre != $Nombre) && ($oTiposModelo->GetByNombre($Nombre)))
		$err |= 4;
		
	/* si no hay ningun error... */	
	if ($err == 0)
	{
		$oTipoModelo->Codigo = $Codigo;
		$oTipoModelo->Nombre = $Nombre;
		
		$oTipoModelo = $oTiposModelo->Update($oTipoModelo);
...
{
	$Codigo = $oTipoModelo->Codigo;
	$Nombre = $oTipoModelo->Nombre;
}
    	...
    	<td>
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
      			<tr>
        			...
        			<td height="40"><span class="tituloPagina">Administraci&oacute;n de Tipos de Modelos - Modificar</span></td>
      			</tr>
    		</table>
		</td>
  	</tr>
                        ...
                        <tr>
                            <td height="30">
                                <div align="center">
                                    ...
                                    <input type="button" name="btnCancelar" class="botonBasico" id="btnCancelar" onclick="javascript: window.location.href = 'tiposmodelo.php<?=$strParams?>';" value="Cancelar" />
                                </div>
                            </td>
                        </tr>
                    </table>
