...
$oMarcas						= new Marcas();
$oOrdenesTrabajo				= new OrdenesTrabajo();
$oOrdenesTrabajoArticulos		= new OrdenesTrabajoTareasArticulos();
			...
			<div align="center">				
				<table width="100%" border="0" align="center" cellpadding="5" cellspacing="0">
								...
								<tr>
	                                <td align="center" colspan="2" width="100%">
										<table width="100%" border="0" cellpadding="0" cellspacing="0">
											<tr>
												<td align="center">
													<div align="center"><span style="text-align:center" class="texto20">Ordenes de Trabajo de la Fecha <?= $FechaInicioDesde ? $FechaInicioDesde : date('d/m/Y') ?></span></div>
												</td>
											</tr>
										</table>
									</td>
                    ...
                    <tr>
                    	...
                    	<td align="left" width="75%" style="border-top: 1px solid #000; border-bottom: 1px solid #000"><div align="left"><strong>Operaciones</strong></div></td>
                    </tr>
					<?php
                    ...
                    <tr>
                    	...
                    	<td align="left" valign="top" width="75%" style="border-bottom: 1px solid #000">
							<table width="100%" border="0" cellpadding="0" cellspacing="0">
								<tr>
									<td colspan="2"><div align="left">Modelo: <?= utf8_encode($oTallerUnidad->Modelo) ?></div></td>
								</tr>
								<tr>
								...
								if ($arrOrdenesTrabajoTareas)
								{
									...
									{
										$arrArticulos = $oOrdenTrabajoTarea->GetAllArticulos();
								?>
								<tr>
								...
								<tr>
									<td colspan="2" valign="top"><div align="left">&nbsp;&nbsp;Repuestos:</div></td>
								</tr>
								<tr>
									<td colspan="2">
										<div align="right">
								...
								<?php
										if ($arrArticulos)
										{
											foreach ($arrArticulos as $oArticuloRelacionado)
											{
												$oArticulo = $oArticulos->GetById($oArticuloRelacionado->IdArticulo);
								?>
												<tr>
													<td>- <?= $oArticulo->Codigo ?> x <?= $oArticuloRelacionado->Cantidad ?></td>
												</tr>
								<?php
											}
										}
...
$oMpdf->Output('Ordenes de Trabajo ' . date('d-m-Y') . '.pdf', 'D'); 
