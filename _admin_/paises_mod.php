...
if (!Session::CheckPerm(PERM_PAIS_UPDATE))
	Session::NoPerm();
...
if ($Submit)
{
	...
	if ($Nombre == '')
		$err |= 2;
	if (($Nombre != $oPais->Nombre) && ($oPaises->GetByNombre($Nombre)))
		$err |= 4;
    	...
    	<td>
			<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
      			<tr>
        			...
        			<td height="40"><span class="tituloPagina">Administraci&oacute;n de Pa&iacute;ses - Modificar</span></td>
      			</tr>
    		</table>
		</td>
  	</tr>
						...
						<tr>
							<td height="30">
								<div align="center">
									...
									<input type="button" name="btnCancelar" class="botonBasico" id="btnCancelar" onclick="javascript: window.location.href = 'paises.php<?=$strParams?>';" value="Cancelar" />
								</div>
							</td>
						</tr>
					</table>
