...
if ($Submit)
{
	...
	switch ($Action)
	{
		...
		case 'Back':
			...
			header("Location: gestorias_add_paso2.php");
			exit;
...
function AddFiador()
{
	...
	frmData.action = 'gestorias_add_paso3.php#Fiadores';
	frmData.submit();
	return true;
}
    	...
    	<td>
			<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
      			<tr>
        			...
        			<td height="40"><span class="tituloPagina">Administraci&oacute;n de Gestor&iacute;as - Agregar - Paso 3</span></td>
      			</tr>
    		</table>
		</td>
  	</tr>
