...
if ($Submit)
{
	...
	if ($Nombre == '')
		$err |= 2;
	elseif (($oTipoUso->Nombre != $Nombre) && ($oTiposUso->GetByNombre($Nombre)))
		$err |= 4;
			
	/* si no hay ningun error... */	
	if ($err == 0)
	{
		$oTipoUso->Codigo = $Codigo;
		$oTipoUso->Nombre = $Nombre;
		
		$oTipoUso = $oTiposUso->Update($oTipoUso);
...
{
	$Codigo = $oTipoUso->Codigo;
	$Nombre = $oTipoUso->Nombre;
}
    	...
    	<td>
			<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
      			<tr>
        			...
        			<td height="40"><span class="tituloPagina">Administraci&oacute;n de Tipos de Uso - Modificar</span></td>
      			</tr>
    		</table>
		</td>
  	</tr>
					...
					<tr>
						<td height="30">
							<div align="center">
								...
								<input type="button" name="btnCancelar" class="botonBasico" id="btnCancelar" onclick="javascript: window.location.href = 'tiposuso.php<?=$strParams?>';" value="Cancelar" />
							</div>
						</td>
					</tr>
				</table>
