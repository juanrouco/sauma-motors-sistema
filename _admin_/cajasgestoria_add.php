...
if (!Session::CheckPerm(PERM_CAJGES_CREATE))
	Session::NoPerm();
...
if ($Submit)
{
	...
	if ($err == 0)
	{
		...
		if ($oCajaGestoria->IdTipoMovimiento == TiposMovimientosCaja::Egreso)
			$Monto *= -1;
		...
		$oCajaGestoria = $oCajasGestoria->Create($oCajaGestoria);
    	...
    	<td>
			<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
      			<tr>
        			...
        			<td height="40"><span class="tituloPagina">Administraci&oacute;n de Caja Gestor&iacute;a - Agregar</span></td>
      			</tr>
    		</table>
		</td>
  	</tr>
