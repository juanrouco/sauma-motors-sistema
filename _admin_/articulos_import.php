...
if ($Submit)
{
	...
	if ($err == 0)
	{
		...
		if ($oUpload->UploadFile())
		{
			...
			$Mensaje = $oArticulos->Import($oUpload->GetNombre());

			/* eliminamos el archivo almacenado en el servidor */
			Up::DeleteFile(Articulos::PathImport, $oUpload->GetNombre());
		}
	}
}
    	...
    	<td>
			<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
      			<tr>
        			...
        			<td height="40"><span class="tituloPagina">Importar Repuestos</span></td>
   			  </tr>
    		</table>
		</td>
  	</tr>
  					...
  					<tr>
            			<td height="30">
              				<div align="center">
                				...
                				<input type="button" name="btnCancelar" class="botonBasico" id="btnCancelar" onclick="javascript: window.location.href = 'articulos.php<?=$strParams?>';" value="Cancelar" />
                			</div>
						</td>
            		</tr>
        		</table>
				...
				<table width="60%"  border="0" align="center" cellpadding="0" cellspacing="0">
  				...
  				<table width="60%" border="0" align="center" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
  					<tr>
            			<td height="30">
              				<div align="center">
                				<input type="button" name="btnAceptar" class="botonBasico" id="btnAceptar" onclick="javascript: window.location.href = 'articulos.php<?=$strParams?>';" value="Aceptar" />
                			</div>
						</td>
            		</tr>
        		</table>
