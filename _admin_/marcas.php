...
$Paginado	= Pageable::PrintPaginator($oPage, $oMarcas->GetCountRows($filter), true);
$arrData 	= $oMarcas->GetAll($filter, $oPage);
...
function UpdateMarca(IdMarca, Checked)
{
	var obj;
	var arr 	= new Array();
	var Activo	= Get('Activo_' + IdMarca);
	
	arr['IdMarca'] 	= IdMarca;
	arr['IdEstado'] = (Activo.checked) ? '<?=Estados::Activo?>' : '<?=Estados::Inactivo?>';

	obj = SendXMLRequest('Marcas', 'Update', null, arr);
	if (obj.Status.Id != 0)
	{
            ...
            <td>
                <table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
                    <tr>
                        ...
                        <td height="40"><span class="tituloPagina">Marcas</span></td>
                    </tr>
                </table>
            </td>
        </tr>
            ...
            <td height="30" valign="top">
                <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                    ...
                    <?php if (Session::CheckPerm(PERM_MARC_CREATE)){ ?>
                        ...
                        <td height="40"><a href="marcas_add.php<?=$strParams?>">Agregar</a></td>
                    <?php } ?>
                        <td width="10">&nbsp;</td>
                    </tr>
                </table>
            ...
            <td>
                <table width="100%" align="center" cellpadding="0" cellspacing="0" class="bordeGris">
                	<tr class="bordeGrisFondo">
                  		...
                  		<td width="195" height="25" class="bordeGrisTitulo"><div><div align="left"><strong>Marca</strong></div></div></td>
                  		<td width="92" height="25" class="bordeGrisTitulo"><div align="center"><strong>Acciones</strong></div></td>
                	</tr>
          
                <?php foreach ($arrData as $oMarca) { ?>      
                
                    <tr onMouseOver="bgColor='#f3f3f3'" onMouseOut="bgColor=''">
                      	<td width="307" height="25" valign="middle"><div id="margen"><?=$oMarca->Codigo?></a></div></td>				  
                    	<td width="195" valign="middle"><div align="left"><?=$oMarca->Nombre?></div>
                      	<td width="92" valign="middle">
                        	<div align="center">
							<?php if (Session::CheckPerm(PERM_MARC_UPDATE)){ ?>
                                <a href="marcas_mod.php<?=$strParams?>&IdMarca=<?=$oMarca->IdMarca?>">
                                    <img src="images/iconos/mod.gif" alt="Modificar" border="0" /></a> - 
                            <?php } ?>
                            <?php if (Session::CheckPerm(PERM_MARC_DELETE)){ ?>
                                <a href="marcas_del.php<?=$strParams?>&IdMarca=<?=$oMarca->IdMarca?>">
