...
$NacimientoCodigoPostal			= strval($_REQUEST['NacimientoCodigoPostal']);
...
if ($Submit)
{
	...
	if ($err == 0)
	{
		...
		/* si el estado civil es soltero, anulamos los campos de conyuge */
		if ($IdEstadoCivil == EstadoCivil::Soltero)
		{
			$Nupcia 					= '';
			$ConyugeNombre				= '';
			$ConyugeApellido			= '';
...
else
{
	...
	$NacimientoDomicilioCalle 		= $oCliente->NacimientoDomicilioCalle;
	$NacimientoDomicilioNumero 		= $oCliente->NacimientoDomicilioNumero;
	$NacimientoDomicilioPiso 		= $oCliente->NacimientoDomicilioPiso;
	$NacimientoDomicilioDpto 		= $oCliente->NacimientoDomicilioDpto;
...
function VerificarEstadoCivil(IdEstadoCivil)
{
	...
	if ((IdEstadoCivil != 'SOLTERO') && (IdEstadoCivil != '') && (IdEstadoCivil != '0'))
	{
                                                                    ...
                                                                    <td valign="top">
                                                                        <table border="0" align="center" cellpadding="0" cellspacing="0">
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td height="20"><?php if ($err & 8) { ?><li style="color:#FF0000;">Ingrese el nro. de cuit/cuil</li><?php } ?></td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td>
                                                                                    <table border="0" align="left" cellpadding="0" cellspacing="0">
                                                                                ...
                                                                                <td>
                                                                                    <table border="0" align="left" cellpadding="0" cellspacing="0">
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td>&nbsp;</td>
                                                                                            <td style="display:none;"><input type="button" id="btnAddUsuario" class="botonBasico"  onClick="javascript:AddUsuario();" value=" + " /></td>
                                                                                        </tr>
                                                                                    </table>
                                                                                </td>
                                                                            </tr>
                                                                                ...
                                                                                <td>
                                                                                    <table border="0" align="left" cellpadding="0" cellspacing="0">
                                                                                        ...
                                                                                        <tr>
                                                                                            <td>
                                                                                                <div align="left">
                                                                                                    <input type="text" name="TipoIva" id="TipoIva" class="camporFormularioSuggest" maxlength="128" value="<?=$TipoIva?>" onkeyup="javascript: StrToUpper(this.id);" />
                                                                                                    <script language="javascript">
                                                                                            ...
                                                                                            <td>&nbsp;</td>
                                                                                            <td style="display:none;"><input type="button" id="btnAddTipoIva" class="botonBasico"  onClick="javascript:AddTipoIva();" value=" + " /></td>
                                                                                        </tr>
                                                                                    </table>
                                                                                </td>
                                                                            </tr>
                                                                                ...
                                                                                <td>
                                                                                    <table border="0" align="left" cellpadding="0" cellspacing="0">
                                                                                        ...
                                                                                        <tr>
                                                                                            <td>
                                                                                                <div align="left">
                                                                                                    <input type="text" name="Profesion" id="Profesion" class="camporFormularioSuggest" maxlength="128" value="<?=$Profesion?>" onkeyup="javascript: StrToUpper(this.id);" required />
                                                                                                    <script language="javascript">
                                                                                            ...
                                                                                            <td>&nbsp;</td>
                                                                                            <td style="display:none;"><input type="button" id="btnAddProfesion" class="botonBasico"  onClick="javascript:AddProfesion();" value=" + " /></td>
                                                                                        </tr>
                                                                                    </table>
                                                                                </td>
                                                                            </tr>
                                                                                ...
                                                                                <td>
                                                                                    <table border="0" align="left" cellpadding="0" cellspacing="0">
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td>&nbsp;</td>
                                                                                            <td style="display:none;"><input type="button" id="btnAddEstadoCivil" class="botonBasico"  onClick="javascript:AddEstadoCivil();" value=" + " /></td>
                                                                                        </tr>
                                                                                    </table>
                                                                                </td>
                                                                            </tr>
									...
									<tr>
                                    	<td>
                                        	<div align="center">
                                                <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
                                                    <tr>
                                                        <td height="40" align="center"><span class="tituloPagina">Domicilio</span></td>
                                                    </tr>
                                                </table>
                                           	</div>
                                        </td>
                                                                                ...
                                                                                <td>
                                                                                    <table border="0" align="left" cellpadding="0" cellspacing="0">
                                                                                        ...
                                                                                        <tr>
                                                                                            <td>
                                                                                                <div align="left">
                                                                                                    <input type="text" name="NacimientoLocalidad" id="NacimientoLocalidad" class="camporFormularioSuggest" maxlength="128" value="<?=$NacimientoLocalidad?>" onkeyup="javascript: StrToUpper(this.id);" />
                                                                                                    <script language="javascript">
                                                                                            ...
                                                                                            <td>
                                                                                                <div align="left">
                                                                                                    <input type="text" name="NacimientoCodigoPostal" id="NacimientoCodigoPostal" class="camporFormularioChicoSuggest" maxlength="10" value="<?=$NacimientoCodigoPostal?>" readonly="readonly" />
                                                                                                    
                                                                                                </div>
                                                                                            </td>
                                                                                            <td>&nbsp;</td>
                                                                                            <td style="display:none;"><input type="button" id="btnAddLocalidad" class="botonBasico"  onClick="javascript:AddLocalidad('DomicilioNacimiento');" value=" + " /></td>
                                                                                        </tr>
                                                                                    </table>
                                                                                </td>
                                                                            </tr>
                                                                    ...
                                                                    <td>
                                                                        <table border="0" align="left" cellpadding="0" cellspacing="0">
                                                                            ...
                                                                            <tr>
                                                                                <td>
                                                                                    <div align="left">
                                                                                        <input type="text" name="ConyugeApellido" id="ConyugeApellido" class="camporFormularioSimple" maxlength="12" value="<?=$ConyugeApellido?>" onkeyup="javascript: StrToUpper(this.id);" />
                                                                                 	</div>
                                                                                </td>
                                                                                <td><span style="color:#FF0000;">&nbsp;</span></td>
                                                                            </tr>
                                                                                ...
                                                                                <td>
                                                                                    <table border="0" align="left" cellpadding="0" cellspacing="0">
                                                                                        ...
                                                                                        <tr>
                                                                                            <td>
                                                                                                <div align="left">
                                                                                                    <input type="text" name="ConyugeDocumentoTipoNombre" id="ConyugeDocumentoTipoNombre" class="camporFormularioSuggest" maxlength="128" value="<?=$ConyugeDocumentoTipoNombre?>" onkeyup="javascript: StrToUpper(this.id);" />
                                                                                                    <script language="javascript">
                                                                                            ...
                                                                                            <td>&nbsp;</td>
                                                                                            <td style="display:none;"><input type="button" id="btnAddTipoDocumento" class="botonBasico" onClick="javascript:AddTipoDocumento('DocumentoConyuge');" value=" + " /></td>
                                                                                        </tr>
                                                                                    </table>
                                                                                </td>
                                                                            </tr>
