...
if ($Submit)
{
	...
	{		
		...
		//$oPedidoRepuesto->FechaVencimiento		= $FechaVencimiento;	
...
<script type="text/javascript">
	...
	function FilterOrdenTrabajo(IdOrdenTrabajo, Dominio)
	{
		...
		$j('#btnVerOT').attr('href', 'ordenestrabajo_detail.php?IdOrdenTrabajo=' + oOrdenTrabajo.IdOrdenTrabajo);
		$j('#btnVerOT').show()
	...
	function validar(busqueda)
	{
		...
		if (!busqueda)
		{
			...
			if ($j('#IdOrdenTrabajo').val() == '' || $j('#IdOrdenTrabajo').val() == '0')
			{
    	...
    	<td>
			<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
      			<tr>
        			...
        			<td height="40"><span class="tituloPagina">DETALLES DE PEDIDO DE REPUESTOS</span></td>
      			</tr>
    		</table>
		</td>
  	</tr>
										...
										<td>
											<table width="100%" border="0" cellpadding="0" cellspacing="0">
												...
												<tr>		
													...
													<td>
														 <?=$oUsuarioGenerador->Nombre . ' ' . $oUsuarioGenerador->Apellido?>
												...
												<tr>
													...
													<td>
														<?= CambiarFechaHora($oPedidoRepuesto->FechaAprobado) ?>
													</td>
												</tr>
											</table>
										</td>
											...
											<table width="100%" cellpadding="0" cellspacing="0" border="0">
												<tr>		
													...
													<td>
														...
														<a href="" id="btnVerOT" target="_blank" style="display: none">[Ver OT]</a>
													</td>
												</tr>
												<tr>
										...
										<td colspan="6">
											<table id="articulos" class="bordeGris" border="0" align="center" cellpadding="0" cellspacing="0" width="95%">
												<tr class="bordeGrisFondo">
													...
													<td width="10%" height="25" class="bordeGrisTitulo"><strong>Fecha Pedido</strong></td>
												...
												<tr id="row_<?= $oPedidoRepuestoDetalle->IdArticulo ?>" onMouseOver="bgColor='#f3f3f3'" onMouseOut="bgColor=''">
													...
													<td height="25">
														<?= $oPedidoRepuestoDetalle->Recibido ? '<span color="green">SI</span>':  '<span style="color: red">NO</span>' ?>
													</td>
													<td height="25">
														<?= CambiarFechaHora($oPedidoRepuestoDetalle->FechaPedido) ?>
													</td>
													<td height="25">
														<?= $oPedidoRepuestoDetalle->NumeroSap ?>
													</td>
												</tr>
												<?php
												}
					...
					<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
						<tr>
							<td height="30" align="center">
								<input type="button" name="btnCancelar" class="botonBasico" id="btnCancelar" onclick="javascript: window.location.href = 'pedidosrepuestos_vista.php<?=$strParams?>';" value="Volver" />	
							</td>
						</tr>
					</table>
				</form>
