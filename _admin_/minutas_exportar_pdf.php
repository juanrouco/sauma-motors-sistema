...
<table width="1200" border="1" cellspacing="0" cellpadding="0">
    <tr>
        ...
        <td class="BordeInf BordeDer" align="center" width="90"><div align="center" class="Estilo1"><div align="center">FLETE</div></div></td>
        <td class="BordeInf BordeDer" align="center" width="90"><div align="center" class="Estilo1"><div align="center">CIRCULAR</div></div></td>
    ...
    <tr>
        ...
        <td width="120" align="center" valign="top"><div align="center" class="Estilo2"><?='$ ' . number_format($oMinuta->GastosFlete, 2, ',', '')?></div></td>
        <td width="120" align="center" valign="top"><div align="center" class="Estilo2"><?='$ ' . number_format($oMinuta->Circular, 2, ',', '')?></div></td>
        <td width="120" align="center" valign="top"><div align="center" class="Estilo2"><?='$ ' . number_format($oUnidad->ImporteCompraBruto + $TotalArreglos, 2, ',', '')?></div></td>
