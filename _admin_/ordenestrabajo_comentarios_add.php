    	...
    	<td>
			<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
      			<tr>
        			...
        			<td height="40"><span class="tituloPagina">Administraci&oacute;n de Ordenes de Trabajo - Agregar Comentario a OT N&deg; <?= $IdOrdenTrabajo ?></span></td>
      			</tr>
    		</table>
		</td>
  	</tr>
					...
					<table width="50%"  border="0" align="center" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
						<tr>
							<td height="30">
								...
								<input type="button" name="btnCancelar" class="botonBasico" id="btnCancelar" onclick="javascript: window.location.href = 'ordenestrabajo_taller.php<?=$strParams?>';" value="Cancelar" />
								</div>
							</td>
						</tr>
					</table>
