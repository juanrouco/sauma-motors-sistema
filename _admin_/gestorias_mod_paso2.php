...
if ($Submit)
{
	...
	switch ($Action)
	{
		...
		case 'Back':
			...
			header("Location: gestorias_mod_paso1.php");
			exit;
    	...
    	<td>
			<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
      			<tr>
        			...
        			<td height="40"><span class="tituloPagina">Administraci&oacute;n de Gestor&iacute;as - Modificar - Paso 2</span></td>
      			</tr>
    		</table>
		</td>
  	</tr>
                                        ...
                                        <td>
                                            <table border="0" align="left" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td>
                                                        <div align="left">
                                                            <input type="text" name="DomicilioFiscalLocalidad" id="DomicilioFiscalLocalidad" class="camporFormularioSuggest" maxlength="128" value="<?=GestoriaCreate::$DomicilioFiscalLocalidad?>" onkeyup="javascript: StrToUpper(this.id);" />
                                                            <script language="javascript">
                                                    ...
                                                    <td>
                                                        <div align="left">
                                                            <input type="text" name="DomicilioFiscalCodigoPostal" id="DomicilioFiscalCodigoPostal" class="camporFormularioChicoSuggest" maxlength="10" value="<?=GestoriaCreate::$DomicilioFiscalCodigoPostal?>" readonly="readonly" />
