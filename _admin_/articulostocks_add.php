...
if ($Submit)
{
	...
	{
		$oArticuloRepetido = $ArticuloStocks->GetByArticuloAndUbicacion($IdArticulo, $IdUbicacion);
	...
	if ($err == 0)
	{
		...
		/* crea el proveedor */
		$oArticuloStock = $ArticuloStocks->Create($oArticuloStock);
    	...
    	<td>
			<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
      			<tr>
        			...
        			<td height="40"><span class="tituloPagina"><?= $oArticulo->Descripcion ?> - Agregar Stock </span></td>
   			  </tr>
    		</table>
		</td>
  	</tr>
            			...
            			<td class="bordeGris">
							<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0">
								...
								<tr>
									...
									<td>
										<div align="left">
											<input type="text" name="Sucursal" id="Sucursal" class="camporFormularioSuggest" value="<?=$Sucursal?>" autocomplete="off" />
											<input type="button" id="btnAddUbicacion" class="botonBasico"  onClick="javascript:AddUbicacion();" value=" + " />
											<span style="color:#FF0000;">&nbsp;(*)</span>
											<script language="">												
												SUGGESTRequest('Ubicaciones', 'GetAll', 'Sucursal', 'FilterUbicacion', 'IdUbicacion', 'Nombre', 'FilterNombre', null);
											</script>								
										</div>
									</td>
								</tr>
                           ...
                           <?php } ?>
                                ...
                                <tr>
									...
									<td>
										<div align="left">
											<input type="text" name="StockInicial" id="StockInicial" class="camporFormularioMediano" value="<?=$StockInicial;?>" />
										</div>
									</td>
								</tr>
								<?php if ($err & 4) { ?>
