...
if ($Submit)
{
	...
	if ($err == 0)
	{
		...
		if ($oConceptos->Update($oConcepto))
		{	
...
<table width="90%"  border="0" align="center" cellpadding="0" cellspacing="0" class="bordeGris">
    	...
    	<td>
			<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
      			<tr>
        			...
        			<td height="40"><span class="tituloPagina">Modificar Concepto</span></td>
      			</tr>
    		</table>
		</td>
  	</tr>
  	...
  	<tr>
    	<td>
			<div align="center">
      		<form name="frmData" id="frmData" method="post" action="conceptos_mod.php<?=$strParams?>" enctype="multipart/form-data" >
