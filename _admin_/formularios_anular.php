...
if ($Submit)
{
	...
	$oFormulario->IdEstado 		= FormularioEstados::Anulado;
		...
		<td>
			<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
				<tr>
					...
					<td height="40"><span class="tituloPagina">Administraci&oacute;n de Formularios - Anular <?=$oTipoFormulario->Descripcion?></span></td>
				</tr>
			</table>
		</td>
	</tr>
