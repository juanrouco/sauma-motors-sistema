...
$strParams.= '&FilterInterno=' 			. $filter['Interno'];
$strParams.= '&FilterPago=' 			. $filter['Pago'];
$strParams.= '&Page='				. $Page;
...
function SetPage(PageContacto)
{
	...
	frmData.Page.value = PageContacto;
	frmData.submit();
}
                        ...
                        <td height="40">
                            <table align="right" border="0" cellspacing="0" cellpadding="0">
                                <tr>
									...
									<td width="30"><div align="center"><a href="pagos_listado_exportar.php<?=$strParams?>">Exportar</a></div></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
            ...
            <td>
                <table width="100%" align="center" cellpadding="0" cellspacing="0" class="bordeGris">
                    <tr class="bordeGrisFondo">
                        ...
                        <td width="150" height="25" class="bordeGrisTitulo"><div id="margen" align="left"><strong>Tipo Pago</strong></div></td>
                        <td width="150" height="25" class="bordeGrisTitulo"><div id="margen" align="left"><strong>Cliente</strong></div></td>
                        <td width="150" height="25" class="bordeGrisTitulo"><div id="margen" align="left"><strong>Vendedor</strong></div></td>
                        <td width="150" height="25" class="bordeGrisTitulo"><div id="margen" align="left"><strong>Pagado</strong></div></td>
                        <td width="500" height="25" class="bordeGrisTitulo"><div id="margen" align="left"><strong>Observaciones</strong></div></td>
				...
				?>
                    ...
                    <tr onMouseOver="bgColor='#f3f3f3'" onMouseOut="bgColor=''">
                        ...
                        <td height="25"><div id="margen" align="left"><?= $oCliente->RazonSocial ?></div></td>
                        <td height="25"><div id="margen" align="left"><?= $oUsuario->Nombre . ' ' . $oUsuario->Apellido ?></div></td>
                        <td height="25"><div id="margen" align="left"><?= $oPago->Pago ? 'SI' : 'NO' ?></div></td>
                        ...
                        <td width="80" height="25"> 
                            <div align="center">
								<?php if ((Session::CheckPerm(PERM_PAGO_UPDATE) || $currentUser->IdUsuario == 29) && $oPago->Pago != '1'){ ?>
                                <a href="pagos_listado_pagar.php<?=$strParams?>&IdPago=<?=$oPago->IdPago?>"><img src="images/iconos/check.gif" alt="Pagar" title="Pagar" border="0" /></a>
                                <?php } ?>
								<?php if ((Session::CheckPerm(PERM_PAGO_UPDATE) || $currentUser->IdUsuario == 29) && $oPago->Pago == '1'){ ?>
                                <a href="pagos_pdf.php<?=$strParams?>&IdPago=<?=$oPago->IdPago?>"><img src="images/iconos/pdf.png" alt="Pagar" title="Pagar" border="0" /></a>
                                <?php } ?>
							</div>
                        </td>
                    </tr>
                ...
                <?php } ?> 
					<tr>
                        <td  colspan="5" height="25"><div id="margen" align="right"><strong>Total: </strong></div></td>
