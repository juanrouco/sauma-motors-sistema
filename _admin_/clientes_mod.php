            ...
            <td>
                <table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
                    <tr>
                        ...
                        <td height="40"><span class="tituloPagina">Administraci&oacute;n de Clientes - Modificar</span></td>
                  </tr>
                </table>
            </td>
        </tr>
                                                                                ...
                                                                                <td>
                                                                                    <table border="0" align="left" cellpadding="0" cellspacing="0">
                                                                                        ...
                                                                                        <tr>
                                                                                            <td>
                                                                                                <div align="left">
                                                                                                    <input type="text" name="Profesion" id="Profesion" class="camporFormularioSuggest" maxlength="128" value="<?=$Profesion?>" onkeyup="javascript: StrToUpper(this.id);"  autocomplete="off"  />
                                                                                                    <script language="javascript">
                                                                    ...
                                                                    <td valign="top">
                                                                        <table border="0" align="left" cellpadding="0" cellspacing="0">
                                                                            ...
                                                                            <tr>
                                                                                <td>
                                                                                    <div align="left">
                                                                                        <input type="text" name="DomicilioCalle" id="DomicilioCalle" class="camporFormularioSimple" required maxlength="128" value="<?=$DomicilioCalle?>" onkeyup="javascript: StrToUpper(this.id);" />
                                                                                    </div>
                                                                                </td>
                                                                                <td><span style="color:#FF0000;">&nbsp;</span></td>
                                                                            </tr>
                                                                                ...
                                                                                <td>
                                                                                    <table border="0" align="left" cellpadding="0" cellspacing="0">
                                                                                        ...
                                                                                        <tr>
                                                                                            <td>
                                                                                                <div align="left">
                                                                                                    <input type="text" name="DomicilioNumero" id="DomicilioNumero" required class="camporFormularioChico" maxlength="12" value="<?=$DomicilioNumero?>" onkeyup="javascript: StrToUpper(this.id);" />
                                                                                                </div>
                                                                                            </td>
                                                                                            <td>&nbsp;</td>
                                                                                            <td>
                                                                                ...
                                                                                <td>
                                                                                    <table border="0" align="left" cellpadding="0" cellspacing="0">
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td>&nbsp;</td>
                                                                                            <td><input type="button" id="btnAddLocalidadPostal" class="botonBasico"  onClick="javascript:AddLocalidadPostal('Domicilio');" value=" + " /></td>
                                                                                        </tr>
                                                                                    </table>
                                                                                </td>
                                                                            </tr>
