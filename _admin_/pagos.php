...
if ((!isset($filterPago)) || (IsEmptyArray($filterPago)) || ($Submit))
{
	...
	$filterPago['IdMinuta'] 	= trim($_REQUEST['IdMinuta']);
}
            ...
            <td>
                <table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
                    <tr>
                        ...
                        <td height="40"><span class="tituloPagina">Administraci&oacute;n de Cuentas Corriente - Pagos</span></td>
                    </tr>
                </table>		
            </td>
        </tr>
                                    ...
                                    <td>
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="pagos_add.php<?= $strParams ?>">Agregar</a></td>
                                            </tr>
											<?php } ?>
                                        </table>
                                    </td>
                                    <td><div align="right"><a href="cuentascorriente.php<?= $strParams ?>" class="linkMenu"><strong>[Volver al listado de cuentas corriente]</strong></a></div></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                    ...
                    <tr onMouseOver="bgColor='#f3f3f3'" onMouseOut="bgColor=''">
                        ...
                        <td width="80" height="25"> 
                            <div align="left">
                                ...
                                <?php } ?>
								<?php if (Session::CheckPerm(PERM_PAGO_DELETE) && $currentUser->IdUsuario != 45){ ?>
