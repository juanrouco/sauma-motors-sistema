...
<form name="frmData" id="frmData" method="post" action="minutaspago_retenciones_exportar_text_txt.php">
            ...
            <td>
                <table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
                    <tr>
                        ...
                        <td height="40"><span class="tituloPagina">Exportar Retenciones en Archivo TXT</span></td>
                    </tr>
                </table>		
            </td>
        </tr>
                            ...
                            <td class="tituloMenu">
                                <table border="0" cellspacing="0" cellpadding="0">
                                    <tr>                              
										...
										<td width="20">&nbsp;</td>
                                        <td><input type="submit" name="button" id="button" class="botonBasico" value="Obtener Retenciones"></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
