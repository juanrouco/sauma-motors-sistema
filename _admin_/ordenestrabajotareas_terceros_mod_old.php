...
if (!$oFacturaCompra = $oFacturasCompras->GetById($oOrdenTrabajoTarea->IdFacturaCompra))
{
	header("Location: ordenestrabajotareas.php" . $strParams);
	exit();
}
...
if ($Submit)
{
	...
	if (!$Total)
		$err |= 32;
	$oFacturaCompraRepetida = $oFacturasCompras->GetByNumeroAndProveedorAndTipo($Numero, $IdProveedor, $IdComprobanteTipo);
	if ($oFacturaCompraRepetida && $oFacturaCompraRepetida->IdFacturaCompra != $oFacturaCompra->IdFacturaCompra)
		$err |= 64;
    	...
    	<td>
			<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordeGrisFondo">
      			<tr>
        			...
        			<td height="40"><span class="tituloPagina">Trabajos de Terceros para OT N&deg; <?= $oOrdenTrabajoTarea->IdOrdenTrabajo ?> - Modificar</span></td>
      			</tr>
    		</table>
		</td>
  	</tr>
